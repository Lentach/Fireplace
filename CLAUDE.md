...
**Tests:** `cd backend && npm test` (292 unit tests, 40 suites; verified by `node scripts/verify-claude-backend-test-counts.mjs`). `cd frontend && flutter test`. CI: `.github/workflows/ci.yml`.
