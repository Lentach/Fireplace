...
## Corpus Check
- 328 files · ~342,957 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4684 nodes · 7543 edges · 308 communities (297 shown, 11 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2cd4c0e2`
...
## Communities (308 total, 11 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (24): buildCorsOrigin(), ChatGateway, AddReactionDto, ALLOWED_EMOJIS, BlockUserDto, MEDIA_URL_REGEX, _mediaOriginEscaped, RemoveReactionDto (+16 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (53): AppConstants, ConversationModel, ArgumentError, EncryptedMedia, MediaCryptoService, E2eEnvelope, main, aesGcmDecrypt (+45 more)
...
Cohesion: 0.05
Nodes (56): ../audio/playback_controller.dart, ../audio/waveform_display.dart, Icon, _formatTime, Row, build, _buildContentColumn, _buildReplyQuote (+48 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (53): api_service.dart, ApiService, _effectiveMediaUrl, Exception, jsonDecode, dispose, _fetch, GifModel (+45 more)

### Community 7 - "Community 7"
Cohesion: 0.09
Nodes (25): AuthService, mockConfigService, mockUsersService, Conversation, ConversationMapper, conv, createMockConversation(), lastMsg (+17 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (50): blocked_users_screen.dart, BlockedUsersScreen, _BlockedUserTile, build, Padding, Scaffold, SizedBox, build (+42 more)

### Community 9 - "Community 9"
Cohesion: 0.06
Nodes (44): avatar_circle.dart, SafeArea, AppScrollBehavior, buildOverscrollIndicator, AvatarCircle, _AvatarCircleState, build, _buildImageUrl (+36 more)

### Community 10 - "Community 10"
Cohesion: 0.08
Nodes (47): GestureDetector, build, Exception, FileMessageContent, _FileMessageContentState, GestureDetector, SizedBox, build (+39 more)

### Community 11 - "Community 11"
Cohesion: 0.08
Nodes (8): BlockedService, ConversationsService, FriendsService, MediaCleanupService, MessageCleanupService, expired, ChatValidationService, ValidateCanMessageResult
...
Cohesion: 0.07
Nodes (40): Center, initState, build, _buildInfoCard, _buildLocalCacheCard, Center, Container, initState (+32 more)
...
Cohesion: 0.07
Nodes (36): anti_quantum_note_dialog.dart, build, AntiQuantumNoteDialog, _AntiQuantumNoteDialogState, build, dispose, Expanded, Padding (+28 more)
...
Cohesion: 0.08
Nodes (20): AcceptFriendRequestDto, RejectFriendRequestDto, SendFriendRequestDto, UnfriendDto, FriendRequestStatus, FriendRequestMapper, payload, request (+12 more)
...
Cohesion: 0.06
Nodes (35): LayoutBuilder, build, _buildScaffold, _ChatBubblePainter, ContactsScreen, CustomPaint, didChangeAppLifecycleState, dispose (+27 more)
...
Cohesion: 0.09
Nodes (21): AuthGate, _AuthGateState, AuthScreen, FireplaceApp, main, MainShell, MaterialApp, MultiProvider (+13 more)

### Community 46 - "Community 46"
Cohesion: 0.09
Nodes (23): code:bash (git add -A), code:bash (rm frontend/Dockerfile.dev), code:bash (# Kill old processes), code:bash (docker system prune -a), code:bash (git add -A), Migration Procedure, code:bash (git add -A), code:bash (rm frontend/Dockerfile.dev) (+15 more)
...
- **Why does `Summary` connect `Community 198` to `Community 288`, `Community 99`, `Community 165`, `Community 166`, `Community 240`, `Community 177`, `Community 115`, `Community 152`, `Community 26`, `Community 220`?**
  _High betweenness centrality (0.162) - this node is a cross-community bridge._
- **Why does `Full Codebase Refactor — Domain-Driven Decomposition` connect `Community 198` to `Community 102`, `Community 208`, `Community 241`, `Community 275`, `Community 22`, `Community 216`?**
  _High betweenness centrality (0.149) - this node is a cross-community bridge._
- **Why does `chat_detail_screen.dart` connect `Community 8` to `Community 4`, `Community 5`, `Community 69`, `Community 199`, `Community 40`, `Community 9`, `Community 10`, `Community 106`, `Community 44`, `Community 79`, `Community 17`, `Community 18`, `Community 20`, `Community 55`, `Community 24`, `Community 25`?**
