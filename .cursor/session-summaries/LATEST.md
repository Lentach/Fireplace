...
## What was done
Autonomous implementation of the pre-release audit findings against `master @ 9d80e25` (v0.0.122 — prod baseline), in worktree `fireplace-fixes`. Seven commits on `fix/audit-bugs`:
