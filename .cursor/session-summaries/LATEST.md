...
**Date:** 2026-07-19 (landing `/welcome` — responsive captions fixed; desktop relay centered — SOURCE ONLY, NOT DEPLOYED)
...
## Key files
- `landing/src/styles/landing.css` — unified finale anchor/copy, short-landscape lane, centered relay, responsive desktop caption width.
- `landing/src/scripts/journey.ts` — short-landscape sender exit and centered geometry documentation.
- Full write-ups: `2026-07-19-session-landing-caption-alignment.md`, `2026-07-19-session-landing-relay-centering.md`.
