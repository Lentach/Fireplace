# Graph Report - Fireplace  (2026-05-15)

## Corpus Check
- 328 files · ~343,861 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4704 nodes · 7570 edges · 325 communities (307 shown, 18 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ecf3f5fe`
...
## Communities (325 total, 18 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (86): add_or_invitations_screen.dart, blocked_users_screen.dart, _AddByUsernameTab, _AddByUsernameTabState, AddOrInvitationsScreen, build, Card, Center (+78 more)
...
Cohesion: 0.03
Nodes (57): AppConstants, ConversationModel, main, aesGcmDecrypt, aesGcmEncrypt, main, secureRandomBytes, main (+49 more)
...
Cohesion: 0.06
Nodes (14): BlockedService, ConversationsService, StartConversationDto, FriendsService, MediaCleanupService, MessageCleanupService, expired, ChatConversationService (+6 more)

### Community 5 - "Community 5"
Cohesion: 0.08
Nodes (49): build, Icon, SizedBox, _formatTime, Column, GestureDetector, Row, build (+41 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (29): AcceptFriendRequestDto, ALLOWED_EMOJIS, MEDIA_URL_REGEX, _mediaOriginEscaped, RejectFriendRequestDto, SendFriendRequestDto, SendMessageDto, dto (+21 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (48): app_localizations.dart, app_localizations_en.dart, app_localizations_pl.dart, antiQuantumNoteSendFailed, AppLocalizations, _AppLocalizationsDelegate, AppLocalizationsEn, AppLocalizationsPl (+40 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (43): avatar_circle.dart, Padding, AppScrollBehavior, buildOverscrollIndicator, AuthForm, _AuthFormState, build, Form (+35 more)

### Community 9 - "Community 9"
Cohesion: 0.06
Nodes (47): initState, build, Directory, dispose, Exception, Function, initState, _isExpired (+39 more)

### Community 10 - "Community 10"
Cohesion: 0.15
Nodes (23): AuthModule, BlockedModule, BlockedUser, ChatModule, ChatValidationModule, Environment, EnvironmentVariables, validate() (+15 more)
...
Cohesion: 0.08
Nodes (40): _ActionTile, AlertDialog, build, _CenterProgressOverlay, ChatActionTiles, _CircularProgressPainter, Container, CustomPaint (+32 more)
...
Cohesion: 0.07
Nodes (37): build, _buildHeaderTitle, _buildScrollToBottomButton, ChatDetailScreen, _ChatDetailScreenState, ChatInputBar, _clearActiveConversationIfThisChat, Column (+29 more)

### Community 17 - "Community 17"
Cohesion: 0.14
Nodes (21): Conversation, ConversationMapper, conv, createMockConversation(), lastMsg, payload, payload, user (+13 more)
...
Cohesion: 0.08
Nodes (30): api_service.dart, ApiService, _effectiveMediaUrl, Exception, jsonDecode, dispose, _fetch, GifModel (+22 more)
...
Cohesion: 0.08
Nodes (32): cacheDecryption, _cancelPendingFetches, clearAll, clearPendingPreKeyFetch, clearSessionRebuild, dispose, _e2eFlowLog, EncryptionProvider (+24 more)

### Community 23 - "Community 23"
Cohesion: 0.07
Nodes (32): anti_quantum_note_dialog.dart, AntiQuantumNoteDialog, _AntiQuantumNoteDialogState, build, dispose, Expanded, Padding, SizedBox (+24 more)
...
Cohesion: 0.06
Nodes (33): applyPhonePortraitOrientations, AuthGate, _AuthGateState, AuthScreen, didChangeMetrics, dispose, FireplaceApp, initState (+25 more)

### Community 26 - "Community 26"
Cohesion: 0.07
Nodes (33): code:dart (Widget _buildDeliveryIcon() {), code:dart (String? _getTimerText() {), code:dart (@override), code:bash (git add frontend/lib/widgets/chat_message_bubble.dart), code:bash (cd frontend), code:dart (import 'package:flutter/material.dart';), code:bash (git add frontend/lib/widgets/chat_input_bar.dart), code:dart (import 'package:flutter/material.dart';) (+25 more)

### Community 27 - "Community 27"
Cohesion: 0.08
Nodes (24): getBaseUrlForPlatform, getBaseUrlForPlatform, BadgingBridge, createBadgingBridge, _navigator, base64UrlEncode, _base64UrlToUint8List, createWebPushBridge (+16 more)
...
Cohesion: 0.1
Nodes (26): Exception, build, buildRecordingBar, _checkMicPermission, dispose, Exception, _formatRecordingDuration, Function (+18 more)

### Community 31 - "Community 31"
Cohesion: 0.08
Nodes (26): ../audio/playback_controller.dart, ../audio/waveform_display.dart, build, GestureDetector, LayoutBuilder, MessageSwipeWrapper, _MessageSwipeWrapperState, _onDragEnd (+18 more)
...
Cohesion: 0.09
Nodes (27): code:bash (cd frontend), code:bash (git add frontend/lib/models/message_model.dart), Phase 2: Frontend - Message Model & Provider Updates, Task 2.1: Extend MessageModel with New Fields, 8. Message Model Enhancement, code:dart (enum MessageType {), code:dart (static MessageType _parseMessageType(String? type) {), code:dart (class MessageModel {) (+19 more)

### Community 35 - "Community 35"
Cohesion: 0.11
Nodes (6): mockConfigService, mockUsersService, JwtStrategy, UsersService, WebPushSubscriptionsService, WebPushSubscriptionUpsertInput

### Community 36 - "Community 36"
Cohesion: 0.08
Nodes (23): Center, AnimatedBuilder, build, Center, dispose, initState, PingEffectOverlay, _PingEffectOverlayState (+15 more)

### Community 37 - "Community 37"
Cohesion: 0.12
Nodes (25): Troubleshooting, 6.1 CORS error, 6.2 Docker vs .env confusion, 6.3 Port 3000 in use, 6.4 Flutter does not see iPhone, 6.5 Firewall blocks port 3000 (Windows), 6.6 iOS: "App Transport Security has blocked cleartext HTTP", 6.7 Android: "CLEARTEXT communication not permitted" (+17 more)

### Community 38 - "Community 38"
Cohesion: 0.09
Nodes (24): Chunk 2: Frontend — Extract EncryptionProvider (Phase 2), Chunk 3: Frontend — Extract FriendsProvider (Phase 3), Chunk 6: Final Cleanup + CLAUDE.md Update (Phase 6), code:dart (// frontend/lib/providers/encryption_provider.dart), code:bash (git add frontend/lib/providers/encryption_provider.dart), code:bash (git add frontend/lib/providers/encryption_provider.dart fron), code:bash (git add frontend/lib/providers/friends_provider.dart), code:bash (git add CLAUDE.md) (+16 more)

### Community 39 - "Community 39"
Cohesion: 0.12
Nodes (22): AlertDialog, build, _buildContactsList, _buildContactTile, _buildHeader, _compareByDisplayName, ContactsScreen, Container (+14 more)

### Community 40 - "Community 40"
Cohesion: 0.11
Nodes (24): 1.3 iOS (`frontend/ios/Runner/Info.plist`), 1.4 Android (`frontend/android/app/src/main/AndroidManifest.xml`), 3.1 Backend CORS — `docker-compose.yml`, 3.2 iOS — `frontend/ios/Runner/Info.plist`, 3.3 Android — `frontend/android/app/src/main/AndroidManifest.xml`, 3. Exact Code Changes, code:yaml (ALLOWED_ORIGINS: 'http://localhost:3000,http://localhost:808), code:yaml (ALLOWED_ORIGINS: 'http://localhost:3000,http://localhost:808) (+16 more)
...
Cohesion: 0.11
Nodes (22): 1. New DTO: DeleteConversationOnlyDto, 2. New Handler: handleDeleteConversationOnly, 3. Remove: handleDeleteConversation, 4. Unchanged: handleUnfriend, 5. Modified: ChatGateway, 6. Verify: startConversation, Backend Changes, code:typescript (@SubscribeMessage('deleteConversation') // ← delete this ent) (+14 more)
...
Cohesion: 0.1
Nodes (20): code:dart (IconButton(), Step 5.1: Remove IconButton delete, Implementation Phases, Phase 2: Frontend Recording, Phase 5: Error Handling & Polish, Phase 6: Testing & Refinement, code:bash (git add frontend/lib/widgets/voice_recording_overlay.dart), code:dart (Future<void> retryVoiceMessage(String tempId) async {) (+12 more)

### Community 49 - "Community 49"
Cohesion: 0.1
Nodes (22): code:bash (git add frontend/lib/providers/chat_provider.dart), Step 4.5: Commit ChatProvider changes, Chunk 4: Frontend — Extract ConnectionProvider + ConversationsProvider + MessagingProvider (Phase 4), code:dart (void connect({required String baseUrl, required String token), code:dart (_socketService.connect(baseUrl: baseUrl, token: token);), code:bash (git add frontend/lib/services/socket_service.dart frontend/l), code:dart (// frontend/lib/providers/connection_provider.dart), code:bash (git add frontend/lib/providers/connection_provider.dart) (+14 more)
...
Cohesion: 0.11
Nodes (16): DefaultFirebaseOptions, UnsupportedError, Function, handleFcmRemoteMessageOpen, setAndroidNotificationConversationTapHandler, AndroidNotificationChannel, Function, handleFcmRemoteMessageOpen (+8 more)

### Community 54 - "Community 54"
Cohesion: 0.11
Nodes (21): code:bash (git add backend/src/messages/messages.service.ts), Task 2: MessagesService.deleteAllByConversation, code:typescript (: rt.messageType === 'IMAGE' || rt.messageType === 'DRAWING'), code:typescript (: rt.messageType === 'IMAGE'), code:bash (git add backend/src/messages/message.entity.ts backend/src/m), Task 1: Remove Drawing from backend, Chunk 1: Backend — MessageType + Upload + Mapper, code:typescript (it('should show GIF label for GIF replyTo', () => {) (+13 more)
...
Cohesion: 0.13
Nodes (18): 2. Architecture Overview, code:mermaid (flowchart TB), Architecture Overview, Contacts Tab Design - Archive → Contacts Refactor, Key Changes, Overview, Success Criteria, Two Independent Flows (+10 more)
...
Cohesion: 0.11
Nodes (18): code:typescript (import {), code:typescript (export { DeleteConversationOnlyDto } from './delete-conversa), code:typescript (import {), code:bash (git add backend/src/chat/dto/delete-conversation-only.dto.ts), Step 1.2: Export DTO in barrel file, Step 1.3: Add handleDeleteConversationOnly method, Step 1.4: Remove old handleDeleteConversation method, Step 1.5: Commit backend DTO and handler (+10 more)
...
Cohesion: 0.11
Nodes (18): code:dart (// In main.dart, update MultiProvider:), code:dart (final chat = context.read<ChatProvider>();), code:bash (git add frontend/lib/main.dart frontend/lib/providers/chat_p), code:bash (git add frontend/lib/main.dart frontend/lib/providers/chat_p), Task 2.2: Wire EncryptionProvider into provider tree + ChatProvider facade, Task 3.2: Wire FriendsProvider + migrate ChatProvider, 1. Kontekst z CLAUDE.md, 3.1 Brak przekazywania expiresIn przy wysyłce (ChatInputBar) (+10 more)

### Community 68 - "Community 68"
Cohesion: 0.12
Nodes (17): code:dart (void connect(String token, int userId) {), code:dart (void _handleMessageDelivered(Map<String, dynamic> data) {), code:dart (void sendPing(int recipientId) {), code:dart (void _handlePingReceived(Map<String, dynamic> data) {), code:dart (void sendMessage(String content, {int? expiresIn}) {), code:dart (void _handleIncomingMessage(Map<String, dynamic> data) {), code:bash (git add frontend/lib/providers/chat_provider.dart), code:typescript (export class SendMessageDto {) (+9 more)

### Community 69 - "Community 69"
Cohesion: 0.14
Nodes (17): code:dart (// frontend/lib/widgets/message/image_message_content.dart), code:block57 (cd frontend && flutter analyze lib/widgets/message/image_mes), code:block58 (git add frontend/lib/widgets/message/image_message_content.d), code:dart (// frontend/lib/widgets/message/gif_message_content.dart), code:block60 (cd frontend && flutter analyze lib/widgets/message/gif_messa), code:block61 (git add frontend/lib/widgets/message/gif_message_content.dar), code:dart (// IMAGE), code:block63 (cd frontend && flutter analyze lib/widgets/message/message_c) (+9 more)
...
Cohesion: 0.12
Nodes (17): ═══════════════════════════════════════, code:typescript (// backend/src/media/media-cleanup.service.spec.ts), code:bash (cd backend && npx jest media-cleanup.service.spec.ts --no-co), code:typescript (// backend/src/media/media-cleanup.service.ts), code:bash (cd backend && npx jest media-cleanup.service.spec.ts --no-co), code:bash (git add backend/src/media/media-cleanup.service.ts backend/s), code:typescript (// deleteMessage for_everyone:), code:typescript (// Before deleting conversation:) (+9 more)

### Community 78 - "Community 78"
Cohesion: 0.12
Nodes (17): 6. SocketService - New Emit, code:dart (void emitDeleteConversationOnly(int conversationId) {), code:dart (_socket!.on('conversationDeleted', onConversationDeleted ?? ), code:dart (final Function(dynamic)? onConversationDeleted;), code:dart (_socket!.on('conversationDeleted', (data) {), code:dart (// Menu (three dots)), code:bash (git add frontend/lib/screens/chat_detail_screen.dart), code:dart (void emitDeleteConversationOnly(int conversationId) {) (+9 more)
...
Cohesion: 0.12
Nodes (16): code:dart (final Map<String, Map<String, dynamic>> _pendingSendContent ), code:dart (_pendingSendContent[tempId] = <String, dynamic>{'content': c), code:dart (Future<void> _encryptAndSend({), code:dart (Map<String, String?>? linkPreview;), code:dart (final pending = _pendingSendContent[tempId];), code:dart (if (msg.content == '[encrypted]' && plaintextContent.isNotEm), code:dart (MessageType? _parseMessageTypeString(String? type) {), code:dart (final parsedType = _parseMessageTypeString(parsed.messageTyp) (+8 more)
...
Cohesion: 0.15
Nodes (15): code:bash (# From project root. Replace CONTAINER with your postgres co), code:json ({), code:bash (cd frontend && flutter run -d chrome), code:sql (-- Last 5 messages with encryption status), Manual E2E Encryption Testing Guide, Prerequisites, Quick Reference: SQL Queries, Scope Reminder (+7 more)
...
Cohesion: 0.13
Nodes (13): Chunk 4: Frontend — Encrypt all message types, code:dart (// After successful upload:), code:bash (git add frontend/lib/providers/chat_provider.dart), code:dart (if (message.messageType == MessageType.ping) {), code:bash (git add frontend/lib/providers/chat_provider.dart frontend/l), E2E Encryption for All Message Types + Drawing Removal — Implementation Plan, Task 11: Encrypt voice messages, Task 12: Encrypt image messages (+5 more)
...
Cohesion: 0.12
Nodes (15): Accepted limitations, code:block1 (Client (Flutter)                       Backend (NestJS)), Decisions added during spec review, Future enhancements, Goal, High-Level Architecture, Identity-Key Auth — Design Spec, Key design decisions (+7 more)

### Community 97 - "Community 97"
Cohesion: 0.13
Nodes (15): code:powershell (ipconfig), code:bash (ifconfig | grep "inet " | grep -v 127.0.0.1), Step 1: Find computer IP, code:xml (<key>CADisableMinimumFrameDurationOnPhone</key>), code:xml (<key>CADisableMinimumFrameDurationOnPhone</key>), code:xml (<manifest xmlns:android="http://schemas.android.com/apk/res/), code:xml (<manifest xmlns:android="http://schemas.android.com/apk/res/), code:block19 (Launching lib/main.dart on iPhone 15 in debug mode...) (+7 more)
...
Cohesion: 0.19
Nodes (13): build, Center, dispose, Function, GifPickerSheet, _GifPickerSheetState, initState, _onScroll (+5 more)

### Community 110 - "Community 110"
Cohesion: 0.14
Nodes (14): code:powershell (# Dodaj regułę dla port 3000), code:bash (# Powinno być 192.168.x.x (local network)), code:bash (docker ps  # Backend powinien być RUNNING), code:block32 (NSURLConnection error: -1022), code:block33 (CLEARTEXT communication to 192.168.1.100 not permitted by ne), code:block34 (error: Signing for "Runner" requires a development team. Sel), code:bash (# Docker - po zmianie docker-compose.yml), Problem 2: "Network error" / "Connection refused" (+6 more)
...
Cohesion: 0.15
Nodes (14): code:markdown (**2026-02-14:**), Step 10.4: Update §13 Recent Changes, code:markdown (**2026-02-14:**), code:bash (git add CLAUDE.md), Task 10: Manual Testing & Documentation, code:markdown (- **Message Types:** TEXT, PING, IMAGE, DRAWING, VOICE), code:markdown (---), code:markdown (**2026-02-15:**) (+6 more)
...
Cohesion: 0.15
Nodes (13): 0. Quick Start, 1. Critical Rules & Gotchas, 3. File Location Map, 6. Key Behaviors & Gotchas (Runtime), 7. Frontend Screens & Widgets, 8. Environment & Config, 9. Known Limitations, Backend (`backend/src/`) (+5 more)
...
Cohesion: 0.17
Nodes (11): Chunk 2: Frontend — Model + Config + API Service, Chunk 5: Integration + CLAUDE.md, code:dart (static String get giphyApiKey {), code:bash (git add frontend/lib/config/app_config.dart), code:dart (Future<Map<String, dynamic>> uploadMedia({), code:dart (} else if (type == 'gif' && gifBytes != null) {), GIF Support Implementation Plan, Task 15: Manual integration test (+3 more)

### Community 154 - "Community 154"
Cohesion: 0.17
Nodes (12): code:typescript (async createImageMessage(data: {), code:typescript (import { MessagesController } from './messages.controller';), code:bash (curl -X POST http://localhost:3000/messages/image \), code:bash (git add backend/src/messages/messages.controller.ts), Task 5.1: Backend - Image Message Upload Endpoint, code:typescript (export class SendMessageDto {), code:typescript (async handleSendMessage(client: Socket, dto: SendMessageDto)), code:typescript (async create(data: {) (+4 more)

### Community 155 - "Community 155"
Cohesion: 0.17
Nodes (12): code:dart (bool _decryptingHistory = false;), code:dart (_decryptHistoryCancelled = true;), code:dart (_decryptHistoryCancelled = false;), code:dart (for (var i = 0; i < sorted.length; i++) {), code:dart (Future<void> _decryptMessageHistory() async {), code:bash (cd frontend && flutter analyze 2>&1 | tail -5), code:bash (git add frontend/lib/providers/chat_provider.dart), Fix C: Cancellation flag for `_decryptMessageHistory` (4.4) (+4 more)
...
Cohesion: 0.17
Nodes (11): code:typescript (/** True if either user has blocked the other. Single query ), code:bash (cd backend && git add src/blocked/blocked.service.ts), code:typescript (/** True only for safe HTTPS URLs pointing to public hosts *), code:typescript (imageUrl: imageUrl ? imageUrl.trim() : null,), code:typescript (imageUrl: imageUrl && isSafeImageUrl(imageUrl.trim()) ? imag), code:bash (cd backend && npm test --no-coverage 2>&1 | tail -15), code:bash (cd backend && git add src/chat/services/link-preview.service), Security & Bug Fixes Implementation Plan (+3 more)
...
Cohesion: 0.18
Nodes (10): 3. Integracja z ChatProvider, 4. Zgodność z architekturą, 7. Rekomendacje na przyszłość, 8. Podsumowanie, Długoterminowe (v2.0):, Gettery i settery:, Handlery:, Krótkoterminowe (v1.1): (+2 more)
...
Cohesion: 0.18
Nodes (11): 4. Implementation Procedure, code:bash (# Docker), code:bash (cd frontend/ios), Step 2: Update backend CORS, Step 3: Edit iOS Info.plist, Step 4: Edit Android AndroidManifest.xml, Step 5: iOS Xcode setup (iOS only), code:block35 (Access to XMLHttpRequest at 'http://192.168.1.100:3000/auth/) (+3 more)
...
Cohesion: 0.18
Nodes (10): Backend, Chat Screen Redesign - End-to-End Test Plan, Frontend, Prerequisites, Test 6.1: Open Gallery, Test 6.2: Select and Upload Image, Test 6: Gallery Attachment (via ChatInputBar), Test 8.1: Complex Workflow (+2 more)
...
Cohesion: 0.18
Nodes (11): 5. ChatProvider - New Methods, code:dart (void deleteConversationOnly(int conversationId) {), code:dart (onConversationDeleted: (data) {), code:dart (void deleteConversationOnly(int conversationId) {), code:dart (void _handleConversationDeleted(dynamic data) {), code:dart (onConversationDeleted: _handleConversationDeleted,), Step 4.1: Add deleteConversationOnly method, Step 4.2: Add _handleConversationDeleted listener (+3 more)
...
Cohesion: 0.18
Nodes (10): Chat Screen Redesign - Telegram/Wire Inspired UI, code:bash (# Start backend), code:markdown (# Chat Redesign Manual Test Results), code:bash (git add docs/testing/2026-02-04-chat-redesign-manual-tests.m), Current State Analysis, Phase 5: Image Upload for Messages (Camera & Drawing), Plan Complete!, Summary (+2 more)
...
Cohesion: 0.18
Nodes (10): 3. Facebook Messenger, 6. Common UX patterns (zoom/pan), 7. Implementation approaches (from research), 8. Recommendations for Fireplace, 9. Sources (URLs), Android (Stack Overflow – “like WhatsApp”), Flutter relevance for Fireplace, Image / media full-screen viewer — research (popular messengers) (+2 more)
...
Cohesion: 0.2
Nodes (10): code:bash (cd frontend), code:bash (flutter run --dart-define=BASE_URL=http://192.168.1.100:3000), Step 6: Run Flutter on device, 4. Flutter Build - Production BASE_URL, code:bash (cd frontend), code:bash (flutter devices), code:bash (flutter run --dart-define=BASE_URL=http://192.168.1.100:3000), code:bash (flutter run --dart-define=BASE_URL=http://192.168.1.100:3000) (+2 more)

### Community 184 - "Community 184"
Cohesion: 0.2
Nodes (10): 1.1 Frontend (Flutter), 1.2 Backend (NestJS), 1. Current Configuration, 6.1 Flutter (Mobile App), 6.2 Backend (NestJS), 6.3 Infrastructure, 6. Libraries & Dependencies, code:yaml (# pubspec.yaml) (+2 more)
...
Cohesion: 0.22
Nodes (8): Chat Scroll: `reverse: true` Refactor, code:dart (_scrollController.jumpTo(preOffset + (newExtent - preExtent)), Edge Cases, Industry precedent, Pagination Scroll Math, Problem, Solution, Testing
...
Cohesion: 0.25
Nodes (8): code:dart (import 'dart:io';), code:dart (import 'package:image_picker/image_picker.dart';), code:dart (import 'package:image_picker/image_picker.dart';), code:dart (import 'dart:typed_data';), code:yaml (dependencies:), code:dart (// In build() method, update content section:), code:bash (git add frontend/lib/services/api_service.dart), Task 5.2: Frontend - Camera & Drawing Upload
...
Cohesion: 0.25
Nodes (8): code:dart (import '../services/media_crypto_service.dart';), code:dart (final MediaCryptoService _mediaCrypto = MediaCryptoService()), code:dart (// In the try block, replace:), code:dart (// Voice: duration comes from the existing dto.duration or i), code:bash (cd frontend && flutter analyze), code:bash (cd frontend && flutter test), code:bash (git add frontend/lib/providers/messaging_provider.dart), Task 9: Encrypt before upload — sendImage, sendVoice, sendGif, sendFile

### Community 225 - "Community 225"
Cohesion: 0.25
Nodes (8): code:dart (// frontend/test/services/media_crypto_service_test.dart), code:block2 (cd frontend && flutter test test/services/media_crypto_servi), code:dart (// frontend/lib/services/media_crypto_service.dart), code:block4 (cd frontend && flutter test test/services/media_crypto_servi), code:dart (import '../services/media_crypto_service.dart';), code:block6 (cd frontend && flutter analyze lib/providers/messaging_provi), code:block7 (git add frontend/lib/services/media_crypto_service.dart \), Task 1: MediaCryptoService
...
Cohesion: 0.29
Nodes (5): badging_bridge_stub.dart, _onConversationsChanged, _scheduleFlush, UnreadBadgeSync, ../utils/app_badge_math.dart
...
Cohesion: 0.29
Nodes (7): code:typescript (const token =), code:typescript (const token = client.handshake.auth?.token as string;), code:typescript (@IsString()), Step 1: Remove WS query-string token fallback in `chat.gateway.ts`, Step 3: Add `@MaxLength` to password in `login.dto.ts`, Step 4: Build and test, Task 1: Trivial backend hardening (1.5, 1.6, 5.1)
...
Cohesion: 0.33
Nodes (6): code:typescript (// backend/src/media/local-storage.service.spec.ts), code:bash (cd backend && npx jest local-storage.service.spec.ts --no-co), code:typescript (// backend/src/media/local-storage.service.ts), code:bash (cd backend && npx jest local-storage.service.spec.ts --no-co), code:bash (git add backend/src/media/local-storage.service.ts backend/s), Task 1: LocalStorageService
...
Cohesion: 0.5
Nodes (4): 5. How-To: Adding New Features, Add a new DB column:, Add a new REST endpoint:, Add a new WebSocket event:
...
Cohesion: 0.5
Nodes (3): File Map, Security & Reliability Hardening — Implementation Plan, Summary
...
## Knowledge Gaps
- **2325 isolated node(s):** `mockUsersService`, `mockConfigService`, `dto`, `mediaUrlError`, `_mediaOriginEscaped` (+2320 more)
...
- **Why does `chat_detail_screen.dart` connect `Community 16` to `Community 0`, `Community 36`, `Community 5`, `Community 293`, `Community 39`, `Community 8`, `Community 9`, `Community 41`, `Community 12`, `Community 109`, `Community 14`, `Community 18`, `Community 22`, `Community 23`?**
  _High betweenness centrality (0.142) - this node is a cross-community bridge._
- **Why does `Full Codebase Refactor — Domain-Driven Decomposition` connect `Community 209` to `Community 6`, `Community 38`, `Community 105`, `Community 215`, `Community 249`, `Community 284`?**
  _High betweenness centrality (0.138) - this node is a cross-community bridge._
- **Why does `Summary` connect `Community 209` to `Community 227`, `Community 228`, `Community 171`, `Community 44`, `Community 302`, `Community 175`, `Community 180`, `Community 86`, `Community 93`, `Community 63`?**
  _High betweenness centrality (0.136) - this node is a cross-community bridge._
- **What connects `mockUsersService`, `mockConfigService`, `dto` to the rest of the system?**
  _2325 weakly-connected nodes found - possible documentation gaps or missing edges._
