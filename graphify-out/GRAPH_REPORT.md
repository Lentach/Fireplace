...
## Corpus Check
- 328 files · ~342,930 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4684 nodes · 7543 edges · 306 communities (294 shown, 12 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e5f5ab3f`
...
## Communities (306 total, 12 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (33): buildCorsOrigin(), ChatGateway, AcceptFriendRequestDto, AddReactionDto, ALLOWED_EMOJIS, BlockUserDto, MEDIA_URL_REGEX, _mediaOriginEscaped (+25 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (71): avatar_circle.dart, build, SizedBox, AvatarCircle, _AvatarCircleState, build, _buildImageUrl, Container (+63 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (68): add_or_invitations_screen.dart, blocked_users_screen.dart, AuthGate, _AuthGateState, AuthScreen, FireplaceApp, main, MainShell (+60 more)
...
Cohesion: 0.05
Nodes (52): api_service.dart, ApiService, _effectiveMediaUrl, Exception, jsonDecode, dispose, _fetch, GifModel (+44 more)
...
Cohesion: 0.1
Nodes (21): Conversation, ConversationsService, ConversationMapper, conv, createMockConversation(), lastMsg, payload, payload (+13 more)
...
Cohesion: 0.05
Nodes (36): aesGcmDecrypt, aesGcmEncrypt, main, secureRandomBytes, main, main, main, main (+28 more)

### Community 11 - "Community 11"
Cohesion: 0.05
Nodes (34): AppConstants, ArgumentError, EncryptedMedia, MediaCryptoService, E2eEnvelope, main, buildProviderWithSampleData, main (+26 more)
...
Cohesion: 0.07
Nodes (30): GetMessagesDto, SendMessageDto, dto, mediaUrlError, MarkConversationReadDto, MessageDeliveredDto, MessageDeliveryStatus, ChatMessageService (+22 more)
...
Cohesion: 0.05
Nodes (37): Backend, Chat Screen Redesign - End-to-End Test Plan, Frontend, Prerequisites, Test 11.1: Open Conversation Without Active Conversation, Test 11.2: Send Drawing Without Active Conversation, Test 11.3: Upload Image Without Recipient, Test 11: Edge Cases (+29 more)
...
Cohesion: 0.08
Nodes (36): build, _buildHeaderTitle, _buildScrollToBottomButton, ChatDetailScreen, _ChatDetailScreenState, ChatInputBar, _clearActiveConversationIfThisChat, Column (+28 more)

### Community 23 - "Community 23"
Cohesion: 0.1
Nodes (9): mockConfigService, mockUsersService, BlockedService, MediaCleanupService, MessageCleanupService, expired, ChatValidationService, ValidateCanMessageResult (+1 more)
...
Cohesion: 0.07
Nodes (29): anti_quantum_note_dialog.dart, AntiQuantumNoteDialog, _AntiQuantumNoteDialogState, build, dispose, Expanded, Padding, SizedBox (+21 more)
...
Cohesion: 0.12
Nodes (7): PendingBucket, PushNotificationCoalescingService, PushNotificationsModule, NotifyOptions, PushNotificationsService, WebPushSubscriptionsService, WebPushSubscriptionUpsertInput

### Community 31 - "Community 31"
Cohesion: 0.11
Nodes (12): FetchPreKeyBundleDto, RequestSessionRebuildDto, UploadKeyBundleDto, OneTimePreKeyDto, UploadOneTimePreKeysDto, PreKeyBundleResponse, ChatKeyExchangeService, invalidData (+4 more)

### Community 32 - "Community 32"
Cohesion: 0.08
Nodes (24): AppScrollBehavior, buildOverscrollIndicator, build, Container, _contentPreview, ReplyPreviewBar, SizedBox, build (+16 more)
...
Cohesion: 0.08
Nodes (28): code:bash (cd frontend), code:bash (git add frontend/lib/models/message_model.dart), Phase 2: Frontend - Message Model & Provider Updates, Task 2.1: Extend MessageModel with New Fields, code:bash (cd frontend/ios), code:bash (cd frontend), code:bash (flutter run --dart-define=BASE_URL=http://192.168.1.100:3000), Step 5: iOS Xcode setup (iOS only) (+20 more)
...
Cohesion: 0.1
Nodes (22): SafeArea, build, Dialog, dispose, ResetPasswordDialog, _ResetPasswordDialogState, SizedBox, _submit (+14 more)
...
Cohesion: 0.11
Nodes (23): AlertDialog, build, _buildContactsList, _buildContactTile, _buildHeader, Center, _compareByDisplayName, ContactsScreen (+15 more)
...
Cohesion: 0.09
Nodes (21): Ciphertext String Format, code:block1 (Alice                          Server                       ), code:block2 (BEFORE: { content: "Cześć Bob!" }), code:json ({), Context, E2E Encryption for Fireplace Messenger — Implementation Plan, Encrypted Envelope Format, First Message Flow (X3DH) (+13 more)
...
Cohesion: 0.11
Nodes (20): 1.1 Frontend (Flutter), 1.3 iOS (`frontend/ios/Runner/Info.plist`), 1.4 Android (`frontend/android/app/src/main/AndroidManifest.xml`), 1. Current Configuration, 2. Files to Modify, 3.2 iOS — `frontend/ios/Runner/Info.plist`, 3. Exact Code Changes, 5. Verification Checklist (+12 more)
...
Cohesion: 0.12
Nodes (18): code:bash (git add -A), code:bash (rm frontend/Dockerfile.dev), code:bash (# Kill old processes), code:bash (docker system prune -a), code:bash (git add -A), Migration Procedure, code:bash (rm frontend/Dockerfile.dev), code:bash (rm frontend/dev-entrypoint.sh) (+10 more)
...
Cohesion: 0.17
Nodes (10): code:dart (@override), code:dart (@override), Step 5.2: Wrap tile content in Dismissible, code:dart (try {), code:dart (),), code:dart (@override), code:bash (cd frontend && flutter test), code:bash (git add frontend/lib/widgets/message/reaction_chips_row.dart) (+2 more)
...
Cohesion: 0.33
Nodes (7): 3.3 Android — `frontend/android/app/src/main/AndroidManifest.xml`, code:xml (<!-- Network access for API + Socket.IO -->), code:xml (<application), code:xml (<application), 3. Android - `frontend/android/app/src/main/AndroidManifest.xml`, code:xml (<!-- Network access for API + Socket.IO -->), code:xml (<application)
...
Cohesion: 0.5
Nodes (4): code:dart (static Widget build({), code:bash (cd frontend && flutter test), code:bash (git add frontend/lib/widgets/message/message_content_factory), Task 4: Forward `timeOverlay` through `MessageContentFactory`

## Knowledge Gaps
- **2310 isolated node(s):** `mockUsersService`, `mockConfigService`, `dto`, `mediaUrlError`, `_mediaOriginEscaped` (+2305 more)
...
- **Why does `Summary` connect `Community 199` to `Community 164`, `Community 69`, `Community 166`, `Community 217`, `Community 77`, `Community 173`, `Community 20`, `Community 216`, `Community 121`, `Community 92`?**
  _High betweenness centrality (0.162) - this node is a cross-community bridge._
- **Why does `Full Codebase Refactor — Domain-Driven Decomposition` connect `Community 199` to `Community 108`, `Community 205`, `Community 271`, `Community 241`, `Community 17`, `Community 214`?**
  _High betweenness centrality (0.149) - this node is a cross-community bridge._
- **Why does `chat_detail_screen.dart` connect `Community 22` to `Community 32`, `Community 1`, `Community 2`, `Community 37`, `Community 38`, `Community 8`, `Community 88`, `Community 42`, `Community 200`, `Community 12`, `Community 45`, `Community 21`, `Community 55`, `Community 56`, `Community 27`, `Community 28`?**
  _High betweenness centrality (0.137) - this node is a cross-community bridge._
- **What connects `mockUsersService`, `mockConfigService`, `dto` to the rest of the system?**
  _2310 weakly-connected nodes found - possible documentation gaps or missing edges._
