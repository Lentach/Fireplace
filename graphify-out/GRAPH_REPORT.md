...
## Corpus Check
- 328 files · ~343,817 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4704 nodes · 7570 edges · 323 communities (307 shown, 16 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7c996106`
...
## Communities (323 total, 16 thin omitted)
...
Cohesion: 0.04
Nodes (51): AppConstants, ConversationModel, main, main, main, main, buildProviderWithSampleData, main (+43 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (64): build, build, Directory, dispose, Exception, Function, initState, _loadAndPlayAudio (+56 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (56): anti_quantum_note_dialog.dart, Padding, AppScrollBehavior, buildOverscrollIndicator, AntiQuantumNoteDialog, _AntiQuantumNoteDialogState, build, dispose (+48 more)

### Community 5 - "Community 5"
Cohesion: 0.08
Nodes (12): BlockedService, ConversationsService, MediaCleanupService, MessageCleanupService, expired, ChatConversationService, friend, mockFriendRequest (+4 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (49): ../audio/playback_controller.dart, ../audio/waveform_display.dart, Icon, _isExpired, Row, Semantics, build, _buildContentColumn (+41 more)

### Community 7 - "Community 7"
Cohesion: 0.07
Nodes (18): GetMessagesDto, MarkConversationReadDto, MessageDeliveredDto, MessageDeliveryStatus, MessagesService, msgs, ChatLinkPreviewService, ChatMessageService (+10 more)
...
Cohesion: 0.06
Nodes (41): api_service.dart, AuthProvider, _cancelSessionRefreshTimer, _clearLocalAuthState, clearPwaAppBadgeOnLogout, clearStatus, dispose, Exception (+33 more)
...
Cohesion: 0.09
Nodes (32): blocked_users_screen.dart, AuthScreen, _AuthScreenState, build, Scaffold, Shadow, SizedBox, BlockedUsersScreen (+24 more)
...
Cohesion: 0.08
Nodes (28): avatar_circle.dart, AlertDialog, initState, AvatarCircle, _AvatarCircleState, build, _buildImageUrl, Container (+20 more)

### Community 28 - "Community 28"
Cohesion: 0.08
Nodes (28): code:bash (cd frontend), code:dart (import 'package:flutter/material.dart';), code:bash (git add frontend/lib/widgets/chat_input_bar.dart), code:dart (import 'package:flutter/material.dart';), code:dart (import 'chat_action_tiles.dart';), code:dart (class ChatProvider extends ChangeNotifier {), code:bash (git add frontend/lib/widgets/chat_action_tiles.dart), code:bash (git add frontend/lib/screens/chat_detail_screen.dart) (+20 more)

### Community 29 - "Community 29"
Cohesion: 0.08
Nodes (24): cancel, ChatReconnectManager, Duration, onDisconnect, resetAttempts, scheduleReconnect, applyRefreshedAccessToken, ConnectionProvider (+16 more)

### Community 30 - "Community 30"
Cohesion: 0.09
Nodes (24): SafeArea, build, ChatInputBar, _ChatInputBarState, Column, dispose, _formatTimer, initState (+16 more)

### Community 31 - "Community 31"
Cohesion: 0.1
Nodes (25): Exception, build, buildRecordingBar, _checkMicPermission, dispose, Exception, _formatRecordingDuration, Function (+17 more)
...
Cohesion: 0.08
Nodes (21): ArgumentError, EncryptedMedia, MediaCryptoService, E2eEnvelope, aesGcmDecrypt, aesGcmEncrypt, main, secureRandomBytes (+13 more)
...
Cohesion: 0.08
Nodes (24): Chat Screen Architecture - Source of Truth, Client → Server, code:typescript (@Entity('messages')), Colors (RpgTheme), Database Schema Changes, Deployment Checklist, Glossary, Image Loading (+16 more)

### Community 37 - "Community 37"
Cohesion: 0.09
Nodes (26): code:bash (git add backend/src/chat/services/chat-message.service.ts \), Step 4: Commit, Chunk 1: Backend — Thin Gateway + Extract Services (Phase 1), code:typescript (// backend/src/chat/services/chat-presence.service.ts), code:bash (git add backend/src/chat/services/chat-reaction.service.ts b), code:bash (git add backend/src/chat/services/chat-link-preview.service.), code:bash (git add -A backend/), code:typescript (// backend/src/chat/services/chat-presence.service.spec.ts) (+18 more)
...
Cohesion: 0.09
Nodes (24): Backend Tests, Frontend Tests, Testing Strategy, Conclusion, Data Flow (Step-by-Step), Expiration Flow, Functional Requirements, Future Enhancements (+16 more)
...
Cohesion: 0.08
Nodes (24): 10. Frontend — ChatProvider, 11. Frontend — ChatMessageBubble, 3. Backend — MessagesService, 4. Backend — MessageMapper, 6. Backend — ChatModule, 7. Frontend — pubspec.yaml, 8. Frontend — MessageModel, 9. Frontend — SocketService (+16 more)
...
Cohesion: 0.09
Nodes (24): code:bash (git add frontend/lib/services/socket_service.dart), Step 3.4: Commit socket service changes, code:dart (Future<String> createSecretNote(String token, String ciphert), code:dart (import 'package:encrypt/encrypt.dart' as enc;), code:dart (Future<void> sendAntiQuantumNote({), code:bash (cd frontend && flutter test 2>&1 | tail -15), code:bash (git add frontend/lib/services/api_service.dart frontend/lib/), Task 7: sendNote in ChatProvider (crypto + API + send message) (+16 more)

### Community 47 - "Community 47"
Cohesion: 0.09
Nodes (23): Chunk 2: Frontend — Extract EncryptionProvider (Phase 2), Chunk 3: Frontend — Extract FriendsProvider (Phase 3), Chunk 6: Final Cleanup + CLAUDE.md Update (Phase 6), code:dart (// In main.dart, update MultiProvider:), code:dart (final chat = context.read<ChatProvider>();), code:bash (git add frontend/lib/main.dart frontend/lib/providers/chat_p), code:bash (git add frontend/lib/providers/friends_provider.dart), code:bash (git add frontend/lib/main.dart frontend/lib/providers/chat_p) (+15 more)

### Community 48 - "Community 48"
Cohesion: 0.14
Nodes (8): RequestSessionRebuildDto, UploadKeyBundleDto, ChatKeyExchangeService, invalidData, mockBundle, noUserClient, nowSpy, validData

### Community 49 - "Community 49"
Cohesion: 0.1
Nodes (20): Implementation Phases, Phase 2: Frontend Recording, Phase 3: Frontend Upload & Optimistic UI, Phase 5: Error Handling & Polish, Phase 6: Testing & Refinement, code:bash (git add frontend/lib/widgets/voice_recording_overlay.dart), code:dart (void sendMessage({), code:bash (git add frontend/lib/services/socket_service.dart frontend/l) (+12 more)

### Community 50 - "Community 50"
Cohesion: 0.09
Nodes (22): code:dart (test('chatHistoryCleared removes cache entry', () {), code:bash (cd frontend && flutter test test/providers/messaging_provide), code:dart (// Keep cache current for active conversation.), code:dart (// Update cache with decrypted content (encrypted placeholde), code:dart (// Keep delivery status current in cache.), code:dart (// Reflect deletion in cache; remove entry entirely if the c), code:dart (_conversationCache.remove(conversationId);), code:dart (_conversationCache.remove(conversationId);) (+14 more)

### Community 51 - "Community 51"
Cohesion: 0.16
Nodes (8): RejectFriendRequestDto, FriendRequest, FriendRequestStatus, FriendsService, FriendRequestMapper, payload, request, friendRequestsB
...
Cohesion: 0.12
Nodes (21): Files to Create, ═══════════════════════════════════════, ═══════════════════════════════════════, ═══════════════════════════════════════, ═══════════════════════════════════════, Backend — create, Backend — delete, Backend — modify (+13 more)
...
Cohesion: 0.1
Nodes (21): code:dart (import 'dart:io';), code:dart (import 'package:image_picker/image_picker.dart';), code:dart (import 'package:image_picker/image_picker.dart';), code:dart (import 'dart:typed_data';), code:yaml (dependencies:), code:dart (// In build() method, update content section:), code:bash (git add frontend/lib/services/api_service.dart), Task 5.2: Frontend - Camera & Drawing Upload (+13 more)
...
Cohesion: 0.11
Nodes (18): applyPhonePortraitOrientations, AuthGate, _AuthGateState, AuthScreen, didChangeMetrics, dispose, FireplaceApp, initState (+10 more)
...
Cohesion: 0.11
Nodes (16): code:dart (/// Persist decrypted message content to survive app restart), code:bash (cd frontend && flutter test), code:bash (git add frontend/lib/services/encryption_service.dart CLAUDE), code:ts (import { ChatKeyExchangeService } from './chat-key-exchange.), code:bash (cd backend && npm test -- --testPathPattern=chat-key-exchang), code:ts (import { ConversationsService } from '../../conversations/co), code:ts (@UseGuards(WsThrottlerGuard)), code:bash (cd backend && npm test -- --testPathPattern=chat-key-exchang) (+8 more)

### Community 68 - "Community 68"
Cohesion: 0.2
Nodes (4): PendingBucket, PushNotificationCoalescingService, NotifyOptions, PushNotificationsService

### Community 69 - "Community 69"
Cohesion: 0.14
Nodes (10): KeyBundleData, KeyBundlesService, OneTimePreKeyData, PreKeyBundleResponse, bundle, callOrder, entities, keys (+2 more)
...
Cohesion: 0.14
Nodes (17): code:yaml (just_audio: ^0.9.36  # already exists), code:bash (git add frontend/pubspec.yaml frontend/pubspec.lock), code:dart (enum MessageType {), code:dart (static MessageType _parseMessageType(String? type) {), code:bash (git add frontend/lib/models/message_model.dart), code:dart (import 'package:flutter/material.dart';), code:dart (import 'dart:async';), code:dart (class _ChatInputBarState extends State<ChatInputBar> {) (+9 more)
...
Cohesion: 0.12
Nodes (14): code:dart (@override), code:dart (@override), code:bash (git add frontend/lib/widgets/conversation_tile.dart frontend), Step 5.2: Wrap tile content in Dismissible, Step 5.4: Verify Flutter compiles, Step 5.5: Commit swipe-to-delete changes, Task 5: Frontend - ConversationTile Swipe-to-Delete, code:dart (try {) (+6 more)
...
Cohesion: 0.18
Nodes (14): build, Center, Column, dispose, Function, GifPickerSheet, _GifPickerSheetState, initState (+6 more)
...
Cohesion: 0.13
Nodes (14): code:typescript (import {), code:typescript (async createImageMessage(data: {), code:typescript (import { MessagesController } from './messages.controller';), code:bash (curl -X POST http://localhost:3000/messages/image \), code:bash (git add backend/src/messages/messages.controller.ts), Task 5.1: Backend - Image Message Upload Endpoint, code:typescript (export { DeleteConversationOnlyDto } from './delete-conversa), code:typescript (import {) (+6 more)
...
Cohesion: 0.16
Nodes (13): 1. User A Deletes Conversation, User B Sends Message Simultaneously, 2. User A Deletes Conversation, Then User B Unfriends, 3. Re-opening Chat Before Full Deletion (Race Condition), Edge Cases, Chat Scroll: `reverse: true` Refactor, code:dart (_scrollController.jumpTo(preOffset + (newExtent - preExtent)), Edge Cases, Industry precedent (+5 more)
...
Cohesion: 0.17
Nodes (13): code:bash (cd frontend), code:bash (git add frontend/lib/models/message_model.dart), Phase 2: Frontend - Message Model & Provider Updates, Task 2.1: Extend MessageModel with New Fields, code:dart (class MessageModel {), code:dart (factory MessageModel.fromJson(Map<String, dynamic> json) {), code:dart (MessageModel copyWith({), code:bash (git add frontend/lib/models/message_model.dart) (+5 more)
...
Cohesion: 0.15
Nodes (12): code:typescript (/** True if either user has blocked the other. Single query ), code:bash (cd backend && git add src/blocked/blocked.service.ts), code:typescript (import { ExecutionContext, Injectable } from '@nestjs/common), code:typescript (import { WsThrottlerGuard } from './guards/ws-throttler.guar), code:typescript (import { UseGuards } from '@nestjs/common';), code:typescript (@UseGuards(WsThrottlerGuard)), code:bash (cd backend && npm test --no-coverage 2>&1 | tail -10), code:bash (cd backend && git add src/chat/guards/ws-throttler.guard.ts ) (+4 more)
...
Cohesion: 0.18
Nodes (8): SendMessageDto, dto, mediaUrlError, data, result, SimpleDto, textPayload, validVoicePayload
...
Cohesion: 0.22
Nodes (8): Chat Screen Redesign - End-to-End Test Plan, Test 5.1: Open Camera, Test 5.2: Take Photo and Upload, Test 5.3: Cancel Camera, Test 5: Camera Image Upload, Test 6.1: Open Gallery, Test 6.2: Select and Upload Image, Test 6: Gallery Attachment (via ChatInputBar)
...
Cohesion: 0.22
Nodes (9): code:dart (if (_activeConversationId == conversationId && content.isNot), code:dart (if (_activeConversationId == conversationId && content.isNot), code:bash (cd frontend && flutter analyze 2>&1 | tail -5), code:bash (git add frontend/lib/providers/chat_provider.dart), Fix B: Retry preserves `replyToMessageId` (4.3), Step 1: Apply all three fixes above, Step 2: Analyze, Step 3: Commit (+1 more)
...
Cohesion: 0.25
Nodes (7): code:dart (IconButton(), Step 5.1: Remove IconButton delete, code:dart (Future<void> _loadAndPlayAudio() async {), code:dart (bool _isExpired() {), code:bash (git add frontend/lib/widgets/voice_message_bubble.dart), Task 5.2: Handle expired voice messages, code:dart (Future<void> _loadAndPlayAudio() async {)
...
Cohesion: 0.29
Nodes (7): 3. Backend — Gateway + Services, `chat-friend-request.service.ts` (503 LOC) -> Split, `chat.gateway.ts` (462 LOC, 29 handlers) -> Thin Gateway, `chat-message.service.ts` (522 LOC) -> Split, code:block10 (chat/services/), code:block9 (chat/services/), `messages.service.ts` (428 LOC) -> Keep as-is
...
Cohesion: 0.4
Nodes (5): code:dart (Widget _buildDeliveryIcon() {), code:dart (String? _getTimerText() {), code:dart (@override), code:bash (git add frontend/lib/widgets/chat_message_bubble.dart), Task 3.1: Update ChatMessageBubble with Delivery Indicator & Timer
...
Cohesion: 0.4
Nodes (5): code:dart (context.read<ChatProvider>().deleteConversation(conversation), code:dart (context.read<ChatProvider>().deleteConversationOnly(conversa), code:dart ('This will delete all messages. This action cannot be undone), code:dart ('This will delete all messages. Your contact will remain in ), Step 5.3: Update ConversationsScreen to call new method
...
Cohesion: 0.67
Nodes (3): Backend, Frontend, Prerequisites
...
- **Why does `chat_detail_screen.dart` connect `Community 17` to `Community 289`, `Community 3`, `Community 4`, `Community 100`, `Community 6`, `Community 38`, `Community 12`, `Community 44`, `Community 14`, `Community 18`, `Community 19`, `Community 22`, `Community 26`, `Community 27`, `Community 29`, `Community 30`?**
  _High betweenness centrality (0.142) - this node is a cross-community bridge._
- **Why does `Full Codebase Refactor — Domain-Driven Decomposition` connect `Community 208` to `Community 226`, `Community 110`, `Community 47`, `Community 214`, `Community 247`, `Community 281`?**
  _High betweenness centrality (0.138) - this node is a cross-community bridge._
- **Why does `Summary` connect `Community 208` to `Community 224`, `Community 67`, `Community 200`, `Community 297`, `Community 177`, `Community 86`, `Community 182`, `Community 184`, `Community 95`?**
