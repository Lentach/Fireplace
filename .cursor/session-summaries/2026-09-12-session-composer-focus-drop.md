...
- NOT verified: real iOS PWA and Android PWA devices (no real soft keyboard in headless Chrome — the keyboard-up half of the contract still rests on the widget test), and prod.
