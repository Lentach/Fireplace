...
**Date:** 2026-07-28 — **invitation rework IMPLEMENTED, PR #106 open, CI green on all three jobs.** Branch `feat/invitation-rework` (worktree `fireplace-wt-invitation`), master merged in, `mergeStateStatus: CLEAN`. Backend 564/47, Flutter **960**+4, live `test_e2e` 11 — all exit 0. **Not merged, not deployed.** ➡ `2026-07-28-invitation-implementation.md`; plan `docs/plans/2026-07-28-invitation-implementation-plan.md`.
