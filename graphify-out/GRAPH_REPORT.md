# Graph Report - Fireplace  (2026-05-17)

## Corpus Check
- 343 files · ~353,397 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4925 nodes · 7878 edges · 308 communities (295 shown, 13 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2489a61c`
...
## Communities (308 total, 13 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (27): buildCorsOrigin(), ChatGateway, AcceptFriendRequestDto, AddReactionDto, ALLOWED_EMOJIS, BlockUserDto, MEDIA_URL_REGEX, _mediaOriginEscaped (+19 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (74): avatar_circle.dart, build, combineDisappearingSeconds, Duration, isMessageExpired, SizedBox, AvatarCircle, _AvatarCircleState (+66 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (75): _addMessageToState, addReaction, _cancelDelayedRetry, _cancelDelayedRetryIfAny, clearAll, clearChatHistory, clearMessages, clearPingEffect (+67 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (53): acceptFriendRequest, connect, deleteConversation, emitAddReaction, emitBlockUser, emitClearChatHistory, emitDeleteConversationOnly, emitDeleteMessage (+45 more)

### Community 4 - "Community 4"
Cohesion: 0.07
Nodes (41): Conversation, GetMessagesDto, SendMessageDto, MarkConversationReadDto, MessageDeliveredDto, ConversationMapper, conv, createMockConversation() (+33 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (36): mockUser, UploadMediaDto, DeleteAccountDto, RegisterFcmTokenDto, RegisterWebPushSubscriptionDto, RemoveFcmTokenDto, RemoveWebPushSubscriptionDto, WebPushKeysDto (+28 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (56): _ActionTile, AlertDialog, _apply, build, _CenterProgressOverlay, ChatActionTiles, _CircularProgressPainter, _clearError (+48 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (57): Ciphertext String Format, code:block1 (Alice                          Server                       ), code:typescript (@Column({ type: 'text', nullable: true, default: null })), code:typescript (encryptedContent: message.encryptedContent ?? null,), code:typescript (@IsOptional() @IsString()), code:typescript (@ValidateIf((o) => !o.encryptedContent && !['VOICE', 'PING']), code:yaml (libsignal_protocol_dart: ^0.7.4), code:dart (class EncryptionService {) (+49 more)

### Community 8 - "Community 8"
Cohesion: 0.07
Nodes (11): BlockedService, ConversationsService, FriendsService, MediaCleanupService, ChatConversationService, friend, mockFriendRequest, mockRecipient (+3 more)

### Community 9 - "Community 9"
Cohesion: 0.12
Nodes (29): AuthModule, BlockedModule, BlockedUser, ChatModule, ChatValidationModule, Environment, EnvironmentVariables, validate() (+21 more)

### Community 10 - "Community 10"
Cohesion: 0.05
Nodes (45): getBaseUrlForPlatform, getBaseUrlForPlatform, BadgingBridge, createBadgingBridge, _navigator, _navigatorHasBadgingApi, base64UrlEncode, _base64UrlToUint8List (+37 more)

### Community 11 - "Community 11"
Cohesion: 0.06
Nodes (52): ../audio/playback_controller.dart, ../audio/waveform_display.dart, Icon, _formatTime, Row, Semantics, build, _buildContentColumn (+44 more)
...
Cohesion: 0.05
Nodes (52): Summary, 2. Frontend — Widget Decomposition, 3. Backend — Gateway + Services, 4. Directory Structure After Refactor, 5. Summary, 7. CLAUDE.md Gotchas Preservation Checklist, Backend `src/chat/`, `chat-friend-request.service.ts` (503 LOC) -> Split (+44 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (46): Center, initState, build, Directory, dispose, Exception, Function, initState (+38 more)

### Community 15 - "Community 15"
Cohesion: 0.06
Nodes (45): getOtherUserId, getOtherUserUsername, clearActiveIfDeletedByOther, _clearActiveIfRemoved, clearAll, clearError, closeConversation, ConversationsProvider (+37 more)

### Community 16 - "Community 16"
Cohesion: 0.06
Nodes (47): blocked_users_screen.dart, BlockedUsersScreen, _BlockedUserTile, build, Padding, Scaffold, SizedBox, build (+39 more)
...
Cohesion: 0.07
Nodes (39): add_or_invitations_screen.dart, _AddByUsernameTab, _AddByUsernameTabState, AddOrInvitationsScreen, build, Card, Center, DefaultTabController (+31 more)

### Community 19 - "Community 19"
Cohesion: 0.06
Nodes (39): 3. Run on device, code:block25, code:block26, code:bash (git add README.md), code:bash (docker-compose down), code:bash (taskkill //F //IM node.exe), code:bash (docker-compose up --build), code:bash (curl http://localhost:3000) (+31 more)

### Community 20 - "Community 20"
Cohesion: 0.06
Nodes (35): MainShell, LayoutBuilder, build, _buildScaffold, _ChatBubblePainter, ContactsScreen, CustomPaint, didChangeAppLifecycleState (+27 more)

### Community 21 - "Community 21"
Cohesion: 0.07
Nodes (32): main, main, _wrap, _lastMessage, main, MaterialApp, MessageModel, _wrap (+24 more)

### Community 22 - "Community 22"
Cohesion: 0.09
Nodes (35): acceptFriendRequest, blockUser, clearAll, clearSearchResults, consumeFriendRequestSent, FriendsProvider, Function, isFriend (+27 more)

### Community 23 - "Community 23"
Cohesion: 0.07
Nodes (33): Exception, _sanitizeFilename, build, buildRecordingBar, _checkMicPermission, dispose, _emitRecordingVoiceToRecipient, Exception (+25 more)
...
Cohesion: 0.06
Nodes (32): build, _columnLabel, CupertinoTheme, DisappearingTimerSheet, _DisappearingTimerSheetState, dispose, _durationPicker, Expanded (+24 more)

### Community 26 - "Community 26"
Cohesion: 0.06
Nodes (33): Backend, Backend Changes, Changing conversation timer, `CLAUDE.md`, Constants, `conversations` (unchanged), Data Model, Expiry sweep (`removeExpiredMessages`, `ChatDetailScreen` 1s timer) (+25 more)

### Community 27 - "Community 27"
Cohesion: 0.07
Nodes (18): AuthService, mockConfigService, mockUsersService, context, mockSocket, req, { req, res }, { res } (+10 more)

### Community 28 - "Community 28"
Cohesion: 0.09
Nodes (31): build, _buildInfoCard, _buildLocalCacheCard, Center, Container, initState, PrivacySafetyScreen, _PrivacySafetyScreenState (+23 more)

### Community 29 - "Community 29"
Cohesion: 0.06
Nodes (26): AuthForm, _AuthFormState, build, Form, build, Dialog, dispose, ResetPasswordDialog (+18 more)

### Community 30 - "Community 30"
Cohesion: 0.07
Nodes (26): SettingsProvider, clearDecryptedContentCache, _decryptedContentKey, _decryptedContentPrefix, EncryptionService, _generateKeys, _pruneDecryptedContentCache, clearPrefsCache (+18 more)

### Community 31 - "Community 31"
Cohesion: 0.08
Nodes (27): anti_quantum_note_dialog.dart, AppScrollBehavior, buildOverscrollIndicator, AntiQuantumNoteDialog, _AntiQuantumNoteDialogState, build, dispose, Expanded (+19 more)

### Community 32 - "Community 32"
Cohesion: 0.07
Nodes (30): Chunk 2: Frontend — Extract EncryptionProvider (Phase 2), Chunk 3: Frontend — Extract FriendsProvider (Phase 3), Chunk 4: Frontend — Extract ConnectionProvider + ConversationsProvider + MessagingProvider (Phase 4), code:dart (// In main.dart, update MultiProvider:), code:dart (final chat = context.read<ChatProvider>();), code:bash (git add frontend/lib/main.dart frontend/lib/providers/chat_p), code:bash (git add frontend/lib/providers/friends_provider.dart), code:bash (git add frontend/lib/main.dart frontend/lib/providers/chat_p) (+22 more)
...
Cohesion: 0.09
Nodes (29): app_localizations.dart, app_localizations_en.dart, app_localizations_pl.dart, antiQuantumNoteSendFailed, AppLocalizations, _AppLocalizationsDelegate, AppLocalizationsEn, AppLocalizationsPl (+21 more)

### Community 35 - "Community 35"
Cohesion: 0.09
Nodes (28): AlertDialog, build, _buildContactsList, _buildContactTile, _buildHeader, _compareByDisplayName, ContactsScreen, Container (+20 more)

### Community 36 - "Community 36"
Cohesion: 0.12
Nodes (6): PendingBucket, PushNotificationCoalescingService, NotifyOptions, PushNotificationsService, WebPushSubscriptionsService, WebPushSubscriptionUpsertInput
...
Cohesion: 0.07
Nodes (25): applyPhonePortraitOrientations, AuthGate, _AuthGateState, AuthScreen, didChangeMetrics, dispose, FireplaceApp, initState (+17 more)

### Community 39 - "Community 39"
Cohesion: 0.07
Nodes (25): Future Enhancements, Chat Screen Architecture - Source of Truth, Client → Server, code:typescript (@Entity('messages')), Colors (RpgTheme), Countdown Not Live Updating, Current Limitations, Database Schema Changes (+17 more)
...
Cohesion: 0.08
Nodes (26): code:bash (git add frontend/lib/providers/chat_provider.dart), code:dart (// Monotonic counter for temporary negative message IDs — pr), code:dart (id: -DateTime.now().millisecondsSinceEpoch, // Temporary neg), code:dart (id: -(++ChatProvider._tempIdSeq), // Monotonic temporary neg), code:dart (if (_activeConversationId == conversationId && content.isNot), code:dart (if (_activeConversationId == conversationId && content.isNot), code:dart (bool _decryptingHistory = false;), code:dart (_decryptHistoryCancelled = true;) (+18 more)

### Community 44 - "Community 44"
Cohesion: 0.09
Nodes (24): code:dart (void connect(String token, int userId) {), code:dart (void _handleMessageDelivered(Map<String, dynamic> data) {), code:dart (void sendPing(int recipientId) {), code:dart (void _handlePingReceived(Map<String, dynamic> data) {), code:dart (void sendMessage(String content, {int? expiresIn}) {), code:dart (void _handleIncomingMessage(Map<String, dynamic> data) {), code:bash (git add frontend/lib/providers/chat_provider.dart), code:typescript (export class SendMessageDto {) (+16 more)

### Community 45 - "Community 45"
Cohesion: 0.1
Nodes (23): Implementation Phases, Phase 2: Frontend Recording, Phase 3: Frontend Upload & Optimistic UI, Phase 4: Frontend Playback, Phase 6: Testing & Refinement, code:dart (void sendMessage({), code:bash (git add frontend/lib/services/socket_service.dart frontend/l), code:dart (import 'dart:io';) (+15 more)

### Community 47 - "Community 47"
Cohesion: 0.14
Nodes (14): JwtAuthGuard, _decodeHtmlEntities, isSafeImageUrl, LinkPreviewService, MessagesController, expectedPayload, preview, extractFirstUrl() (+6 more)
...
Cohesion: 0.1
Nodes (17): badging_bridge_stub.dart, cancel, ChatReconnectManager, Duration, onDisconnect, resetAttempts, scheduleReconnect, onDisconnect (+9 more)
...
Cohesion: 0.1
Nodes (20): code:dart (Widget _buildDeliveryIcon() {), code:dart (String? _getTimerText() {), code:dart (@override), code:bash (git add frontend/lib/widgets/chat_message_bubble.dart), Task 3.1: Update ChatMessageBubble with Delivery Indicator & Timer, Phase 5: Error Handling & Polish, code:bash (git add frontend/lib/widgets/voice_recording_overlay.dart), code:dart (Future<void> retryVoiceMessage(String tempId) async {) (+12 more)

### Community 54 - "Community 54"
Cohesion: 0.1
Nodes (22): code:dart (Future<String> createSecretNote(String token, String ciphert), code:dart (import 'package:encrypt/encrypt.dart' as enc;), code:dart (Future<void> sendAntiQuantumNote({), code:bash (cd frontend && flutter test 2>&1 | tail -15), code:bash (git add frontend/lib/services/api_service.dart frontend/lib/), Task 7: sendNote in ChatProvider (crypto + API + send message), Chunk 3: Frontend — Remove ping socket events, update ApiService, code:bash (git add frontend/lib/services/socket_service.dart frontend/l) (+14 more)

### Community 55 - "Community 55"
Cohesion: 0.1
Nodes (20): code:typescript (/** True if either user has blocked the other. Single query ), code:bash (cd backend && npm test --no-coverage 2>&1 | tail -15), code:bash (cd backend && git add src/blocked/blocked.service.ts), code:typescript (it('does not serve the same OTP twice under concurrent calls), code:bash (cd backend && npm test -- --testPathPattern=key-bundles --no), code:bash (cd backend && npm test --no-coverage 2>&1 | tail -10), code:bash (cd backend && git add src/key-bundles/key-bundles.service.ts), code:typescript (import { ExecutionContext, Injectable } from '@nestjs/common) (+12 more)
...
Cohesion: 0.1
Nodes (19): SafeArea, _bannerDurationLabel, build, ChatInputBar, _ChatInputBarState, Column, dispose, _formatTimer (+11 more)

### Community 59 - "Community 59"
Cohesion: 0.1
Nodes (14): aesGcmDecrypt, aesGcmEncrypt, main, secureRandomBytes, main, main, main, dart:math (+6 more)

### Community 60 - "Community 60"
Cohesion: 0.1
Nodes (20): code:typescript (import {), code:typescript (import { IsInt } from 'class-validator';), code:typescript (export { DeleteConversationOnlyDto } from './delete-conversa), code:typescript (import {), code:bash (git add backend/src/chat/dto/delete-conversation-only.dto.ts), Step 1.1: Create DeleteConversationOnlyDto, Step 1.2: Export DTO in barrel file, Step 1.3: Add handleDeleteConversationOnly method (+12 more)

### Community 61 - "Community 61"
Cohesion: 0.11
Nodes (20): Already fixed (skip these), code:typescript (const token =), code:typescript (async upsertKeyBundle(userId: number, data: KeyBundleData): ), code:typescript (async findOrCreate(userOne: User, userTwo: User): Promise<Co), code:typescript (const token = client.handshake.auth?.token as string;), code:bash (cd backend && npm run build && npm test), code:bash (git add backend/src/key-bundles/key-bundles.service.ts \), code:typescript (@IsString()) (+12 more)

### Community 62 - "Community 62"
Cohesion: 0.11
Nodes (19): Context, Kolejność implementacji, Krytyczne pliki, Plan: Link Preview, Weryfikacja, code:bash (docker logs mvp-chat-app-backend-1 --tail 50), code:block21 ([ChatGateway] Client connected: <socket_id>), Kontakt i Wsparcie (+11 more)

### Community 63 - "Community 63"
Cohesion: 0.12
Nodes (21): Architecture, Backend Services, E2E Encryption, Frontend Providers, Architecture, Benefits Summary, Development Experience, Performance (+13 more)
...
Cohesion: 0.11
Nodes (13): AppConstants, E2eEnvelope, main, main, main, main, main, package:fireplace/constants/app_constants.dart (+5 more)

### Community 66 - "Community 66"
Cohesion: 0.13
Nodes (20): 1. New DTO: DeleteConversationOnlyDto, 2. New Handler: handleDeleteConversationOnly, 3. Remove: handleDeleteConversation, 4. Unchanged: handleUnfriend, 5. Modified: ChatGateway, 6. Verify: startConversation, Backend Changes, code:typescript (@SubscribeMessage('deleteConversation') // ← delete this ent) (+12 more)

### Community 67 - "Community 67"
Cohesion: 0.1
Nodes (19): code:bash (git add backend/src/messages/entities/message.entity.ts), code:typescript (import { Entity, PrimaryGeneratedColumn, Column, ManyToOne, ), code:typescript (@SubscribeMessage('messageDelivered')), code:bash (# Backend will auto-sync with TypeORM synchronize:true), code:javascript (// Send message with expiration), Task 1.1: Add Message Delivery Status & Expiration, code:typescript (describe('handleMessageDelivered', () => {), code:bash (cd backend && npm test -- --testPathPattern=chat-message.ser) (+11 more)
...
Cohesion: 0.16
Nodes (16): api_service.dart, ApiService, _effectiveMediaUrl, Exception, jsonDecode, dispose, _fetch, GifModel (+8 more)

### Community 70 - "Community 70"
Cohesion: 0.11
Nodes (18): AuthProvider, _cancelSessionRefreshTimer, _clearLocalAuthState, clearPwaAppBadgeOnLogout, clearStatus, dispose, Exception, Function (+10 more)

### Community 71 - "Community 71"
Cohesion: 0.13
Nodes (18): Backend: deleteConversationOnly, Edge Case: Other User Offline, Error Handling, Frontend: Swipe-to-Delete Failure, 1. Permission Denied, 2. Recording Errors, 3. Upload Failures, 4. Playback Errors (+10 more)

### Community 72 - "Community 72"
Cohesion: 0.14
Nodes (19): 1.1 Frontend (Flutter), 1.3 iOS (`frontend/ios/Runner/Info.plist`), 1.4 Android (`frontend/android/app/src/main/AndroidManifest.xml`), 1. Current Configuration, 3.2 iOS — `frontend/ios/Runner/Info.plist`, 3.3 Android — `frontend/android/app/src/main/AndroidManifest.xml`, 3. Exact Code Changes, code:xml (<!-- Allow HTTP connections to local IP (development only) -) (+11 more)

### Community 73 - "Community 73"
Cohesion: 0.11
Nodes (18): Backend, Chat Screen Redesign - End-to-End Test Plan, Frontend, Prerequisites, Test 5.1: Open Camera, Test 5.2: Take Photo and Upload, Test 5.3: Cancel Camera, Test 5: Camera Image Upload (+10 more)

### Community 74 - "Community 74"
Cohesion: 0.11
Nodes (17): Chat Screen Redesign - Telegram/Wire Inspired UI, code:typescript (export enum MessageType {), code:typescript (import { IsInt } from 'class-validator';), code:typescript (import { SendPingDto } from './dto/send-ping.dto';), code:javascript (socket.emit('sendPing', { recipientId: 2 });), code:bash (git add backend/src/messages/entities/message.entity.ts), code:typescript (async handleSendMessage(), code:bash (# Start backend) (+9 more)

### Community 75 - "Community 75"
Cohesion: 0.12
Nodes (17): Phase 1: Backend Foundation, code:typescript (export enum MessageType {), code:typescript (@Post('voice')), code:typescript (import { CloudinaryModule } from '../cloudinary/cloudinary.m), code:bash (# First login to get JWT), code:bash (git add backend/src/messages/messages.controller.ts backend/), code:bash (git add backend/src/messages/message.entity.ts), code:typescript (@Column({ type: 'text', nullable: true })) (+9 more)
...
Cohesion: 0.11
Nodes (17): code:dart (@override), code:dart (@override), Step 5.2: Wrap tile content in Dismissible, code:dart (try {), code:dart (),), code:dart (@override), code:bash (cd frontend && flutter test), code:bash (git add frontend/lib/widgets/message/reaction_chips_row.dart) (+9 more)
...
Cohesion: 0.11
Nodes (17): antiQuantumNoteSendFailed, AppLocalizationsEn, conversationDisappearingTimerHint, conversationLastMessageEphemeralRemaining, disappearingComposerBanner, disappearingComposerBannerSemantics, disappearingTimerDays, disappearingTimerHours (+9 more)

### Community 82 - "Community 82"
Cohesion: 0.11
Nodes (17): code:ts (@Column({ type: 'timestamp', nullable: true })), code:ts (user.passwordChangedAt = new Date();), code:ts (async validate(payload: {), code:ts (import { JwtStrategy } from './strategies/jwt.strategy';), code:ts (import { Controller, Get, Res, HttpStatus } from '@nestjs/co), code:ts (import { Module } from '@nestjs/common';), code:ts (import { HealthModule } from './health/health.module';), code:yaml (healthcheck:) (+9 more)
...
Cohesion: 0.12
Nodes (16): bodyFont, Color, ephemeralAccent, FireplaceColors, formatMessageClock, InputDecoration, isDark, messageBubbleMetaColor (+8 more)

### Community 85 - "Community 85"
Cohesion: 0.12
Nodes (16): antiQuantumNoteSendFailed, AppLocalizationsPl, conversationDisappearingTimerHint, conversationLastMessageEphemeralRemaining, disappearingComposerBanner, disappearingComposerBannerSemantics, disappearingTimerDays, disappearingTimerHours (+8 more)

### Community 86 - "Community 86"
Cohesion: 0.12
Nodes (15): 1. Podsumowanie, 3. Drobne uwagi (jakość kodu i spójność), 4. Co jest dobre, 5. Szansa na sukces, Chat Screen Architecture & Plan — Code Review, 3. Integracja z ChatProvider, 4. Zgodność z architekturą, 7. Rekomendacje na przyszłość (+7 more)
...
Cohesion: 0.12
Nodes (17): code:dart (enum MessageDeliveryStatus {), code:bash (cd frontend), code:bash (git add frontend/lib/models/message_model.dart), Phase 2: Frontend - Message Model & Provider Updates, Task 2.1: Extend MessageModel with New Fields, 5. ChatProvider Enhancements, code:dart (Future<void> sendVoiceMessage({), code:dart (enum MessageDeliveryStatus {) (+9 more)

### Community 92 - "Community 92"
Cohesion: 0.12
Nodes (16): Chunk 2: Frontend — Model + Config + API Service, Chunk 3: Frontend — L10n + GifService + GifPickerSheet, Chunk 5: Integration + CLAUDE.md, code:dart (static String get giphyApiKey {), code:bash (git add frontend/lib/config/app_config.dart), code:dart (Future<Map<String, dynamic>> uploadMedia({), code:dart (} else if (type == 'gif' && gifBytes != null) {), code:json ("gifNoResults": "Nie znaleziono GIFów",) (+8 more)

### Community 93 - "Community 93"
Cohesion: 0.12
Nodes (17): ═══════════════════════════════════════, code:typescript (// backend/src/media/local-storage.service.spec.ts), code:bash (cd backend && npx jest local-storage.service.spec.ts --no-co), code:typescript (// deleteMessage for_everyone:), code:typescript (// Before deleting conversation:), code:typescript (// backend/src/media/local-storage.service.ts), code:typescript (const userMessages = await this.messagesService.findAllBySen), code:bash (cd backend && npm test) (+9 more)

### Community 94 - "Community 94"
Cohesion: 0.12
Nodes (15): code:ts (import { ChatKeyExchangeService } from './chat-key-exchange.), code:bash (cd backend && npm test -- --testPathPattern=chat-key-exchang), code:ts (import { ConversationsService } from '../../conversations/co), code:ts (@UseGuards(WsThrottlerGuard)), code:bash (cd backend && npm test -- --testPathPattern=chat-key-exchang), code:bash (cd backend && npm test), code:bash (git add backend/src/chat/services/chat-key-exchange.service.), Task 3: Session Rebuild DoS Protection (+7 more)

### Community 95 - "Community 95"
Cohesion: 0.12
Nodes (17): 4. Implementation Procedure, code:powershell (ipconfig), code:bash (ifconfig | grep "inet " | grep -v 127.0.0.1), code:bash (# Docker), code:bash (cd frontend/ios), Step 1: Find computer IP, Step 2: Update backend CORS, Step 3: Edit iOS Info.plist (+9 more)
...
Cohesion: 0.12
Nodes (15): 2.1 Walidacja „blocked + friends” w backendzie, 2.2 Wielokrotne tworzenie `ApiService` w frontendzie, 2. Duplikacja logiki, 4. Zbyt duże pliki, 5.1 Zamierzone no-op, 5.2 Placeholdery do uzupełnienia, 5. Funkcje / miejsca „nic nie robiące”, 6.1 Co działa dobrze (+7 more)
...
Cohesion: 0.14
Nodes (16): code:bash (cd frontend), code:bash (flutter run --dart-define=BASE_URL=http://192.168.1.100:3000), Step 6: Run Flutter on device, code:bash (cd frontend), code:xml (<manifest xmlns:android="http://schemas.android.com/apk/res/), code:xml (<manifest xmlns:android="http://schemas.android.com/apk/res/), code:bash (cd frontend/ios), code:bash (cd frontend) (+8 more)
...
Cohesion: 0.13
Nodes (11): ConversationModel, FriendRequestModel, copyWith, MessageModel, needsDecryption, parseDeliveryStatus, _parseMessageType, ReplyToPreview (+3 more)
...
Cohesion: 0.14
Nodes (14): code:bash (git add frontend/lib/providers/chat_provider.dart), Step 4.5: Commit ChatProvider changes, code:bash (rm frontend/lib/screens/archive_placeholder_screen.dart), code:bash (git add -u frontend/lib/screens/), code:dart (// DELETE THIS BLOCK:), code:bash (git add frontend/lib/providers/auth_provider.dart), code:bash (git add frontend/lib/providers/chat_provider.dart), code:bash (git add frontend/lib/services/socket_service.dart) (+6 more)
...
Cohesion: 0.15
Nodes (13): Chunk 1: Drawing Removal + Envelope Extension + Model Changes, Chunk 4: Frontend — Encrypt all message types, code:dart (// After successful upload:), code:bash (git add frontend/lib/providers/chat_provider.dart), code:bash (git add -A frontend/lib/screens/drawing_canvas_screen.dart f), E2E Encryption for All Message Types + Drawing Removal — Implementation Plan, Task 11: Encrypt voice messages, Task 2: Remove Drawing from frontend (+5 more)
...
Cohesion: 0.13
Nodes (15): code:typescript (// backend/src/auth/auth-challenge.store.spec.ts), code:bash (cd backend && npx jest src/auth/auth-challenge.store.spec.ts), code:typescript (// backend/src/auth/auth-challenge.store.ts), code:bash (cd backend && npx jest src/auth/auth-challenge.store.spec.ts), code:bash (git add backend/src/auth/auth-challenge.store.ts backend/src), code:typescript (// backend/src/auth/auth.module.ts), code:bash (cd backend && npm run build), code:bash (# In Docker) (+7 more)
...
Cohesion: 0.14
Nodes (14): code:yaml (cryptography: ^2.7.0), code:bash (cd frontend && flutter pub get), code:bash (git add frontend/pubspec.yaml frontend/pubspec.lock), code:dart (// frontend/test/services/crypto/auth_identity_keypair_test.), code:bash (cd frontend && flutter test test/services/crypto/auth_identi), code:dart (// frontend/lib/services/crypto/auth_identity_keypair.dart), code:bash (cd frontend && flutter test test/services/crypto/auth_identi), code:bash (git add frontend/lib/services/crypto/auth_identity_keypair.d) (+6 more)

### Community 132 - "Community 132"
Cohesion: 0.14
Nodes (13): code:typescript (// message-expiry.util.spec.ts), Execution, File Structure, Read-Based Disappearing Messages Implementation Plan, Self-Review (risks), Task 1: Backend constants and expiry utility, Task 2: Entity, create path, mapper, Task 3: Send + getMessages + markConversationRead (+5 more)
...
Cohesion: 0.24
Nodes (5): MessageCleanupService, expired, isMessageExpired(), createdAt, now

### Community 135 - "Community 135"
Cohesion: 0.15
Nodes (11): main, _gifMessage, main, _wrap, _wrapBubble, package:fireplace/providers/auth_provider.dart, package:fireplace/providers/friends_provider.dart, package:fireplace/widgets/message/chat_message_bubble.dart (+3 more)
...
Cohesion: 0.15
Nodes (12): 1. Clone the repository, 1. Clone the repository, 1. Install dependencies, 1. Install dependencies, 2. Build and run, 2. Connect device via USB or WiFi, 2. Start backend + database, code:block18 (+4 more)
...
Cohesion: 0.18
Nodes (13): code:yaml (just_audio: ^0.9.36  # already exists), code:bash (git add frontend/pubspec.yaml frontend/pubspec.lock), code:dart (import 'package:flutter/material.dart';), code:dart (import 'dart:async';), code:dart (class _ChatInputBarState extends State<ChatInputBar> {), code:dart (Future<void> _checkMicPermission() async {), code:dart (// Mic/Send button), code:bash (git add frontend/lib/widgets/chat_input_bar.dart) (+5 more)

### Community 148 - "Community 148"
Cohesion: 0.17
Nodes (13): code:bash (git status), code:bash (git add -A), code:bash (git log --oneline -8), code:bash (git push origin master), Task 12: Final Commit and Summary, code:bash (cd frontend && flutter analyze), code:bash (cd backend && npm run build), code:bash (git status) (+5 more)

### Community 149 - "Community 149"
Cohesion: 0.15
Nodes (12): BASE_URL Setup, code:bash (flutter run -d <device> --dart-define=BASE_URL=http://192.16), code:dart (// lib/constants/app_constants.dart), code:dart (// lib/config/env_config.dart), code:bash (# Enable USB debugging on phone (Settings → Developer Option), code:bash (# First time (via USB):), Flutter Configuration, Flutter Devices Setup (+4 more)
...
Cohesion: 0.17
Nodes (11): applyRefreshedAccessToken, ConnectionProvider, disconnect, dispose, emit, ensureReconnectIfNeeded, _registerEventListeners, setProviders (+3 more)

### Community 157 - "Community 157"
Cohesion: 0.17
Nodes (9): _FakeEncryptionProvider, main, TimeoutException, main, expectLater, main, package:fake_async/fake_async.dart, package:fireplace/providers/encryption_provider.dart (+1 more)
...
Cohesion: 0.17
Nodes (12): code:dart (test('build includes messageType when provided', () {), code:dart (class E2eEnvelope {), code:bash (git add frontend/lib/utils/e2e_envelope.dart frontend/test/u), Task 3: Extend E2E Envelope with messageType, mediaUrl, mediaDuration, code:dart (import 'dart:convert';), code:bash (cd frontend && flutter test test/utils/e2e_envelope_test.dar), code:dart (// Add two new key constants:), code:bash (grep -rn "E2eEnvelope.parse\|\.parse(" frontend/lib --includ) (+4 more)
...
Cohesion: 0.18
Nodes (11): code:dart (// frontend/lib/utils/e2e_envelope.dart), code:block11 (cd frontend && flutter test test/utils/e2e_envelope_test.dar), code:block12 (git add frontend/lib/utils/e2e_envelope.dart \), code:dart (// frontend/test/utils/e2e_envelope_test.dart), code:block80 (cd frontend && flutter test && flutter analyze lib/), code:block9 (cd frontend && flutter test test/utils/e2e_envelope_test.dar), File Map, Media Encryption (Client-Side AES-256-GCM) Implementation Plan (+3 more)
...
Cohesion: 0.18
Nodes (10): 1. Kontekst z CLAUDE.md, 2.1 ChatDetailScreen, 2.2 ChatInputBar, 2.3 ChatActionTiles, 2.4 ChatMessageBubble, 2.5 PingEffectOverlay, 2. Co jest już zaimplementowane i spójne, 4. Spójność z architekturą (okno rozmowy) (+2 more)
...
Cohesion: 0.18
Nodes (11): 1. Database Changes, 2. Cloudinary Service Enhancement, 3. New REST Endpoint, 4. WebSocket Integration, Backend Components, code:typescript (export enum MessageType {), code:typescript (async uploadVoiceMessage(), code:typescript (@Post('voice')) (+3 more)
...
Cohesion: 0.18
Nodes (11): code:ts (import {), code:ts (@IsString()), code:ts (@IsString()), code:bash (cd backend && npm test -- --no-coverage), code:bash (git add backend/src/config/env.validation.ts), code:ts (import {), code:ts (@Index('idx_messages_conv_created', ['conversation', 'create), code:bash (cd backend && npm test -- --no-coverage) (+3 more)
...
Cohesion: 0.2
Nodes (8): ArgumentError, EncryptedMedia, MediaCryptoService, expectLater, expectLater, main, MediaCryptoService, package:fireplace/services/media_crypto_service.dart

### Community 185 - "Community 185"
Cohesion: 0.2
Nodes (7): main, main, buildProviderWithSampleData, main, package:fireplace/models/conversation_model.dart, package:fireplace/models/user_model.dart, package:fireplace/providers/conversations_provider.dart

### Community 186 - "Community 186"
Cohesion: 0.2
Nodes (9): 2.1 ChatDetailScreen ✅, 2.2 ChatInputBar ✅, 2.3 ChatActionTiles ✅, 2.4 ChatMessageBubble ✅, 2.5 PingEffectOverlay ✅, 2. Przegląd komponentów okna chatu, code:block10 (Column:), code:dart (switch (message.deliveryStatus) {) (+1 more)
...
Cohesion: 0.2
Nodes (10): 3.1 Backend CORS — `docker-compose.yml`, code:yaml (ALLOWED_ORIGINS: 'http://localhost:3000,http://localhost:808), code:yaml (ALLOWED_ORIGINS: 'http://localhost:3000,http://localhost:808), code:env (ALLOWED_ORIGINS=http://localhost:3000,http://localhost:8080,), 1. Backend CORS, 2. iOS - `frontend/ios/Runner/Info.plist`, code:env (ALLOWED_ORIGINS=http://localhost:3000,http://localhost:8080), code:env (ALLOWED_ORIGINS=http://localhost:3000,http://localhost:8080,) (+2 more)

### Community 190 - "Community 190"
Cohesion: 0.2
Nodes (10): code:block10, code:markdown (## 2. Quick Start), code:block12 (Backend: http://192.168.1.11:3000 (accessible from phone)), code:block13, code:block14 (Frontend: http://192.168.1.11:8080), code:markdown (**Last updated:** 2026-02-12), code:bash (git add CLAUDE.md), code:markdown (## Quick Start (Docker)) (+2 more)

### Community 191 - "Community 191"
Cohesion: 0.22
Nodes (10): 2. Run in Chrome (connects to backend on localhost:3000), 3. In another terminal: Run Flutter on your device, code:block20, code:block21 (- **Frontend (web):** http://localhost:8080), code:markdown (### Frontend), code:block23, code:markdown (### Frontend), code:block1 (┌───────────────────────────────────────────────────────────) (+2 more)

### Community 192 - "Community 192"
Cohesion: 0.2
Nodes (10): code:dart (import 'dart:ui' as ui;), code:dart (import '../screens/drawing_canvas_screen.dart';), code:bash (git add frontend/lib/screens/drawing_canvas_screen.dart), Task 3.6: Create Drawing Canvas Screen (Basic), 4. Modified: MainShell, code:dart (// Import), code:dart (import 'dart:async';), code:dart (import 'dart:async';) (+2 more)

### Community 193 - "Community 193"
Cohesion: 0.22
Nodes (10): code:bash (sudo nano /etc/nginx/sites-available/fireplace), code:bash (sudo ln -s /etc/nginx/sites-available/fireplace /etc/nginx/s), Etap 6: Nginx + SSL, code:bash (sudo certbot --nginx -d twoja-domena.com), code:bash (sudo nano /etc/nginx/sites-available/fireplace), code:nginx (server {), code:bash (sudo ln -s /etc/nginx/sites-available/fireplace /etc/nginx/s), Etap 6: Konfiguracja Nginx + SSL (+2 more)
...
Cohesion: 0.22
Nodes (7): main, _msg, main, MessageModel, _msg, package:fireplace/models/message_model.dart, package:fireplace/utils/message_expiry.dart
...
Cohesion: 0.22
Nodes (9): code:bash (scp -r frontend/build/web/* TWOJ_USER@<IP>:~/fireplace/front), code:nginx (server {), code:nginx (server {), Etap 8: Flutter web build, code:bash (# Lokalnie:), code:bash (# Skopiuj build na serwer), code:nginx (server {), Etap 8: Build frontendu (+1 more)
...
Cohesion: 0.25
Nodes (8): 3.1 Brak przekazywania expiresIn przy wysyłce (ChatInputBar), 3.2 Obrazki w bąbelku bez ograniczenia szerokości, 3.3 EmojiPicker — minimalna konfiguracja, 3.4 Plan vs kod — tempId przy optymistic message, 3.5 Ścieżki w commitach w planie, 3. Luki i rozbieżności (tylko okno rozmowy), code:dart (final expiresIn = chat.conversationDisappearingTimer;), code:dart (final chat = context.read<ChatProvider>();)
...
Cohesion: 0.29
Nodes (7): code:dart (void _handleConversationDeleted(dynamic data) {), code:dart (onConversationDeleted: _handleConversationDeleted,), Step 3.3: Verify Flutter compiles, Step 4.2: Add _handleConversationDeleted listener, Step 4.3: Register listener in connect() method, Step 4.4: Verify Flutter compiles, Task 4: Frontend - ChatProvider Methods
...
Cohesion: 0.29
Nodes (7): CLAUDE.md Updates, code:markdown (## 2. Quick Start), code:block21 (Backend: http://192.168.1.11:3000 (accessible from phone)), code:block22, code:block23 (Frontend: http://192.168.1.11:8080), code:markdown (## 2. Quick Start), Task 5: Update CLAUDE.md Section 2 (Quick Start)
...
Cohesion: 0.29
Nodes (6): code:typescript (const conversation = await this.conversationsService.findByI), code:bash (cd backend && npm run build && npm test), Step 1: Add membership check in `handleMarkConversationRead`, Step 2: Replace N-saves loop with batch UPDATE in `messages.service.ts`, Step 3: Build and test, Task 3: Membership check + batch READ update (3.2, 3.5)
...
Cohesion: 0.29
Nodes (7): code:dart (final parsed = E2eEnvelope.parse(encryptedContent);), code:dart (// In initState or a FutureBuilder:), code:dart (Future<void> _loadAndPlayAudio() async {), code:dart (// After decrypt:), code:bash (cd frontend && flutter analyze && flutter test), code:bash (git add frontend/lib/widgets/message/image_message_content.d), Task 10: Decrypt on receive — image, voice, GIF, file widgets
...
Cohesion: 0.29
Nodes (6): Handoff: PWA badge — liczba → kropka (indicator), Kontekst wcześniejszych usterek (żeby nie zepsuć), Opcjonalnie później (poza tym handoffem), Pliki do zmiany (stan na 2026-05-11), Sugestia implementacji API bridge, Testy / weryfikacja
...
Cohesion: 0.33
Nodes (5): Contacts Tab Implementation Plan, Notes for Implementation, Step 6.2: Verify Flutter compiles, Success Criteria Checklist, Task 6: Frontend - ContactsScreen

### Community 245 - "Community 245"
Cohesion: 0.33
Nodes (6): Step 9.1: Test Delete Conversation Flow, Step 9.2: Test Unfriend Flow, Step 9.3: Test ChatDetailScreen (no unfriend button), Step 9.4: Test Both Users (Multi-Device), Step 9.5: Document any issues, Task 9: Manual E2E Testing

### Community 246 - "Community 246"
Cohesion: 0.33
Nodes (6): Chunk 6: Final Cleanup + CLAUDE.md Update (Phase 6), code:bash (git add CLAUDE.md), Task 6.1: Line count verification, Task 6.2: Run all tests, Task 6.3: Update CLAUDE.md, Task 6.4: Final comprehensive smoke test

### Community 247 - "Community 247"
Cohesion: 0.33
Nodes (6): code:typescript (// backend/src/media/media-cleanup.service.spec.ts), code:bash (cd backend && npx jest media-cleanup.service.spec.ts --no-co), code:typescript (// backend/src/media/media-cleanup.service.ts), code:bash (cd backend && npx jest media-cleanup.service.spec.ts --no-co), code:bash (git add backend/src/media/media-cleanup.service.ts backend/s), Task 3: MediaCleanupService
...
Cohesion: 0.33
Nodes (6): code:dart (// frontend/test/services/auth_session_manager_test.dart), code:bash (cd frontend && flutter test test/services/auth_session_manag), code:dart (// frontend/lib/services/auth_session_manager.dart), code:bash (cd frontend && flutter test test/services/auth_session_manag), code:bash (git add frontend/lib/services/auth_session_manager.dart fron), Task 20 — `AuthSessionManager`
...
Cohesion: 0.4
Nodes (5): 6. Ostateczna ocena, Błędy naprawione: 4/4 ✅, Funkcjonalność: 100% ✅, Komponenty: 5/5 ✅, Zgodność z dokumentacją: 100% ✅
...
Cohesion: 0.4
Nodes (5): code:block4 (❌ frontend/Dockerfile.dev), Existing Files (No Changes), Files to Modify, Files to Remove, Migration Steps

### Community 269 - "Community 269"
Cohesion: 0.4
Nodes (5): 5. ChatProvider - New Methods, code:dart (void deleteConversationOnly(int conversationId) {), code:dart (onConversationDeleted: (data) {), code:dart (void deleteConversationOnly(int conversationId) {), Step 4.1: Add deleteConversationOnly method

### Community 270 - "Community 270"
Cohesion: 0.4
Nodes (5): code:block46, code:bash (# Find the backup commit), Frontend: http://localhost:8080, Rollback Plan, Verification Checklist
...
Cohesion: 0.4
Nodes (5): code:dart (// frontend/lib/utils/web_blob_utils_stub.dart), code:dart (// frontend/lib/utils/web_blob_utils_web.dart), code:block30 (cd frontend && flutter analyze lib/utils/web_blob_utils_stub), code:block31 (git add frontend/lib/utils/web_blob_utils_stub.dart \), Task 5: Web blob URL utilities
...
## Knowledge Gaps
- **2512 isolated node(s):** `mockUsersService`, `mockConfigService`, `dto`, `mediaUrlError`, `_mediaOriginEscaped` (+2507 more)
...
- **Why does `chat_detail_screen.dart` connect `Community 16` to `Community 1`, `Community 35`, `Community 186`, `Community 170`, `Community 11`, `Community 14`, `Community 15`, `Community 48`, `Community 209`, `Community 18`, `Community 51`, `Community 20`, `Community 153`, `Community 58`, `Community 28`, `Community 29`, `Community 31`?**
  _High betweenness centrality (0.156) - this node is a cross-community bridge._
- **Why does `Full Codebase Refactor — Domain-Driven Decomposition` connect `Community 13` to `Community 32`, `Community 115`, `Community 214`?**
  _High betweenness centrality (0.147) - this node is a cross-community bridge._
- **Why does `Summary` connect `Community 13` to `Community 100`, `Community 71`, `Community 73`, `Community 74`, `Community 203`, `Community 82`, `Community 114`?**
