...
## Corpus Check
- 326 files · ~342,156 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4672 nodes · 7532 edges · 322 communities (306 shown, 16 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `aa350a2d`
...
2. `package:flutter/material.dart` - 73 edges
3. `validateDto()` - 64 edges
4. `chat_detail_screen.dart` - 56 edges
5. `ChatMessageService` - 55 edges
6. `../chat_action_tiles.dart` - 51 edges
7. `../../theme/rpg_theme.dart` - 49 edges
8. `ChatGateway` - 47 edges
9. `UsersService` - 45 edges
10. `conversations_provider.dart` - 44 edges

## Surprising Connections (you probably didn't know these)
- `anti_quantum_note_dialog.dart` --defines--> `AntiQuantumNoteDialog`  [EXTRACTED]
  frontend/lib/widgets/chat_action_tiles.dart → docs/superpowers/specs/2026-03-12-anti-quantum-note-design.md
- `main()` --defines--> `conversations_provider.dart`  [EXTRACTED]
  backend/scripts/migrate-add-tags.ts → frontend/lib/providers/messaging_provider.dart
- `main()` --defines--> `encryption_provider.dart`  [EXTRACTED]
  backend/scripts/migrate-add-tags.ts → frontend/lib/providers/messaging_provider.dart
- `main()` --defines--> `messaging_provider.dart`  [EXTRACTED]
  backend/scripts/migrate-add-tags.ts → frontend/lib/providers/connection_provider.dart
...
## Communities (322 total, 16 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (60): AppConstants, ConversationModel, ArgumentError, EncryptedMedia, MediaCryptoService, E2eEnvelope, main, aesGcmDecrypt (+52 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (19): buildCorsOrigin(), ChatGateway, AddReactionDto, BlockUserDto, RemoveReactionDto, SearchUsersDto, PushClientStateDto, RecordingVoiceDto (+11 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (71): _addMessageToState, addReaction, _cancelDelayedRetry, _cancelDelayedRetryIfAny, clearAll, clearChatHistory, clearMessages, clearPingEffect (+63 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (60): avatar_circle.dart, build, SizedBox, AvatarCircle, _AvatarCircleState, build, _buildImageUrl, Container (+52 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (48): SafeArea, AuthForm, _AuthFormState, build, dispose, Form, build, DeleteAccountDialog (+40 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (48): ../audio/playback_controller.dart, ../audio/waveform_display.dart, Icon, _formatTime, Row, Semantics, build, _buildContentColumn (+40 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (45): app_localizations.dart, app_localizations_en.dart, app_localizations_pl.dart, antiQuantumNoteSendFailed, AppLocalizations, _AppLocalizationsDelegate, AppLocalizationsEn, AppLocalizationsPl (+37 more)

### Community 7 - "Community 7"
Cohesion: 0.09
Nodes (10): BlockedService, ConversationsService, MediaCleanupService, ChatConversationService, friend, mockFriendRequest, mockRecipient, mockSender (+2 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (43): getOtherUserId, getOtherUserUsername, clearActiveIfDeletedByOther, _clearActiveIfRemoved, clearAll, clearError, closeConversation, ConversationsProvider (+35 more)

### Community 9 - "Community 9"
Cohesion: 0.15
Nodes (22): AuthModule, BlockedModule, BlockedUser, ChatModule, ChatValidationModule, Environment, EnvironmentVariables, validate() (+14 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (42): 1. Podsumowanie, 2.10 MessagesService.createImageMessage — zależności, 2.11 Backend — Multer i file.buffer, 2.13 Drawing canvas — moment przechwytywania obrazu, 2.14 EmojiPicker — Config / CategoryIcons, 2.1 Ścieżki plików — Backend, 2.2 Backend — ConversationsService API, 2.3 Message entity — JoinColumn i spójność (+34 more)

### Community 11 - "Community 11"
Cohesion: 0.07
Nodes (25): AcceptFriendRequestDto, ALLOWED_EMOJIS, GetMessagesDto, MEDIA_URL_REGEX, _mediaOriginEscaped, RejectFriendRequestDto, SendFriendRequestDto, SendMessageDto (+17 more)

### Community 12 - "Community 12"
Cohesion: 0.07
Nodes (40): blocked_users_screen.dart, AuthScreen, _AuthScreenState, build, Scaffold, Shadow, SizedBox, BlockedUsersScreen (+32 more)

### Community 13 - "Community 13"
Cohesion: 0.09
Nodes (19): MarkConversationReadDto, MessageDeliveredDto, MessageDeliveryStatus, PendingBucket, PushNotificationCoalescingService, NotifyOptions, PushNotificationsService, ChatLinkPreviewService (+11 more)

### Community 14 - "Community 14"
Cohesion: 0.07
Nodes (41): add_or_invitations_screen.dart, _AddByUsernameTab, _AddByUsernameTabState, AddOrInvitationsScreen, build, Card, Center, DefaultTabController (+33 more)
...
Cohesion: 0.07
Nodes (34): api_service.dart, AuthProvider, _cancelSessionRefreshTimer, _clearLocalAuthState, clearStatus, dispose, Exception, Function (+26 more)

### Community 20 - "Community 20"
Cohesion: 0.06
Nodes (33): build, _buildScaffold, _ChatBubblePainter, ContactsScreen, CustomPaint, didChangeAppLifecycleState, dispose, _FilledChatBubbleWithLines (+25 more)
...
Cohesion: 0.09
Nodes (34): build, _buildHeaderTitle, _buildScrollToBottomButton, ChatDetailScreen, _ChatDetailScreenState, ChatInputBar, _clearActiveConversationIfThisChat, Column (+26 more)

### Community 23 - "Community 23"
Cohesion: 0.07
Nodes (28): SettingsProvider, clearDecryptedContentCache, _decryptedContentKey, _decryptedContentPrefix, EncryptionService, _generateKeys, _pruneDecryptedContentCache, clearPrefsCache (+20 more)

### Community 24 - "Community 24"
Cohesion: 0.09
Nodes (8): mockConfigService, mockUsersService, MessageCleanupService, expired, JwtStrategy, UsersService, WebPushSubscriptionsService, WebPushSubscriptionUpsertInput

### Community 25 - "Community 25"
Cohesion: 0.06
Nodes (32): acceptFriendRequest, connect, deleteConversation, emitAddReaction, emitBlockUser, emitClearChatHistory, emitDeleteConversationOnly, emitDeleteMessage (+24 more)

### Community 26 - "Community 26"
Cohesion: 0.07
Nodes (33): 3. Run on device, code:block25, code:block26, code:bash (git add README.md), code:bash (docker-compose down), code:bash (taskkill //F //IM node.exe), code:bash (docker-compose up --build), code:bash (curl http://localhost:3000) (+25 more)

### Community 27 - "Community 27"
Cohesion: 0.07
Nodes (28): anti_quantum_note_dialog.dart, Padding, AntiQuantumNoteDialog, _AntiQuantumNoteDialogState, build, dispose, Expanded, Padding (+20 more)

### Community 28 - "Community 28"
Cohesion: 0.1
Nodes (30): build, _buildInfoCard, _buildLocalCacheCard, Center, Container, initState, PrivacySafetyScreen, _PrivacySafetyScreenState (+22 more)

### Community 29 - "Community 29"
Cohesion: 0.07
Nodes (29): code:ts (@Column({ type: 'timestamp', nullable: true })), code:ts (user.passwordChangedAt = new Date();), code:ts (const payload = {), code:ts (async validate(payload: {), code:ts (async validate(payload: {), code:ts (@Get('me')), code:dart (Future<Map<String, dynamic>> fetchMe(String token) async {), code:dart (// In ApiService.fetchMe, change the throw to:) (+21 more)
...
Cohesion: 0.07
Nodes (26): Future Enhancements, Chat Screen Architecture - Source of Truth, Client → Server, code:typescript (@Entity('messages')), Countdown Not Live Updating, Current Limitations, Database Schema Changes, Delivery Indicators Not Updating (+18 more)

### Community 32 - "Community 32"
Cohesion: 0.09
Nodes (23): badging_bridge_stub.dart, _onConversationsChanged, _scheduleFlush, UnreadBadgeSync, Function, Function, build, Center (+15 more)

### Community 33 - "Community 33"
Cohesion: 0.08
Nodes (27): code:bash (git status), code:bash (git add -A), code:bash (git log --oneline -8), code:bash (git push origin master), Task 12: Final Commit and Summary, code:bash (cd frontend && flutter analyze), code:bash (cd backend && npm run build), code:bash (git status) (+19 more)
...
Cohesion: 0.09
Nodes (26): Chunk 5: Frontend — Widget Decomposition (Phase 5), code:dart (class MessageMetadataRow extends StatelessWidget {), code:dart (class MessageContentFactory {), code:bash (git add frontend/lib/widgets/message/ frontend/lib/screens/c), code:bash (git add frontend/lib/widgets/input/ frontend/lib/screens/cha), code:bash (git add frontend/lib/widgets/audio/ frontend/lib/widgets/mes), Task 5.1: Decompose `chat_message_bubble.dart` into composition pattern, Task 5.2: Decompose `chat_input_bar.dart` (+18 more)
...
Cohesion: 0.1
Nodes (23): Implementation Phases, Phase 2: Frontend Recording, Phase 3: Frontend Upload & Optimistic UI, Phase 6: Testing & Refinement, code:yaml (just_audio: ^0.9.36  # already exists), code:bash (git add frontend/pubspec.yaml frontend/pubspec.lock), code:dart (import 'package:flutter/material.dart';), code:dart (import 'dart:async';) (+15 more)

### Community 39 - "Community 39"
Cohesion: 0.08
Nodes (25): code:dart (test('build includes messageType when provided', () {), code:dart (class E2eEnvelope {), code:bash (git add frontend/lib/utils/e2e_envelope.dart frontend/test/u), Task 3: Extend E2E Envelope with messageType, mediaUrl, mediaDuration, code:dart (// frontend/lib/utils/e2e_envelope.dart), code:block11 (cd frontend && flutter test test/utils/e2e_envelope_test.dar), code:block12 (git add frontend/lib/utils/e2e_envelope.dart \), code:dart (import 'dart:convert';) (+17 more)

### Community 40 - "Community 40"
Cohesion: 0.1
Nodes (20): AppScrollBehavior, buildOverscrollIndicator, build, Container, _contentPreview, ReplyPreviewBar, SizedBox, build (+12 more)

### Community 41 - "Community 41"
Cohesion: 0.08
Nodes (23): 1.1 `getOtherUserDisplayHandle` — nigdy nieużywane, 1.2 `MessageModel.parseMessageType` — publiczne, nieużywane, 1.3 `dart:io` w `chat_provider.dart`, 1. Martwy / nieużywany kod, 2.1 Walidacja „blocked + friends” w backendzie, 2.2 Wielokrotne tworzenie `ApiService` w frontendzie, 2. Duplikacja logiki, 3.1 Brak `replyToMessageId` w payloadzie backendu (+15 more)

### Community 42 - "Community 42"
Cohesion: 0.1
Nodes (23): Backend: deleteConversationOnly, Edge Case: Other User Offline, Error Handling, Frontend: Swipe-to-Delete Failure, 1. Permission Denied, 2. Recording Errors, 3. Upload Failures, 4. Playback Errors (+15 more)
...
Cohesion: 0.15
Nodes (14): _decodeHtmlEntities, isSafeImageUrl, LinkPreviewService, main, package:fireplace/services/link_preview_service.dart, expectedPayload, preview, extractFirstUrl() (+6 more)
...
Cohesion: 0.09
Nodes (22): code:dart (import 'package:flutter_test/flutter_test.dart';), code:bash (cd frontend && flutter test test/providers/messaging_provide), code:dart (// Snapshot to cache immediately (may include encrypted plac), code:dart (final myConversationId = responseConversationId ?? _effectiv), code:bash (cd frontend && flutter test test/providers/messaging_provide), code:bash (cd frontend && flutter test), code:bash (git add frontend/lib/providers/messaging_provider.dart front), code:bash (cd frontend && flutter test test/providers/messaging_provide) (+14 more)

### Community 50 - "Community 50"
Cohesion: 0.1
Nodes (21): code:bash (cd backend && npm test -- --testPathPattern=messages.service), code:ts (import { ExecutionContext } from '@nestjs/common';), code:bash (cd backend && npm test -- --testPathPattern="ws-throttler.gu), code:bash (git add backend/src/chat/guards/ws-throttler.guard.spec.ts), code:ts (import { LinkPreviewService } from './link-preview.service';), code:bash (cd backend && npm test -- --testPathPattern="link-preview.se), code:bash (grep -n "deleteAccount" backend/src/users/users.service.ts |), code:ts (import { UsersService } from './users.service';) (+13 more)

### Community 51 - "Community 51"
Cohesion: 0.18
Nodes (7): FriendRequest, FriendRequestStatus, FriendsService, FriendRequestMapper, payload, request, friendRequestsB

### Community 53 - "Community 53"
Cohesion: 0.16
Nodes (9): LocalStorageService, err, mockFs, UploadAvatarResult, UploadImageResult, UploadRawFileResult, UploadVoiceResult, mockMessageRepo (+1 more)

### Community 54 - "Community 54"
Cohesion: 0.1
Nodes (21): code:block4 (❌ frontend/Dockerfile.dev), code:bash (git add -A), code:bash (rm frontend/Dockerfile.dev), code:bash (# Kill old processes), code:bash (docker system prune -a), code:bash (git add -A), Existing Files (No Changes), Files to Modify (+13 more)

### Community 55 - "Community 55"
Cohesion: 0.1
Nodes (20): code:typescript (// message.mapper.ts), Chat Screen Redesign - Telegram/Wire Inspired UI, code:dart (if (chat.activeConversationId == null) {), code:bash (cd frontend), code:bash (git add frontend/lib/models/message_model.dart), code:typescript (messages.map(m => ({), code:bash (# Start backend), code:markdown (# Chat Redesign Manual Test Results) (+12 more)
...
Cohesion: 0.1
Nodes (21): code:typescript (// backend/src/auth/dto/register.dto.ts), code:typescript (// backend/src/auth/dto/login.dto.ts), code:bash (git add backend/src/auth/dto/register.dto.ts backend/src/aut), code:typescript (// backend/src/auth/dto/challenge.dto.ts), code:typescript (// backend/src/auth/dto/refresh-with-key.dto.ts), code:typescript (// backend/src/auth/dto/device-info.dto.ts), code:bash (git add backend/src/auth/dto/challenge.dto.ts backend/src/au), code:typescript (// backend/src/auth/identity-key-session.guard.spec.ts) (+13 more)
...
Cohesion: 0.14
Nodes (20): 1.1 Frontend (Flutter), 1.2 Backend (NestJS), 1.3 iOS (`frontend/ios/Runner/Info.plist`), 1.4 Android (`frontend/android/app/src/main/AndroidManifest.xml`), 1. Current Configuration, 3.2 iOS — `frontend/ios/Runner/Info.plist`, 3.3 Android — `frontend/android/app/src/main/AndroidManifest.xml`, 3. Exact Code Changes (+12 more)

### Community 60 - "Community 60"
Cohesion: 0.1
Nodes (19): Chunk 2: Frontend — Model + Config + API Service, Chunk 4: Frontend — ChatProvider + Wire-up + Bubble, Chunk 5: Integration + CLAUDE.md, code:dart (static String get giphyApiKey {), code:bash (git add frontend/lib/config/app_config.dart), code:dart (Future<Map<String, dynamic>> uploadMedia({), code:dart (} else if (type == 'gif' && gifBytes != null) {), code:dart (/// Send a GIF message. Downloads from Giphy, uploads to Clo) (+11 more)

### Community 61 - "Community 61"
Cohesion: 0.11
Nodes (20): code:bash (git add frontend/lib/services/socket_service.dart), Step 3.4: Commit socket service changes, code:dart (Future<String> createSecretNote(String token, String ciphert), code:dart (import 'package:encrypt/encrypt.dart' as enc;), code:dart (Future<void> sendAntiQuantumNote({), code:bash (cd frontend && flutter test 2>&1 | tail -15), code:bash (git add frontend/lib/services/api_service.dart frontend/lib/), Task 7: sendNote in ChatProvider (crypto + API + send message) (+12 more)
...
Cohesion: 0.1
Nodes (20): code:yaml (cryptography: ^2.7.0), code:bash (cd frontend && flutter pub get), code:bash (git add frontend/pubspec.yaml frontend/pubspec.lock), code:dart (// frontend/test/services/crypto/auth_identity_keypair_test.), code:bash (cd frontend && flutter test test/services/crypto/auth_identi), code:dart (// frontend/lib/services/crypto/auth_identity_keypair.dart), code:bash (cd frontend && flutter test test/services/crypto/auth_identi), code:bash (git add frontend/lib/services/crypto/auth_identity_keypair.d) (+12 more)
...
Cohesion: 0.12
Nodes (17): code:dart (IconButton(), Step 5.1: Remove IconButton delete, Phase 5: Error Handling & Polish, code:bash (git add frontend/lib/widgets/voice_recording_overlay.dart), code:dart (Future<void> retryVoiceMessage(String tempId) async {), code:dart (Widget _buildDeliveryIcon() {), code:bash (git add frontend/lib/providers/chat_provider.dart frontend/l), code:dart (Future<void> _loadAndPlayAudio() async {) (+9 more)

### Community 68 - "Community 68"
Cohesion: 0.11
Nodes (18): 10. Frontend — ChatProvider, 3. Backend — MessagesService, 4. Backend — MessageMapper, 6. Backend — ChatModule, 7. Frontend — pubspec.yaml, 8. Frontend — MessageModel, 9. Frontend — SocketService, code:dart (linkPreviewUrl: json['linkPreviewUrl'] as String?,) (+10 more)
...
Cohesion: 0.12
Nodes (18): code:dart (void sendPing(int recipientId) {), code:bash (git add frontend/lib/providers/chat_provider.dart), Step 4.5: Commit ChatProvider changes, code:bash (git add frontend/lib/providers/chat_provider.dart), Task 4: Clean debug prints from `chat_provider.dart` (Frontend), Chunk 4: Frontend — Encrypt all message types, code:dart (void sendPing(int recipientId) {), code:bash (git add frontend/lib/providers/chat_provider.dart) (+10 more)

### Community 71 - "Community 71"
Cohesion: 0.13
Nodes (16): Executive Summary, 2. Files to Modify, 5. Verification Checklist, 7. Production Next Steps, Document Change Log, Executive Summary, Key Concepts, Mobile Deployment — Flutter on Physical Device (+8 more)

### Community 72 - "Community 72"
Cohesion: 0.11
Nodes (17): ChatActionTiles (`widgets/chat_action_tiles.dart`), ChatMessageBubble (`widgets/chat_message_bubble.dart`), ChatProvider (`providers/chat_provider.dart`), CLAUDE.md Updates After Implementation, E2eEnvelope parsing, Frontend Changes, GIF Support — Design Spec, Giphy API Details (+9 more)

### Community 73 - "Community 73"
Cohesion: 0.11
Nodes (17): code:typescript (import {), code:typescript (import { IsInt } from 'class-validator';), code:typescript (async handleDeleteConversationOnly(), code:typescript (import { IsInt } from 'class-validator';), code:typescript (export { DeleteConversationOnlyDto } from './delete-conversa), code:typescript (import {), code:bash (git add backend/src/chat/dto/delete-conversation-only.dto.ts), Step 1.1: Create DeleteConversationOnlyDto (+9 more)

### Community 74 - "Community 74"
Cohesion: 0.12
Nodes (17): Chunk 2: Frontend — Extract EncryptionProvider (Phase 2), Chunk 3: Frontend — Extract FriendsProvider (Phase 3), code:dart (// In main.dart, update MultiProvider:), code:dart (final chat = context.read<ChatProvider>();), code:bash (git add frontend/lib/main.dart frontend/lib/providers/chat_p), code:bash (git add frontend/lib/providers/friends_provider.dart), code:bash (git add frontend/lib/main.dart frontend/lib/providers/chat_p), Full Codebase Refactor Implementation Plan (+9 more)

### Community 75 - "Community 75"
Cohesion: 0.12
Nodes (17): code:dart (// frontend/test/services/api_service_media_test.dart), code:block23 (cd frontend && flutter test test/services/api_service_media_), code:dart (/// Upload already-encrypted media bytes to backend. Returns), code:block25 (cd frontend && flutter test test/services/api_service_media_), code:block26 (cd frontend && flutter analyze lib/services/api_service.dart), code:block27 (git add frontend/lib/services/api_service.dart \), code:dart (// frontend/lib/utils/web_blob_utils_stub.dart), code:dart (// frontend/lib/utils/web_blob_utils_web.dart) (+9 more)
...
Cohesion: 0.18
Nodes (9): FetchPreKeyBundleDto, RequestSessionRebuildDto, UploadKeyBundleDto, PreKeyBundleResponse, invalidData, mockBundle, noUserClient, nowSpy (+1 more)

### Community 78 - "Community 78"
Cohesion: 0.15
Nodes (9): KeyBundleData, KeyBundlesService, OneTimePreKeyData, bundle, callOrder, entities, keys, mockKeyBundleData (+1 more)

### Community 79 - "Community 79"
Cohesion: 0.13
Nodes (17): code:typescript (const token =), code:typescript (async upsertKeyBundle(userId: number, data: KeyBundleData): ), code:typescript (async findOrCreate(userOne: User, userTwo: User): Promise<Co), code:typescript (const token = client.handshake.auth?.token as string;), code:bash (cd backend && npm run build && npm test), code:bash (git add backend/src/key-bundles/key-bundles.service.ts \), code:typescript (@IsString()), Step 1: Atomic upsert in `key-bundles.service.ts` (+9 more)
...
Cohesion: 0.12
Nodes (17): code:dart (import 'dart:ui' as ui;), code:dart (import '../screens/drawing_canvas_screen.dart';), code:bash (git add frontend/lib/screens/drawing_canvas_screen.dart), Task 3.6: Create Drawing Canvas Screen (Basic), 4. Modified: MainShell, code:dart (// Import), Chunk 3: Frontend — L10n + GifService + GifPickerSheet, code:json ("gifNoResults": "Nie znaleziono GIFów",) (+9 more)

### Community 84 - "Community 84"
Cohesion: 0.15
Nodes (13): Bubble Redesign: Telegram-style time overlay + media full-bleed, Files Changed, Goal, Problem, Scope, Spec: In-Session Conversation Message Cache, Bubble Redesign: Telegram-style time overlay + media full-bleed, Files Changed (+5 more)

### Community 85 - "Community 85"
Cohesion: 0.12
Nodes (17): ═══════════════════════════════════════, code:dart (// frontend/test/services/media_crypto_service_test.dart), code:bash (cd frontend && flutter test test/services/media_crypto_servi), code:dart (// frontend/lib/services/media_crypto_service.dart), code:bash (cd frontend && flutter test test/services/media_crypto_servi), code:bash (cd frontend && flutter analyze), code:bash (git add frontend/lib/services/media_crypto_service.dart fron), code:dart (final parsed = E2eEnvelope.parse(encryptedContent);) (+9 more)
...
Cohesion: 0.13
Nodes (12): buildProviderWithSampleData, main, main, _msg, _FakeEncryptionProvider, main, TimeoutException, main (+4 more)

### Community 89 - "Community 89"
Cohesion: 0.12
Nodes (15): Anti-Quantum Note — Design Spec, Backend, Client-side encryption with key-in-fragment, Database, New module: `secret-notes`, Protection against link-preview bots, Reading Page (served by backend), Security Model (+7 more)

### Community 90 - "Community 90"
Cohesion: 0.12
Nodes (15): Backend, Chat Screen Redesign - End-to-End Test Plan, Frontend, Prerequisites, Test 6.1: Open Gallery, Test 6.2: Select and Upload Image, Test 6: Gallery Attachment (via ChatInputBar), Test 8.1: Complex Workflow (+7 more)
...
Cohesion: 0.12
Nodes (16): 1. Backend Deployment (Render.com), 3. Android - Usuń usesCleartextTraffic, 4. Flutter Build - Production BASE_URL, 5. iOS Signing (App Store), 6. Android Signing (Google Play), 7. Checklist przed publikacją, Android Alternative (jeśli nie masz Androida), code:block39 (ALLOWED_ORIGINS=https://twoja-domena.com) (+8 more)
...
Cohesion: 0.12
Nodes (14): code:typescript (@Post('voice')), code:typescript (import { CloudinaryModule } from '../cloudinary/cloudinary.m), code:bash (# First login to get JWT), code:bash (git add backend/src/messages/messages.controller.ts backend/), code:typescript (import {), Task 1.4: Create POST /messages/voice endpoint, code:typescript (import { DataSource } from 'typeorm';), code:typescript (async deleteAccount(userId: number, password: string): Promi) (+6 more)

### Community 95 - "Community 95"
Cohesion: 0.12
Nodes (16): code:dart (Widget _buildDeliveryIcon() {), code:dart (String? _getTimerText() {), code:dart (@override), code:bash (git add frontend/lib/widgets/chat_message_bubble.dart), Task 3.1: Update ChatMessageBubble with Delivery Indicator & Timer, code:dart (@override), code:dart (@override), Step 5.2: Wrap tile content in Dismissible (+8 more)
...
Cohesion: 0.14
Nodes (14): Notes, code:dart (class _CircularProgressPainter extends CustomPainter {), code:bash (git add frontend/lib/widgets/chat_action_tiles.dart), code:dart (class _LongPressActionTile extends StatefulWidget {), code:bash (git add frontend/lib/widgets/chat_action_tiles.dart), code:dart (void _handleClearChatHistory(BuildContext context) {), code:bash (git add frontend/lib/widgets/chat_action_tiles.dart), Delete Chat History Implementation Plan (+6 more)
...
Cohesion: 0.12
Nodes (16): code:dart (// frontend/test/services/media_crypto_service_test.dart), code:block2 (cd frontend && flutter test test/services/media_crypto_servi), code:dart (// frontend/lib/services/media_crypto_service.dart), code:block4 (cd frontend && flutter test test/services/media_crypto_servi), code:dart (import '../services/media_crypto_service.dart';), code:block6 (cd frontend && flutter analyze lib/providers/messaging_provi), code:block7 (git add frontend/lib/services/media_crypto_service.dart \), Task 1: MediaCryptoService (+8 more)
...
Cohesion: 0.15
Nodes (14): code:bash (# From project root. Replace CONTAINER with your postgres co), code:bash (cd frontend && flutter run -d chrome), code:sql (-- Last 5 messages with encryption status), Manual E2E Encryption Testing Guide, Prerequisites, Quick Reference: SQL Queries, Scope Reminder, Steps (+6 more)

### Community 102 - "Community 102"
Cohesion: 0.14
Nodes (15): CLAUDE.md Updates, code:markdown (## 2. Quick Start), code:block21 (Backend: http://192.168.1.11:3000 (accessible from phone)), code:block22, code:block23 (Frontend: http://192.168.1.11:8080), code:block10, code:markdown (## 2. Quick Start), code:block12 (Backend: http://192.168.1.11:3000 (accessible from phone)) (+7 more)
...
Cohesion: 0.15
Nodes (14): Anti-Quantum Note — Implementation Plan, Chunk 1: Backend — Entity, Module, Service, Chunk 2: Backend — Controller, Module, App wiring, Chunk 4: Frontend — Crypto + sendNote + tile wiring, code:typescript (// backend/src/secret-notes/secret-note.entity.ts), code:typescript (// backend/src/secret-notes/secret-notes.module.ts), code:typescript (// 1. Add import at top of app.module.ts:), code:yaml (backend:) (+6 more)
...
Cohesion: 0.13
Nodes (15): code:typescript (// backend/src/auth/crypto/ed25519.verifier.spec.ts), code:bash (cd backend && npx jest src/auth/crypto/ed25519.verifier.spec), code:typescript (// backend/src/auth/crypto/ed25519.verifier.ts), code:bash (cd backend && npx jest src/auth/crypto/ed25519.verifier.spec), code:bash (git add backend/src/auth/crypto/), code:typescript (// backend/src/auth/auth.module.ts), code:bash (cd backend && npm run build), code:bash (# In Docker) (+7 more)
...
Cohesion: 0.15
Nodes (9): getBaseUrlForPlatform, getBaseUrlForPlatform, createGifObjectUrl, revokeGifObjectUrl, createGifObjectUrl, revokeGifObjectUrl, Function, handler (+1 more)

### Community 113 - "Community 113"
Cohesion: 0.14
Nodes (13): build, Directory, dispose, Exception, Function, initState, _isExpired, _loadAndPlayAudio (+5 more)

### Community 114 - "Community 114"
Cohesion: 0.14
Nodes (13): AuthGate, _AuthGateState, AuthScreen, FireplaceApp, main, MainShell, MaterialApp, MultiProvider (+5 more)
...
Cohesion: 0.14
Nodes (14): code:block32 (NSURLConnection error: -1022), code:block33 (CLEARTEXT communication to 192.168.1.100 not permitted by ne), code:block34 (error: Signing for "Runner" requires a development team. Sel), code:block35 (Access to XMLHttpRequest at 'http://192.168.1.100:3000/auth/), code:block36 (Access blocked from origin 'null'), code:bash (# Docker), code:bash (# Docker - po zmianie docker-compose.yml), Problem 3: iOS - "App Transport Security has blocked a cleartext HTTP" (+6 more)

### Community 117 - "Community 117"
Cohesion: 0.23
Nodes (14): Troubleshooting, 6.1 CORS error, 6.2 Docker vs .env confusion, 6.3 Port 3000 in use, 6.4 Flutter does not see iPhone, 6.5 Firewall blocks port 3000 (Windows), 6.6 iOS: "App Transport Security has blocked cleartext HTTP", 6.7 Android: "CLEARTEXT communication not permitted" (+6 more)

### Community 118 - "Community 118"
Cohesion: 0.14
Nodes (11): Deployment, Environment Variables, Features, Phone (same WiFi), Project Structure, Quick Start, Running Tests, Tech Stack (+3 more)
...
Cohesion: 0.16
Nodes (13): Phase 1: Backend Foundation, code:typescript (export enum MessageType {), code:bash (git add backend/src/messages/message.entity.ts), code:typescript (@Column({ type: 'text', nullable: true })), code:bash (git add backend/src/messages/message.entity.ts), code:typescript (export interface UploadImageResult {), code:bash (git add backend/src/cloudinary/cloudinary.service.ts), Phase 1: Backend Foundation (+5 more)

### Community 122 - "Community 122"
Cohesion: 0.14
Nodes (14): 0. Quick Start, 3. File Location Map, 5. How-To: Adding New Features, 6. Key Behaviors & Gotchas (Runtime), 7. Frontend Screens & Widgets, 8. Environment & Config, 9. Known Limitations, Add a new DB column: (+6 more)
...
Cohesion: 0.15
Nodes (14): Chunk 4: Frontend — Extract ConnectionProvider + ConversationsProvider + MessagingProvider (Phase 4), code:dart (void connect({required String baseUrl, required String token), code:dart (_socketService.connect(baseUrl: baseUrl, token: token);), code:bash (git add frontend/lib/services/socket_service.dart frontend/l), code:bash (git add frontend/lib/providers/conversations_provider.dart), code:dart (MultiProvider(), code:bash (git add -A frontend/lib/), code:bash (git rm frontend/lib/providers/chat_provider.dart) (+6 more)
...
Cohesion: 0.22
Nodes (13): code:yaml (libsignal_protocol_dart: ^0.7.4), code:dart (class EncryptionService {), code:dart (class LinkPreviewService {), code:typescript (@Entity('key_bundles')), code:typescript (@Entity('one_time_pre_keys')), code:typescript (@Module({), Modified files:, New file: (+5 more)
...
Cohesion: 0.27
Nodes (8): DeleteAccountDto, RegisterFcmTokenDto, RegisterWebPushSubscriptionDto, RemoveFcmTokenDto, RemoveWebPushSubscriptionDto, WebPushKeysDto, startsWith(), validateAvatarMagicBytes()
...
Cohesion: 0.23
Nodes (12): build, _buildLinkPreviewCard, _buildTextWithLinks, Padding, RichText, SizedBox, Stack, TextMessageContent (+4 more)

### Community 137 - "Community 137"
Cohesion: 0.15
Nodes (13): 4. Implementation Procedure, code:powershell (ipconfig), code:bash (ifconfig | grep "inet " | grep -v 127.0.0.1), code:bash (# Docker), code:bash (cd frontend/ios), Step 1: Find computer IP, Step 2: Update backend CORS, Step 3: Edit iOS Info.plist (+5 more)

### Community 138 - "Community 138"
Cohesion: 0.17
Nodes (13): code:bash (cd frontend), code:bash (flutter run --dart-define=BASE_URL=http://192.168.1.100:3000), Step 6: Run Flutter on device, code:bash (cd frontend), code:bash (scp -r frontend/build/web/* TWOJ_USER@<IP>:~/fireplace/front), code:nginx (server {), Etap 8: Flutter web build, code:bash (cd frontend/ios) (+5 more)
...
Cohesion: 0.22
Nodes (13): 1. New DTO: DeleteConversationOnlyDto, 2. New Handler: handleDeleteConversationOnly, 3. Remove: handleDeleteConversation, 4. Unchanged: handleUnfriend, 5. Modified: ChatGateway, 6. Verify: startConversation, Backend Changes, code:typescript (@SubscribeMessage('deleteConversation') // ← delete this ent) (+5 more)
...
Cohesion: 0.19
Nodes (13): Phase 4: Frontend Playback, code:dart (import 'dart:io';), code:bash (git add frontend/lib/widgets/voice_message_bubble.dart), code:dart (import 'voice_message_bubble.dart';), code:dart (@override), code:bash (git add frontend/lib/widgets/chat_message_bubble.dart), code:dart (// Waveform with progress), code:dart (class _WaveformPainter extends CustomPainter {) (+5 more)
...
Cohesion: 0.15
Nodes (11): Chat Scroll: `reverse: true` Refactor, `CLAUDE.md`, code:dart (_scrollController.jumpTo(preOffset + (newExtent - preExtent)), Component Changes, Edge Cases, Industry precedent, `messaging_provider.dart` — no changes, Pagination Scroll Math (+3 more)

### Community 148 - "Community 148"
Cohesion: 0.15
Nodes (12): code:dart (else if (message.messageType == MessageType.gif && message.m), code:dart (void _showGifDialog(BuildContext context, String url) {), code:bash (git add frontend/lib/widgets/chat_message_bubble.dart), Task 14: Render GIF in ChatMessageBubble, code:dart (static const double _kTimeOverlayWidth = 66.0;), code:dart (builder: (context, layoutConstraints) {), code:dart (// Add this import at top of test file:), code:bash (cd frontend && flutter test test/widgets/message/bubble_rede) (+4 more)
...
Cohesion: 0.15
Nodes (13): code:dart (// frontend/lib/providers/encryption_provider.dart), code:bash (git add frontend/lib/providers/encryption_provider.dart), code:bash (git add frontend/lib/providers/encryption_provider.dart fron), code:dart (// frontend/lib/providers/connection_provider.dart), code:bash (git add frontend/lib/providers/connection_provider.dart), Task 2.1: Create `EncryptionProvider` skeleton with state + interface, Task 2.3: Move E2E initialization + key exchange logic to EncryptionProvider, Task 4.2: Create ConnectionProvider (+5 more)

### Community 151 - "Community 151"
Cohesion: 0.15
Nodes (12): code:bash (git add backend/src/chat/services/chat-message.service.ts), code:typescript (@SubscribeMessage('clearChatHistory')), code:bash (docker-compose logs backend --tail=30), code:bash (git add backend/src/chat/chat.gateway.ts), code:typescript (/**), code:bash (docker-compose logs backend --tail=20), code:bash (git add backend/src/messages/messages.service.ts), code:typescript (import { ClearChatHistoryDto } from '../dto/chat.dto';) (+4 more)

### Community 152 - "Community 152"
Cohesion: 0.15
Nodes (12): code:dart (import 'package:flutter_test/flutter_test.dart';), code:bash (cd frontend && flutter test test/services/encryption_service), code:dart (/// Removes all persisted decrypted content cache entries fo), code:bash (cd frontend && flutter test test/services/encryption_service), code:dart (void clearAll() {), code:dart (group('EncryptionProvider.clearAll triggers persist-clear', ), code:bash (cd frontend && flutter test), code:bash (git add frontend/lib/services/encryption_service.dart fronte) (+4 more)
...
Cohesion: 0.17
Nodes (12): code:bash (git add CLAUDE.md), Task 10: Manual Testing & Documentation, Chunk 6: Final Cleanup + CLAUDE.md Update (Phase 6), code:bash (git add CLAUDE.md), Task 6.1: Line count verification, Task 6.2: Run all tests, Task 6.3: Update CLAUDE.md, Task 6.4: Final comprehensive smoke test (+4 more)
...
Cohesion: 0.17
Nodes (10): code:typescript (/** True if either user has blocked the other. Single query ), code:bash (cd backend && git add src/blocked/blocked.service.ts), code:typescript (it('does not serve the same OTP twice under concurrent calls), code:bash (cd backend && npm test -- --testPathPattern=key-bundles --no), code:bash (cd backend && npm test --no-coverage 2>&1 | tail -10), code:bash (cd backend && git add src/key-bundles/key-bundles.service.ts), Security & Bug Fixes Implementation Plan, Summary of Tasks (+2 more)
...
Cohesion: 0.18
Nodes (10): Context, E2E Encryption for Fireplace Messenger — Implementation Plan, Frontend:, Implementation Order, New file:, Phase 6: Frontend — UI (Privacy & Safety), Phase 7: Migration — Clear Old Messages, Phase 9: CLAUDE.md Update (+2 more)
...
Cohesion: 0.25
Nodes (10): 1. User A Deletes Conversation, User B Sends Message Simultaneously, 2. User A Deletes Conversation, Then User B Unfriends, 3. Re-opening Chat Before Full Deletion (Race Condition), Contacts Tab Design - Archive → Contacts Refactor, Edge Cases, Overview, Success Criteria, User Stories (+2 more)
...
Cohesion: 0.22
Nodes (11): code:bash (sudo nano /etc/nginx/sites-available/fireplace), code:nginx (server {), code:bash (sudo ln -s /etc/nginx/sites-available/fireplace /etc/nginx/s), Etap 6: Nginx + SSL, code:bash (sudo certbot --nginx -d twoja-domena.com), code:bash (sudo nano /etc/nginx/sites-available/fireplace), code:nginx (server {), code:bash (sudo ln -s /etc/nginx/sites-available/fireplace /etc/nginx/s) (+3 more)

### Community 179 - "Community 179"
Cohesion: 0.2
Nodes (9): Chunk 1: Drawing Removal + Envelope Extension + Model Changes, code:bash (git add -A frontend/lib/screens/drawing_canvas_screen.dart f), E2E Encryption for All Message Types + Drawing Removal — Implementation Plan, Task 2: Remove Drawing from frontend, Current State, E2E Encryption for All Message Types + Drawing Removal, Non-Goals, Summary (+1 more)

### Community 180 - "Community 180"
Cohesion: 0.18
Nodes (11): Chunk 3: Frontend — Crypto utility + Dialog widget, code:yaml (encrypt: ^5.0.3), code:bash (cd frontend && flutter pub get 2>&1 | tail -5), code:bash (git add frontend/pubspec.yaml frontend/pubspec.lock), code:dart (// frontend/test/widgets/anti_quantum_note_dialog_test.dart), code:bash (cd frontend && flutter test test/widgets/anti_quantum_note_d), code:dart (// frontend/lib/widgets/anti_quantum_note_dialog.dart), code:bash (cd frontend && flutter test test/widgets/anti_quantum_note_d) (+3 more)
...
Cohesion: 0.2
Nodes (11): 1. WhatsApp, 2. Telegram, 3. Facebook Messenger, Media viewer behavior, Media viewer behavior (Desktop), Summary, Summary, Summary (+3 more)

### Community 183 - "Community 183"
Cohesion: 0.33
Nodes (9): base64UrlEncode, _base64UrlToUint8List, createWebPushBridge, _isIOSWebKit, isStandaloneOrNotRequired, _toBase64Url, _toPayload, WebPushBridge (+1 more)

### Community 184 - "Community 184"
Cohesion: 0.24
Nodes (10): 1. Critical Rules & Gotchas, E2E Encryption, Frontend, TypeORM, 5. Testy kompilacji, Backend:, code:bash (npm run build), code:bash (flutter analyze) (+2 more)

### Community 185 - "Community 185"
Cohesion: 0.22
Nodes (10): code:bash (git add frontend/lib/providers/chat_provider.dart), code:bash (cd frontend && flutter analyze 2>&1 | tail -5), code:bash (git add frontend/lib/providers/chat_provider.dart), Step 1: Apply all three fixes above, Step 2: Analyze, Step 2: Analyze, Step 3: Commit, Step 3: Commit (+2 more)

### Community 186 - "Community 186"
Cohesion: 0.2
Nodes (10): Chunk 5: Final integration, persist/restore, tests, docs, code:dart (final data = <String, dynamic>{), code:dart (final restoredType = _parseMessageTypeString(stored?['messag), code:bash (git add frontend/lib/providers/chat_provider.dart), code:bash (# Terminal 1), code:bash (git add -A), code:bash (git add CLAUDE.md), Task 13: Complete persist/restore paths for all types (+2 more)

### Community 187 - "Community 187"
Cohesion: 0.2
Nodes (9): code:bash (rm frontend/lib/screens/archive_placeholder_screen.dart), code:bash (git add -u frontend/lib/screens/), code:dart (// DELETE THIS BLOCK:), code:bash (git add frontend/lib/providers/auth_provider.dart), code:bash (git add frontend/lib/services/socket_service.dart), Quick Clean Refactoring — Implementation Plan, Task 1: Delete dead screen files (Frontend), Task 2: Remove unused `clearStatus()` from AuthProvider (Frontend) (+1 more)
...
Cohesion: 0.2
Nodes (9): code:bash (cd backend && git add src/chat/services/chat-conversation.se), code:bash (cd backend && npm test --no-coverage 2>&1 | tail -10), code:bash (cd backend && git add src/chat/services/chat-conversation.se), code:typescript (import { Test, TestingModule } from '@nestjs/testing';), code:bash (cd backend && npm test -- --testPathPattern=chat-conversatio), code:typescript (const areFriends = await this.friendsService.areFriends(user), code:bash (cd backend && npm test -- --testPathPattern=chat-conversatio), Task 2: `startConversation` — friendship check (+1 more)
...
Cohesion: 0.22
Nodes (9): code:json ({), Ciphertext String Format, code:block1 (Alice                          Server                       ), code:block2 (BEFORE: { content: "Cześć Bob!" }), code:json ({), Encrypted Envelope Format, First Message Flow (X3DH), Signal Protocol Overview (for this app) (+1 more)
...
Cohesion: 0.22
Nodes (9): code:xml (<key>CADisableMinimumFrameDurationOnPhone</key>), code:xml (<key>CADisableMinimumFrameDurationOnPhone</key>), code:xml (<manifest xmlns:android="http://schemas.android.com/apk/res/), code:xml (<manifest xmlns:android="http://schemas.android.com/apk/res/), code:block19 (Launching lib/main.dart on iPhone 15 in debug mode...), Krok 3: iOS - HTTP Exception + Permissions, Krok 4: Android - Permissions + HTTP, Krok 7: Test na Telefonie (+1 more)
...
Cohesion: 0.22
Nodes (9): code:markdown (| **deleteConversationOnly** | ChatConversationService.handl), code:markdown (- **conversationDeleted:** `{ conversationId: number }`), code:markdown (### 7.X Delete Conversation vs Unfriend), code:bash (git add CLAUDE.md), Step 10.1: Update §5 WebSocket Event Map, Step 10.2: Update §7 Frontend Mechanisms, Step 10.3: Update §9 File Map, Step 10.5: Commit documentation (+1 more)

### Community 203 - "Community 203"
Cohesion: 0.22
Nodes (9): BASE_URL Setup, code:bash (flutter run -d <device> --dart-define=BASE_URL=http://192.16), code:dart (// lib/constants/app_constants.dart), code:dart (// lib/config/env_config.dart), code:bash (# Enable USB debugging on phone (Settings → Developer Option), code:bash (# First time (via USB):), Flutter Configuration, Flutter Devices Setup (+1 more)
...
Cohesion: 0.22
Nodes (9): 1. Database Changes, 2. Cloudinary Service Enhancement, 3. New REST Endpoint, 4. WebSocket Integration, Backend Components, code:typescript (export enum MessageType {), code:typescript (async uploadVoiceMessage(), code:typescript (@Post('voice')) (+1 more)
...
Cohesion: 0.22
Nodes (9): code:dart (context.read<ChatProvider>().deleteConversation(conversation), code:dart (context.read<ChatProvider>().deleteConversationOnly(conversa), code:dart ('This will delete all messages. This action cannot be undone), code:dart ('This will delete all messages. Your contact will remain in ), code:bash (git add frontend/lib/widgets/conversation_tile.dart frontend), Step 5.3: Update ConversationsScreen to call new method, Step 5.4: Verify Flutter compiles, Step 5.5: Commit swipe-to-delete changes (+1 more)

### Community 208 - "Community 208"
Cohesion: 0.22
Nodes (8): code:dart (/// Direct access to the underlying EncryptionService for in), Done, EncryptionProvider Encapsulation — Implementation Plan, Step 3.1: Verify no remaining external usages, Step 3.2: Remove the getter, Step 3.3: Run analyze, Step 3.4: Run all tests, Task 3: Remove the encryptionService getter

### Community 209 - "Community 209"
Cohesion: 0.39
Nodes (8): Implementation status, PWA App Badge (Badging API) Implementation Plan, Task 1: Math helpers + unit tests, Task 2: Badging bridge (stub + web), Task 3: UnreadBadgeSync, Task 4: Wire MainShell, Task 5: Docs + graphify, Task 6: Verification
...
Cohesion: 0.36
Nodes (8): Backend, Backend, code:dart (class _LongPressActionTile extends StatefulWidget {), code:typescript (async deleteAllByConversation(conversationId: number): Promi), code:typescript (async handleClearChatHistory(client: Socket, data: any, serv), code:typescript (export class ClearChatHistoryDto {), Components, Frontend
...
Cohesion: 0.25
Nodes (7): Architecture, Benefits Summary, Development Experience, Implementation Checklist, Native Flutter Development Setup - Design Document, Performance, Problem Statement
...
Cohesion: 0.25
Nodes (8): code:markdown (**2026-02-14:**), Step 10.4: Update §13 Recent Changes, code:markdown (**2026-02-14:**), code:markdown (- **Message Types:** TEXT, PING, IMAGE, DRAWING, VOICE), code:markdown (---), code:markdown (**2026-02-15:**), code:bash (git add CLAUDE.md), Task 6.1: Update CLAUDE.md with voice messages
...
Cohesion: 0.29
Nodes (8): 6. API Service Enhancement, code:dart (Future<VoiceUploadResult> uploadVoiceMessage({), code:dart (class VoiceUploadResult {), code:dart (import 'dart:io';), code:dart (class VoiceUploadResult {), code:dart (Future<VoiceUploadResult> uploadVoiceMessage({), code:bash (git add frontend/lib/services/api_service.dart), Task 3.2: Create uploadVoiceMessage in ApiService
...
Cohesion: 0.25
Nodes (8): code:dart (import 'package:flutter_test/flutter_test.dart';), code:dart (import 'package:flutter_test/flutter_test.dart';), code:dart (/// Persist decrypted message content to local cache.), Step 1.1: Write the failing tests, Step 1.2: Run tests to verify they fail, Step 1.3: Add delegation methods to EncryptionProvider, Step 1.4: Run tests to verify they pass, Task 1: Add delegation methods to EncryptionProvider + tests
...
Cohesion: 0.25
Nodes (8): 4. Slack, 5. Discord, Behavior, Behavior, Behavior, Summary, Summary, Trigger

### Community 233 - "Community 233"
Cohesion: 0.29
Nodes (7): code:typescript (export class UploadKeyBundleDto {), code:typescript (export class OneTimePreKeyDto {), code:typescript (export class FetchPreKeyBundleDto {), Modified files:, New files:, Phase 2: Backend — WebSocket Key Exchange Events, WebSocket Event Table
...
Cohesion: 0.29
Nodes (7): 3.1 Backend CORS — `docker-compose.yml`, code:yaml (ALLOWED_ORIGINS: 'http://localhost:3000,http://localhost:808), code:yaml (ALLOWED_ORIGINS: 'http://localhost:3000,http://localhost:808), code:env (ALLOWED_ORIGINS=http://localhost:3000,http://localhost:8080,), 1. Backend CORS, code:env (ALLOWED_ORIGINS=http://localhost:3000,http://localhost:8080), code:env (ALLOWED_ORIGINS=http://localhost:3000,http://localhost:8080,)
...
Cohesion: 0.29
Nodes (7): code:bash (git add .), code:bash (git log --oneline -10  # Review commits), Step 11.1: Check git status, Step 11.2: Verify all success criteria, Step 11.4: Create final summary commit (if needed), Step 11.5: Push to remote (if applicable), Task 11: Final Verification and Cleanup
...
Cohesion: 0.29
Nodes (7): code:ts (import { BadRequestException } from '@nestjs/common';), code:ts (import { validateAvatarMagicBytes } from './magic-bytes.vali), code:ts (import { validateAvatarMagicBytes } from '../media/magic-byt), code:ts (import { validateAvatarMagicBytes } from './magic-bytes.vali), code:bash (cd backend && npm test -- --testPathPattern=magic-bytes), code:bash (git add backend/src/media/magic-bytes.validator.ts backend/s), Task 3: Magic Bytes Validation on Avatar Upload
...
Cohesion: 0.33
Nodes (6): 11. Frontend — ChatMessageBubble, code:dart (// Zastąpić:), code:dart (Widget _buildTextWithLinks(BuildContext context, String text), code:dart (if (message.linkPreviewUrl != null)), code:dart (Widget _buildLinkPreviewCard(BuildContext context, bool isDa), code:dart (import 'package:flutter/gestures.dart';  // TapGestureRecogn)

### Community 257 - "Community 257"
Cohesion: 0.33
Nodes (6): code:typescript (// backend/src/secret-notes/secret-notes.service.spec.ts), code:bash (cd backend && npx jest secret-notes.service.spec --no-covera), code:typescript (// backend/src/secret-notes/secret-notes.service.ts), code:bash (cd backend && npx jest secret-notes.service.spec --no-covera), code:bash (git add backend/src/secret-notes/secret-notes.service.ts bac), Task 2: SecretNotesService

### Community 258 - "Community 258"
Cohesion: 0.33
Nodes (6): code:typescript (// backend/src/secret-notes/secret-notes.controller.ts), code:bash (cd backend && npx jest secret-notes.controller.spec --no-cov), code:bash (git add backend/src/secret-notes/secret-notes.controller.ts ), code:typescript (// backend/src/secret-notes/secret-notes.controller.spec.ts), code:bash (cd backend && npx jest secret-notes.controller.spec --no-cov), Task 3: SecretNotesController
...
Cohesion: 0.33
Nodes (6): code:typescript (// backend/src/auth/auth-challenge.store.spec.ts), code:bash (cd backend && npx jest src/auth/auth-challenge.store.spec.ts), code:typescript (// backend/src/auth/auth-challenge.store.ts), code:bash (cd backend && npx jest src/auth/auth-challenge.store.spec.ts), code:bash (git add backend/src/auth/auth-challenge.store.ts backend/src), Task 4 — `AuthChallengeStore`

### Community 264 - "Community 264"
Cohesion: 0.33
Nodes (6): code:typescript (// backend/src/auth/device-sessions.service.ts), code:bash (cd backend && npx jest src/auth/device-sessions.service.spec), code:bash (git add backend/src/auth/device-sessions.service.ts backend/), code:typescript (// backend/src/auth/device-sessions.service.spec.ts), code:bash (cd backend && npx jest src/auth/device-sessions.service.spec), Task 2 — `DeviceSessionsService`
...
Cohesion: 0.4
Nodes (4): BadgingBridge, createBadgingBridge, _navigator, dart:js_util
...
Cohesion: 0.4
Nodes (5): Backend (modify), Backend (new), Files to Create/Modify, Frontend (modify), Frontend (new)
...
Cohesion: 0.4
Nodes (5): code:bash (# Lokalnie:), code:bash (# Skopiuj build na serwer), code:nginx (server {), Etap 8: Build frontendu, Serwowanie frontendu przez Nginx
...
Cohesion: 0.5
Nodes (4): Backend, Documentation, Frontend, Implementation Checklist

### Community 286 - "Community 286"
Cohesion: 0.5
Nodes (4): code:dart (// Monotonic counter for temporary negative message IDs — pr), code:dart (id: -DateTime.now().millisecondsSinceEpoch, // Temporary neg), code:dart (id: -(++ChatProvider._tempIdSeq), // Monotonic temporary neg), Fix A: Monotonic optimistic ID counter (4.2)
...
Cohesion: 0.5
Nodes (4): Test 1.1: Sending Message Shows Clock Icon, Test 1.2: Receiving Message Shows Double Checkmark, Test 1.3: Old Messages Have Delivered Status, Test 1: Message Delivery Indicators
...
Cohesion: 0.5
Nodes (4): 8. Quick Reference, code:bash (# Find IP), Commands, File Map

### Community 294 - "Community 294"
Cohesion: 0.5
Nodes (4): 13.1 Signal Protocol Documentation, 13.2 Implementation Guides, 13.3 Security Research, 13. Resources & Documentation

### Community 295 - "Community 295"
Cohesion: 0.5
Nodes (4): code:powershell (# Dodaj regułę dla port 3000), code:bash (# Powinno być 192.168.x.x (local network)), code:bash (docker ps  # Backend powinien być RUNNING), Problem 2: "Network error" / "Connection refused"
...
Cohesion: 0.5
Nodes (4): code:ts (const PRIVATE_IP_RE =), code:ts (const PRIVATE_IP_RE =), code:bash (git add backend/src/chat/services/link-preview.service.ts), Task 1 — Fix SSRF: add missing IP ranges to PRIVATE_IP_RE
...
Cohesion: 0.67
Nodes (3): Modified files:, New files:, Phase 8: Tests

### Community 304 - "Community 304"
Cohesion: 0.67
Nodes (3): code:dart (final who = otherName ?? 'Recipient';), code:dart (String _userFriendlySendError(Object e, int recipientId) {), Step 1: Find and replace all three Polish strings

### Community 305 - "Community 305"
Cohesion: 0.67
Nodes (3): code:dart (if (_activeConversationId == conversationId && content.isNot), code:dart (if (_activeConversationId == conversationId && content.isNot), Fix B: Retry preserves `replyToMessageId` (4.3)

## Knowledge Gaps
- **2304 isolated node(s):** `mockUsersService`, `mockConfigService`, `dto`, `mediaUrlError`, `_mediaOriginEscaped` (+2299 more)
...
- **Why does `Summary` connect `Community 210` to `Community 232`, `Community 42`, `Community 179`, `Community 182`, `Community 55`, `Community 152`, `Community 89`, `Community 90`, `Community 29`?**
  _High betweenness centrality (0.149) - this node is a cross-community bridge._
- **Why does `chat_detail_screen.dart` connect `Community 22` to `Community 32`, `Community 3`, `Community 4`, `Community 37`, `Community 5`, `Community 40`, `Community 8`, `Community 12`, `Community 44`, `Community 14`, `Community 47`, `Community 147`, `Community 20`, `Community 211`, `Community 27`, `Community 28`?**
  _High betweenness centrality (0.145) - this node is a cross-community bridge._
- **Why does `Full Codebase Refactor — Domain-Driven Decomposition` connect `Community 210` to `Community 74`, `Community 11`, `Community 108`, `Community 278`, `Community 249`, `Community 219`?**
