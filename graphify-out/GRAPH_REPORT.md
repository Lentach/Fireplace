# Graph Report - Fireplace  (2026-05-16)

## Corpus Check
- 328 files · ~344,818 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4725 nodes · 7608 edges · 317 communities (303 shown, 14 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e0c1eaca`
...
## Communities (317 total, 14 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (74): build, Icon, Exception, SizedBox, _formatTime, GestureDetector, Row, build (+66 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (20): buildCorsOrigin(), ChatGateway, AddReactionDto, BlockUserDto, RemoveReactionDto, SearchUsersDto, PushClientStateDto, RecordingVoiceDto (+12 more)
...
Cohesion: 0.04
Nodes (41): AppConstants, ConversationModel, FriendRequestModel, main, aesGcmDecrypt, aesGcmEncrypt, main, secureRandomBytes (+33 more)
...
Cohesion: 0.05
Nodes (51): SafeArea, build, ChatInputBar, _ChatInputBarState, Column, dispose, _formatTimer, initState (+43 more)
...
Cohesion: 0.09
Nodes (24): AuthService, Conversation, ConversationMapper, conv, createMockConversation(), lastMsg, payload, payload (+16 more)
...
Cohesion: 0.06
Nodes (48): add_or_invitations_screen.dart, avatar_circle.dart, _AddByUsernameTab, _AddByUsernameTabState, AddOrInvitationsScreen, build, Card, Center (+40 more)

### Community 11 - "Community 11"
Cohesion: 0.06
Nodes (27): AcceptFriendRequestDto, ALLOWED_EMOJIS, MEDIA_URL_REGEX, _mediaOriginEscaped, RejectFriendRequestDto, SendFriendRequestDto, SendMessageDto, dto (+19 more)
...
Cohesion: 0.05
Nodes (41): initState, Exception, _sanitizeFilename, build, Directory, dispose, Exception, Function (+33 more)

### Community 15 - "Community 15"
Cohesion: 0.07
Nodes (41): AuthScreen, _AuthScreenState, build, Scaffold, Shadow, SizedBox, Scaffold, build (+33 more)
...
Cohesion: 0.06
Nodes (31): AppScrollBehavior, buildOverscrollIndicator, AuthForm, _AuthFormState, build, Form, build, Dialog (+23 more)
...
Cohesion: 0.07
Nodes (36): 8. Message Model Enhancement, code:dart (enum MessageType {), code:dart (static MessageType _parseMessageType(String? type) {), code:dart (class MessageModel {), code:yaml (just_audio: ^0.9.36  # already exists), code:bash (git add frontend/pubspec.yaml frontend/pubspec.lock), code:dart (enum MessageType {), code:dart (static MessageType _parseMessageType(String? type) {) (+28 more)

### Community 23 - "Community 23"
Cohesion: 0.09
Nodes (32): blocked_users_screen.dart, BlockedUsersScreen, _BlockedUserTile, build, Padding, Scaffold, SizedBox, AlertDialog (+24 more)
...
Cohesion: 0.07
Nodes (30): anti_quantum_note_dialog.dart, Padding, AntiQuantumNoteDialog, _AntiQuantumNoteDialogState, build, dispose, Expanded, Padding (+22 more)
...
Cohesion: 0.1
Nodes (30): build, _buildHeaderTitle, _buildScrollToBottomButton, ChatDetailScreen, _ChatDetailScreenState, ChatInputBar, _clearActiveConversationIfThisChat, Column (+22 more)
...
Cohesion: 0.08
Nodes (24): Future Enhancements, Chat Screen Architecture - Source of Truth, Client → Server, code:typescript (@Entity('messages')), Colors (RpgTheme), Current Limitations, Database Schema Changes, Deployment Checklist (+16 more)
...
Cohesion: 0.08
Nodes (24): code:typescript (import {), code:typescript (async createImageMessage(data: {), code:typescript (import { MessagesController } from './messages.controller';), code:bash (curl -X POST http://localhost:3000/messages/image \), code:bash (git add backend/src/messages/messages.controller.ts), Phase 5: Image Upload for Messages (Camera & Drawing), Task 5.1: Backend - Image Message Upload Endpoint, code:typescript (export { DeleteConversationOnlyDto } from './delete-conversa) (+16 more)

### Community 37 - "Community 37"
Cohesion: 0.09
Nodes (20): main, main, main, _wrap, _gifMessage, main, _wrap, _wrapBubble (+12 more)
...
Cohesion: 0.08
Nodes (24): code:dart (import 'dart:convert';), code:dart (String? _blobUrl; // Web only: revoked on dispose), code:dart (Future<String> _downloadAndCache(String url) async {), code:dart (if (_blobUrl != null) {), code:block54 (cd frontend && flutter analyze lib/widgets/audio/playback_co), code:block55 (git add frontend/lib/widgets/audio/playback_controller.dart), Task 7: Voice PlaybackController — decrypt before play, ═══════════════════════════════════════ (+16 more)

### Community 43 - "Community 43"
Cohesion: 0.12
Nodes (18): api_service.dart, ApiService, _effectiveMediaUrl, jsonDecode, dispose, _fetch, GifModel, GifService (+10 more)

### Community 44 - "Community 44"
Cohesion: 0.1
Nodes (21): cancel, ChatReconnectManager, Duration, onDisconnect, resetAttempts, scheduleReconnect, applyRefreshedAccessToken, ConnectionProvider (+13 more)

### Community 45 - "Community 45"
Cohesion: 0.09
Nodes (22): code:ts (@Column({ type: 'timestamp', nullable: true })), code:ts (user.passwordChangedAt = new Date();), code:ts (const payload = {), code:ts (async validate(payload: {), code:ts (async validate(payload: {), code:ts (@Get('me')), code:dart (Future<Map<String, dynamic>> fetchMe(String token) async {), code:dart (// In ApiService.fetchMe, change the throw to:) (+14 more)
...
Cohesion: 0.09
Nodes (22): code:typescript (// backend/src/auth/dto/register.dto.ts), code:typescript (// backend/src/auth/dto/login.dto.ts), code:bash (git add backend/src/auth/dto/register.dto.ts backend/src/aut), code:typescript (// backend/src/auth/auth.service.spec.ts — add to existing d), code:bash (cd backend && npx jest src/auth/auth.service.spec.ts), code:typescript (import { DeviceSessionsService } from './device-sessions.ser), code:bash (cd backend && npx jest src/auth/auth.service.spec.ts), code:bash (git add backend/src/auth/auth.service.ts backend/src/auth/au) (+14 more)
...
Cohesion: 0.1
Nodes (20): 10. Frontend — ChatProvider, 1. Backend — Entity, 3. Backend — MessagesService, 4. Backend — MessageMapper, 6. Backend — ChatModule, 7. Frontend — pubspec.yaml, 8. Frontend — MessageModel, 9. Frontend — SocketService (+12 more)
...
Cohesion: 0.12
Nodes (13): getBaseUrlForPlatform, getBaseUrlForPlatform, revokeAudioObjectUrl, revokeAudioObjectUrl, Exception, _sanitizeFilename, _saveBytesAsDownload, _triggerAnchorDownload (+5 more)
...
Cohesion: 0.11
Nodes (18): Implementation Phases, Phase 2: Frontend Recording, Phase 5: Error Handling & Polish, Phase 6: Testing & Refinement, code:bash (git add frontend/lib/widgets/voice_recording_overlay.dart), code:dart (Future<void> retryVoiceMessage(String tempId) async {), code:dart (Widget _buildDeliveryIcon() {), code:bash (git add frontend/lib/providers/chat_provider.dart frontend/l) (+10 more)

### Community 60 - "Community 60"
Cohesion: 0.11
Nodes (19): code:bash (git status), code:bash (git add -A), code:bash (git log --oneline -8), code:bash (git push origin master), Task 12: Final Commit and Summary, code:bash (cd frontend && flutter analyze), code:bash (cd backend && npm run build), code:bash (git status) (+11 more)
...
Cohesion: 0.11
Nodes (17): ../audio/playback_controller.dart, ../audio/waveform_display.dart, build, _buildDeliveryIcon, _buildReplyQuote, Column, Container, _formatDuration (+9 more)

### Community 71 - "Community 71"
Cohesion: 0.13
Nodes (17): code:bash (# From project root. Replace CONTAINER with your postgres co), code:json ({), code:bash (cd frontend && flutter run -d chrome), code:sql (-- Last 5 messages with encryption status), Manual E2E Encryption Testing Guide, Prerequisites, Quick Reference: SQL Queries, Scope Reminder (+9 more)

### Community 72 - "Community 72"
Cohesion: 0.11
Nodes (17): code:typescript (export enum MessageType {), code:typescript (import { IsInt } from 'class-validator';), code:typescript (import { SendPingDto } from './dto/send-ping.dto';), code:javascript (socket.emit('sendPing', { recipientId: 2 });), code:bash (git add backend/src/messages/entities/message.entity.ts), Task 1.2: Add Ping Message Type, 1. Database Changes, 2. Cloudinary Service Enhancement (+9 more)
...
Cohesion: 0.12
Nodes (17): code:bash (git add backend/src/chat/chat.gateway.ts), Step 2.4: Commit gateway changes, code:bash (git add backend/src/chat/chat.gateway.ts \), Chunk 2: Backend Changes (upload-media endpoint, remove sendPing, remove old endpoints), code:typescript (import { IsIn, IsNumber, IsOptional, IsPositive } from 'clas), code:typescript (@Post('upload-media')), code:bash (git add backend/src/messages/), code:bash (git add backend/src/chat/) (+9 more)

### Community 80 - "Community 80"
Cohesion: 0.13
Nodes (15): code:dart (void sendPing(int recipientId) {), Chunk 4: Frontend — Encrypt all message types, code:dart (void sendPing(int recipientId) {), code:bash (git add frontend/lib/providers/chat_provider.dart), code:dart (// After successful upload:), code:bash (git add frontend/lib/providers/chat_provider.dart), code:dart (if (message.messageType == MessageType.ping) {), code:bash (git add frontend/lib/providers/chat_provider.dart frontend/l) (+7 more)

### Community 81 - "Community 81"
Cohesion: 0.12
Nodes (17): Chunk 4: Frontend — Extract ConnectionProvider + ConversationsProvider + MessagingProvider (Phase 4), code:dart (void connect({required String baseUrl, required String token), code:dart (_socketService.connect(baseUrl: baseUrl, token: token);), code:bash (git add frontend/lib/services/socket_service.dart frontend/l), code:dart (// frontend/lib/providers/connection_provider.dart), code:bash (git add frontend/lib/providers/connection_provider.dart), code:bash (git add frontend/lib/providers/messaging_provider.dart), code:dart (MultiProvider() (+9 more)
...
Cohesion: 0.12
Nodes (16): code:dart (// frontend/lib/utils/e2e_envelope.dart), code:block11 (cd frontend && flutter test test/utils/e2e_envelope_test.dar), code:block12 (git add frontend/lib/utils/e2e_envelope.dart \), code:dart (// frontend/lib/utils/web_blob_utils_stub.dart), code:dart (// frontend/lib/utils/web_blob_utils_web.dart), code:block30 (cd frontend && flutter analyze lib/utils/web_blob_utils_stub), code:block31 (git add frontend/lib/utils/web_blob_utils_stub.dart \), code:dart (// frontend/test/utils/e2e_envelope_test.dart) (+8 more)
...
Cohesion: 0.12
Nodes (11): GeneratedPluginRegistrant, GeneratedPluginRegistrant, -registerWithRegistry, Add, Add / Replace, `chat_detail_screen.dart`, `CLAUDE.md`, Component Changes (+3 more)
...
Cohesion: 0.19
Nodes (14): base64UrlEncode, _base64UrlToUint8List, _bytesFromArrayBuffer, createWebPushBridge, _isIOSWebKit, isStandaloneOrNotRequired, _navigatorHas, _NavigatorStandalone (+6 more)

### Community 97 - "Community 97"
Cohesion: 0.17
Nodes (12): DefaultFirebaseOptions, UnsupportedError, AndroidNotificationChannel, Function, handleFcmRemoteMessageOpen, setAndroidNotificationConversationTapHandler, showFireplaceMessageNotificationWithPlugin, UnsupportedError (+4 more)

### Community 98 - "Community 98"
Cohesion: 0.13
Nodes (14): 1.1 Frontend (Flutter), 1. Current Configuration, 2. Files to Modify, 5. Verification Checklist, 7. Production Next Steps, 8. Quick Reference, code:bash (# Find IP), Commands (+6 more)

### Community 99 - "Community 99"
Cohesion: 0.13
Nodes (14): Backend, Chat Screen Redesign - End-to-End Test Plan, Frontend, Prerequisites, Test 3.1: Send Ping, Test 3.2: Receive Ping - Visual Effect, Test 3.3: Ping Message in History, Test 3: Ping Feature (+6 more)
...
Cohesion: 0.13
Nodes (15): code:bash (docker-compose down), code:bash (taskkill //F //IM node.exe), code:bash (docker-compose up --build), code:bash (curl http://localhost:3000), code:bash (docker-compose down), code:bash (docker images | findstr "mvp-chat-app"), code:bash (docker system prune -a), code:bash (docker-compose up --build) (+7 more)

### Community 102 - "Community 102"
Cohesion: 0.14
Nodes (15): code:bash (git add frontend/lib/services/socket_service.dart), Step 3.4: Commit socket service changes, code:dart (Future<String> createSecretNote(String token, String ciphert), code:dart (import 'package:encrypt/encrypt.dart' as enc;), code:dart (Future<void> sendAntiQuantumNote({), code:bash (cd frontend && flutter test 2>&1 | tail -15), code:bash (git add frontend/lib/services/api_service.dart frontend/lib/), Task 7: sendNote in ChatProvider (crypto + API + send message) (+7 more)

### Community 103 - "Community 103"
Cohesion: 0.13
Nodes (14): Chat Screen Redesign - Telegram/Wire Inspired UI, code:bash (cd frontend), code:bash (git add frontend/lib/models/message_model.dart), code:bash (# Start backend), code:markdown (# Chat Redesign Manual Test Results), code:bash (git add docs/testing/2026-02-04-chat-redesign-manual-tests.m), Current State Analysis, Phase 1: Backend - Message Model Extensions (+6 more)
...
Cohesion: 0.14
Nodes (11): Function, handleFcmRemoteMessageOpen, setAndroidNotificationConversationTapHandler, _currentPlatform, Function, PushService, _registerExistingWebSubscription, _unregisterWebPush (+3 more)
...
Cohesion: 0.16
Nodes (13): 6. API Service Enhancement, code:dart (Future<VoiceUploadResult> uploadVoiceMessage({), code:dart (class VoiceUploadResult {), Phase 3: Frontend Upload & Optimistic UI, code:dart (import 'dart:io';), code:dart (class VoiceUploadResult {), code:dart (Future<VoiceUploadResult> uploadVoiceMessage({), code:bash (git add frontend/lib/services/api_service.dart) (+5 more)
...
Cohesion: 0.15
Nodes (13): 5. ChatProvider - New Methods, code:dart (void deleteConversationOnly(int conversationId) {), code:dart (onConversationDeleted: (data) {), code:dart (void deleteConversationOnly(int conversationId) {), code:dart (void _handleConversationDeleted(dynamic data) {), code:dart (onConversationDeleted: _handleConversationDeleted,), code:bash (git add frontend/lib/providers/chat_provider.dart), Step 4.1: Add deleteConversationOnly method (+5 more)
...
Cohesion: 0.15
Nodes (12): Anti-Quantum Note — Design Spec, Backend, Backend (modify), Backend (new), Database, Files to Create/Modify, Frontend (modify), Frontend (new) (+4 more)
...
Cohesion: 0.2
Nodes (12): 1. Critical Rules & Gotchas, E2E Encryption, Frontend, TypeORM, Backend, Documentation, Frontend, Implementation Checklist (+4 more)
...
Cohesion: 0.17
Nodes (12): code:typescript (/** True if either user has blocked the other. Single query ), code:bash (cd backend && npm test --no-coverage 2>&1 | tail -15), code:bash (cd backend && git add src/blocked/blocked.service.ts), code:typescript (/** True only for safe HTTPS URLs pointing to public hosts *), code:typescript (imageUrl: imageUrl ? imageUrl.trim() : null,), code:typescript (imageUrl: imageUrl && isSafeImageUrl(imageUrl.trim()) ? imag), code:bash (cd backend && npm test --no-coverage 2>&1 | tail -15), code:bash (cd backend && git add src/chat/services/link-preview.service) (+4 more)
...
Cohesion: 0.17
Nodes (12): code:dart (import '../services/media_crypto_service.dart';), code:dart (final MediaCryptoService _mediaCrypto = MediaCryptoService()), code:dart (// In the try block, replace:), code:dart (Future<void> _encryptAndSend({), code:dart (// Voice: duration comes from the existing dto.duration or i), code:bash (cd frontend && flutter analyze), code:bash (cd frontend && flutter test), code:bash (git add frontend/lib/providers/messaging_provider.dart) (+4 more)
...
Cohesion: 0.18
Nodes (10): code:dart (// frontend/lib/providers/auth_provider.dart), code:bash (cd frontend && flutter test test/providers/auth_provider_ide), code:bash (git add frontend/lib/providers/auth_provider.dart frontend/t), code:dart (import 'package:jwt_decoder/jwt_decoder.dart';), code:bash (git add frontend/lib/providers/connection_provider.dart), Execution Handoff, PR 6 — Frontend AuthProvider + ConnectionProvider Rewrite, Self-Review (+2 more)
...
Cohesion: 0.2
Nodes (8): copyWith, MessageModel, needsDecryption, parseDeliveryStatus, _parseMessageType, ReplyToPreview, copyWith, UserModel
...
Cohesion: 0.22
Nodes (8): Function, handler, onData, onDone, onError, pause, resume, _VisibilityChangeSubscription
...
Cohesion: 0.22
Nodes (9): 3. Run on device, code:block25, code:block26, code:bash (git add README.md), code:bash (docker-compose -f docker-compose.web.yml up --build), code:bash (docker-compose -f docker-compose.web.yml down), code:markdown (## Startup Commands (2026-02-12)), Task 11: Update MEMORY.md with New Startup Commands (+1 more)
...
Cohesion: 0.22
Nodes (9): code:dart (Widget _buildDeliveryIcon() {), code:dart (String? _getTimerText() {), code:dart (@override), code:bash (git add frontend/lib/widgets/chat_message_bubble.dart), Task 3.1: Update ChatMessageBubble with Delivery Indicator & Timer, code:dart (else if (message.messageType == MessageType.gif && message.m), code:dart (void _showGifDialog(BuildContext context, String url) {), code:bash (git add frontend/lib/widgets/chat_message_bubble.dart) (+1 more)
...
Cohesion: 0.25
Nodes (8): 1.2 Backend (NestJS), 6.1 Flutter (Mobile App), 6.2 Backend (NestJS), 6.3 Infrastructure, 6. Libraries & Dependencies, code:yaml (# pubspec.yaml), code:yaml (# android/app/build.gradle), code:json ({)
...
Cohesion: 0.25
Nodes (8): Chunk 4: Frontend — ChatProvider + Wire-up + Bubble, code:dart (/// Send a GIF message. Downloads from Giphy, uploads to Clo), code:dart (onTap: () => _showComingSoon(context, l10n.actionTileGif),), code:dart (onTap: () => _openGifPicker(context),), code:dart (void _openGifPicker(BuildContext context) {), code:dart (import 'gif_picker_sheet.dart';), Task 12: Add sendGif to ChatProvider, Task 13: Wire GIF picker to action tiles
...
Cohesion: 0.21
Nodes (8): code:ts (const PRIVATE_IP_RE =), code:ts (const PRIVATE_IP_RE =), code:bash (git add backend/src/chat/services/link-preview.service.ts), Placeholder Scan, Self-Review, Spec Coverage Check, Task 1 — Fix SSRF: add missing IP ranges to PRIVATE_IP_RE, Type Consistency
...
Cohesion: 0.33
Nodes (3): mockConfigService, mockUsersService, JwtStrategy

### Community 234 - "Community 234"
Cohesion: 0.29
Nodes (6): BadgingBridge, createBadgingBridge, _navigator, _navigatorHasBadgingApi, dart:js_interop_unsafe, dart:js_util
...
Cohesion: 0.33
Nodes (6): Ciphertext String Format, code:block1 (Alice                          Server                       ), code:block2 (BEFORE: { content: "Cześć Bob!" }), First Message Flow (X3DH), Signal Protocol Overview (for this app), What Server Sees
...
Cohesion: 0.33
Nodes (5): Current State, E2E Encryption for All Message Types + Drawing Removal, Non-Goals, Summary, Target State
...
Cohesion: 0.33
Nodes (6): code:dart (// inside ApiService), code:dart (Future<Map<String, dynamic>> fetchMe([String? unused]) async), code:dart (AuthProvider() {), code:bash (cd frontend && flutter test), code:bash (git add frontend/lib/services/api_service.dart frontend/lib/), Task 22 — `ApiService` 401 retry helper + apply to all methods
...
Cohesion: 0.4
Nodes (5): code:typescript (// backend/src/auth/dto/challenge.dto.ts), code:typescript (// backend/src/auth/dto/refresh-with-key.dto.ts), code:typescript (// backend/src/auth/dto/device-info.dto.ts), code:bash (git add backend/src/auth/dto/challenge.dto.ts backend/src/au), Task 7 — New auth DTOs
...
Cohesion: 0.5
Nodes (4): Reading Page (served by backend), State 1 — Landing (note exists, not yet read), State 2 — Revealed (after button click), State 3 — Gone (already read or expired)
...
## Knowledge Gaps
- **2343 isolated node(s):** `mockUsersService`, `mockConfigService`, `dto`, `mediaUrlError`, `_mediaOriginEscaped` (+2338 more)
...
- **Why does `chat_detail_screen.dart` connect `Community 27` to `Community 0`, `Community 6`, `Community 40`, `Community 10`, `Community 44`, `Community 13`, `Community 14`, `Community 15`, `Community 17`, `Community 18`, `Community 19`, `Community 53`, `Community 23`, `Community 25`, `Community 94`?**
  _High betweenness centrality (0.161) - this node is a cross-community bridge._
- **Why does `Full Codebase Refactor — Domain-Driven Decomposition` connect `Community 120` to `Community 230`, `Community 11`, `Community 107`, `Community 248`, `Community 219`?**
  _High betweenness centrality (0.148) - this node is a cross-community bridge._
- **Why does `Summary` connect `Community 120` to `Community 65`, `Community 99`, `Community 103`, `Community 263`, `Community 140`, `Community 45`, `Community 210`, `Community 30`?**
