...
## Corpus Check
- 343 files · ~354,190 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4932 nodes · 7886 edges · 312 communities (299 shown, 13 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `483a4c92`
...
## Communities (312 total, 13 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (78): _acknowledgeHistoryFetch, _addMessageToState, addReaction, _cancelDelayedRetry, _cancelDelayedRetryIfAny, clearAll, clearChatHistory, clearMessages (+70 more)
...
Cohesion: 0.05
Nodes (68): add_or_invitations_screen.dart, blocked_users_screen.dart, _AddByUsernameTab, _AddByUsernameTabState, AddOrInvitationsScreen, build, Card, Center (+60 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (65): ../audio/playback_controller.dart, ../audio/waveform_display.dart, Icon, AlertDialog, build, _buildEphemeralPrefix, _buildLastMessageEphemeralIndicator, _buildTrailingMetaRow (+57 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (64): build, Exception, build, Directory, dispose, Exception, Function, initState (+56 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (58): anti_quantum_note_dialog.dart, Padding, AppScrollBehavior, buildOverscrollIndicator, AntiQuantumNoteDialog, _AntiQuantumNoteDialogState, build, dispose (+50 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (57): _ActionTile, AlertDialog, _apply, build, _CenterProgressOverlay, ChatActionTiles, _CircularProgressPainter, _clearError (+49 more)

### Community 7 - "Community 7"
Cohesion: 0.08
Nodes (25): mockConfigService, mockUsersService, ConversationMapper, conv, createMockConversation(), lastMsg, payload, payload (+17 more)

### Community 8 - "Community 8"
Cohesion: 0.09
Nodes (11): BlockedService, ConversationsService, StartConversationDto, MediaCleanupService, mockMessageRepo, mockStorage, ChatConversationService, friend (+3 more)
...
Cohesion: 0.08
Nodes (20): GetMessagesDto, MarkConversationReadDto, MessageDeliveredDto, PendingBucket, PushNotificationCoalescingService, NotifyOptions, PushNotificationsService, ChatLinkPreviewService (+12 more)

### Community 18 - "Community 18"
Cohesion: 0.08
Nodes (36): build, _buildInfoCard, _buildLocalCacheCard, Center, Container, initState, PrivacySafetyScreen, _PrivacySafetyScreenState (+28 more)
...
Cohesion: 0.07
Nodes (33): Exception, build, buildRecordingBar, _checkMicPermission, dispose, _emitRecordingVoiceToRecipient, Exception, ExcludeFocus (+25 more)

### Community 21 - "Community 21"
Cohesion: 0.08
Nodes (35): build, _buildHeaderTitle, _buildScrollToBottomButton, ChatDetailScreen, _ChatDetailScreenState, ChatInputBar, _clearActiveConversationIfThisChat, Column (+27 more)
...
Cohesion: 0.07
Nodes (29): Backend, Chat Screen Redesign - End-to-End Test Plan, Frontend, Prerequisites, Test 10.1: Image Upload Validation - MIME Type, Test 10.2: Image Upload Validation - File Size, Test 10.3: CORS Headers, Test 10: Backend Validation (+21 more)
...
Cohesion: 0.09
Nodes (24): main, main, _wrap, _lastMessage, main, MaterialApp, MessageModel, _wrap (+16 more)
...
Cohesion: 0.09
Nodes (24): _bannerDurationLabel, build, ChatInputBar, _ChatInputBarState, Column, dispose, _formatTimer, initState (+16 more)
...
Cohesion: 0.09
Nodes (20): main, _msg, _FakeEncryptionProvider, main, TimeoutException, main, expectLater, main (+12 more)
...
Cohesion: 0.14
Nodes (9): FriendRequest, FriendRequestStatus, FriendsService, FriendRequestMapper, payload, request, friendRequestsB, ChatValidationService (+1 more)
...
Cohesion: 0.08
Nodes (24): initState, AnimatedBuilder, build, Center, dispose, initState, PingEffectOverlay, _PingEffectOverlayState (+16 more)
...
Cohesion: 0.08
Nodes (25): code:dart (import 'package:flutter_test/flutter_test.dart';), code:dart (import 'package:flutter_test/flutter_test.dart';), code:dart (/// Persist decrypted message content to local cache.), Step 1.1: Write the failing tests, Step 1.2: Run tests to verify they fail, Step 1.3: Add delegation methods to EncryptionProvider, Step 1.4: Run tests to verify they pass, Task 1: Add delegation methods to EncryptionProvider + tests (+17 more)
...
Cohesion: 0.14
Nodes (3): MessagesService, msgs, LinkPreviewService
...
Cohesion: 0.09
Nodes (24): code:dart (import 'dart:io';), code:dart (import 'package:image_picker/image_picker.dart';), code:dart (import 'package:image_picker/image_picker.dart';), code:dart (import 'dart:typed_data';), code:yaml (dependencies:), code:dart (// In build() method, update content section:), code:bash (git add frontend/lib/services/api_service.dart), Task 5.2: Frontend - Camera & Drawing Upload (+16 more)
...
Cohesion: 0.13
Nodes (21): avatar_circle.dart, AvatarCircle, _AvatarCircleState, build, _buildImageUrl, Container, didUpdateWidget, initState (+13 more)
...
Cohesion: 0.13
Nodes (7): AuthController, createAuthServiceMock(), AuthService, LoginDto, RefreshBodyDto, RegisterDto, login()
...
Cohesion: 0.14
Nodes (13): _decodeHtmlEntities, isSafeImageUrl, LinkPreviewService, main, package:fireplace/services/link_preview_service.dart, expectedPayload, preview, extractFirstUrl() (+5 more)
...
Cohesion: 0.12
Nodes (19): code:bash (git add -A), code:bash (rm frontend/Dockerfile.dev), code:bash (# Kill old processes), code:bash (docker system prune -a), code:bash (git add -A), Migration Procedure, code:bash (git add -A), code:bash (rm frontend/Dockerfile.dev) (+11 more)

### Community 75 - "Community 75"
Cohesion: 0.11
Nodes (19): BASE_URL Setup, code:bash (flutter run -d <device> --dart-define=BASE_URL=http://192.16), code:dart (// lib/constants/app_constants.dart), code:dart (// lib/config/env_config.dart), code:bash (docker-compose up), code:bash (cd frontend), code:bash (flutter run -d <device-id> --dart-define=BASE_URL=http://192), code:bash (docker-compose down) (+11 more)
...
Cohesion: 0.11
Nodes (19): code:dart (test('build includes messageType when provided', () {), code:dart (class E2eEnvelope {), code:bash (git add frontend/lib/utils/e2e_envelope.dart frontend/test/u), Task 3: Extend E2E Envelope with messageType, mediaUrl, mediaDuration, code:dart (import 'dart:convert';), code:dart (String? _blobUrl; // Web only: revoked on dispose), code:dart (Future<String> _downloadAndCache(String url) async {), code:dart (if (_blobUrl != null) {) (+11 more)
...
Cohesion: 0.12
Nodes (16): Chunk 1: Drawing Removal + Envelope Extension + Model Changes, Chunk 5: Final integration, persist/restore, tests, docs, code:dart (final data = <String, dynamic>{), code:dart (final restoredType = _parseMessageTypeString(stored?['messag), code:bash (git add frontend/lib/providers/chat_provider.dart), code:bash (git add -A frontend/lib/screens/drawing_canvas_screen.dart f), code:bash (git add CLAUDE.md), E2E Encryption for All Message Types + Drawing Removal — Implementation Plan (+8 more)
...
Cohesion: 0.11
Nodes (17): code:typescript (import {), code:typescript (async createImageMessage(data: {), code:typescript (import { MessagesController } from './messages.controller';), code:bash (curl -X POST http://localhost:3000/messages/image \), code:bash (git add backend/src/messages/messages.controller.ts), Phase 5: Image Upload for Messages (Camera & Drawing), Task 5.1: Backend - Image Message Upload Endpoint, code:typescript (import { IsInt } from 'class-validator';) (+9 more)
...
Cohesion: 0.18
Nodes (15): base64UrlEncode, _base64UrlToUint8List, _bytesFromArrayBuffer, createWebPushBridge, _isIOSWebKit, isStandaloneOrNotRequired, _navigatorHas, _NavigatorStandalone (+7 more)
...
Cohesion: 0.22
Nodes (8): Function, main, _openSheet, _tapSheetButton, _wrap, package:fireplace/widgets/chat_action_tiles.dart, package:fireplace/widgets/disappearing_timer_sheet.dart, package:flutter/cupertino.dart
...
Cohesion: 0.33
Nodes (5): BadgingBridge, createBadgingBridge, _navigator, _navigatorHasBadgingApi, dart:js_interop_unsafe
...
Cohesion: 0.4
Nodes (3): E2eEnvelope, main, package:fireplace/utils/e2e_envelope.dart
...
## Knowledge Gaps
- **2519 isolated node(s):** `mockUsersService`, `mockConfigService`, `dto`, `mediaUrlError`, `_mediaOriginEscaped` (+2514 more)
...
- **Why does `chat_detail_screen.dart` connect `Community 21` to `Community 64`, `Community 33`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 32`, `Community 167`, `Community 41`, `Community 10`, `Community 18`, `Community 19`, `Community 55`, `Community 219`?**
  _High betweenness centrality (0.163) - this node is a cross-community bridge._
- **Why does `Summary` connect `Community 216` to `Community 229`, `Community 230`, `Community 201`, `Community 45`, `Community 48`, `Community 118`, `Community 89`, `Community 90`, `Community 29`, `Community 190`?**
  _High betweenness centrality (0.155) - this node is a cross-community bridge._
- **Why does `Full Codebase Refactor — Domain-Driven Decomposition` connect `Community 216` to `Community 14`, `Community 242`, `Community 277`, `Community 88`, `Community 123`, `Community 223`?**
