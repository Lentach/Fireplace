...
## Corpus Check
- 343 files · ~354,485 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4934 nodes · 7890 edges · 333 communities (321 shown, 12 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d6a851cc`
...
## Communities (333 total, 12 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (83): build, AuthScreen, _AuthScreenState, build, Scaffold, Shadow, SizedBox, initState (+75 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (79): _acknowledgeHistoryFetch, _addMessageToState, addReaction, _cancelDelayedRetry, _cancelDelayedRetryIfAny, clearAll, clearChatHistory, clearMessages (+71 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (65): blocked_users_screen.dart, applyPhonePortraitOrientations, AuthGate, _AuthGateState, AuthScreen, didChangeMetrics, dispose, FireplaceApp (+57 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (16): buildCorsOrigin(), ChatGateway, BlockUserDto, SearchUsersDto, PushClientStateDto, RecordingVoiceDto, TypingDto, WsThrottlerGuard (+8 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (60): ../audio/playback_controller.dart, ../audio/waveform_display.dart, Icon, _isExpired, AlertDialog, build, _buildEphemeralPrefix, _buildLastMessageEphemeralIndicator (+52 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (58): _ActionTile, AlertDialog, _apply, build, _CenterProgressOverlay, ChatActionTiles, _CircularProgressPainter, _clearError (+50 more)
...
Cohesion: 0.09
Nodes (19): AuthController, createAuthServiceMock(), AuthService, Conversation, LoginDto, RefreshBodyDto, RegisterDto, ConversationMapper (+11 more)
...
Cohesion: 0.07
Nodes (26): AcceptFriendRequestDto, AddReactionDto, ALLOWED_EMOJIS, GetMessagesDto, MEDIA_URL_REGEX, _mediaOriginEscaped, RejectFriendRequestDto, SendFriendRequestDto (+18 more)
...
Cohesion: 0.06
Nodes (36): anti_quantum_note_dialog.dart, Padding, AppScrollBehavior, buildOverscrollIndicator, AntiQuantumNoteDialog, _AntiQuantumNoteDialogState, build, dispose (+28 more)

### Community 15 - "Community 15"
Cohesion: 0.1
Nodes (20): MarkConversationReadDto, MessageDeliveredDto, MediaCleanupService, mockMessageRepo, mockStorage, MessageCleanupService, expired, Message (+12 more)

### Community 16 - "Community 16"
Cohesion: 0.1
Nodes (35): axios, connectSocket(), createUser(), io, runTest(), sleep(), axios, connectSocket() (+27 more)

### Community 17 - "Community 17"
Cohesion: 0.07
Nodes (35): Exception, Function, build, buildRecordingBar, _checkMicPermission, dispose, _emitRecordingVoiceToRecipient, Exception (+27 more)
...
Cohesion: 0.06
Nodes (34): code:dart (void _handleConversationDeleted(dynamic data) {), code:dart (onConversationDeleted: _handleConversationDeleted,), code:dart (// Menu (three dots)), code:bash (git add frontend/lib/screens/chat_detail_screen.dart), code:dart (import 'archive_placeholder_screen.dart';), code:dart (import 'contacts_screen.dart';), code:dart (const ArchivePlaceholderScreen(),), code:dart (const ContactsScreen(),) (+26 more)
...
Cohesion: 0.08
Nodes (32): avatar_circle.dart, Positioned, build, _buildConversationList, _buildCustomHeader, _buildDesktopLayout, _buildMobileLayout, Center (+24 more)
...
Cohesion: 0.1
Nodes (17): PendingBucket, PushNotificationCoalescingService, NotifyOptions, PushNotificationsService, conv, data, emitCalls, expiresAt (+9 more)

### Community 29 - "Community 29"
Cohesion: 0.11
Nodes (5): RemoveReactionDto, MessagesService, msgs, ChatReactionService, mockConversation

### Community 30 - "Community 30"
Cohesion: 0.08
Nodes (26): main, main, _wrap, Function, main, _openSheet, _tapSheetButton, _wrap (+18 more)
...
Cohesion: 0.08
Nodes (29): code:dart (// frontend/lib/utils/web_blob_utils_stub.dart), code:dart (// frontend/lib/utils/web_blob_utils_web.dart), code:block30 (cd frontend && flutter analyze lib/utils/web_blob_utils_stub), code:block31 (git add frontend/lib/utils/web_blob_utils_stub.dart \), code:dart (import 'dart:convert';), code:dart (String? _blobUrl; // Web only: revoked on dispose), code:dart (Future<String> _downloadAndCache(String url) async {), code:dart (if (_blobUrl != null) {) (+21 more)

### Community 34 - "Community 34"
Cohesion: 0.07
Nodes (27): Future Enhancements, Chat Screen Architecture - Source of Truth, Client → Server, code:typescript (@Entity('messages')), Colors (RpgTheme), Current Limitations, Database Schema Changes, Deployment Checklist (+19 more)

### Community 35 - "Community 35"
Cohesion: 0.08
Nodes (25): build, Dialog, dispose, ResetPasswordDialog, _ResetPasswordDialogState, SizedBox, _submit, build (+17 more)
...
Cohesion: 0.09
Nodes (24): Implementation Phases, Phase 2: Frontend Recording, Phase 3: Frontend Upload & Optimistic UI, Phase 6: Testing & Refinement, code:yaml (just_audio: ^0.9.36  # already exists), code:bash (git add frontend/pubspec.yaml frontend/pubspec.lock), code:dart (import 'package:flutter/material.dart';), code:bash (git add frontend/lib/widgets/voice_recording_overlay.dart) (+16 more)
...
Cohesion: 0.08
Nodes (21): Function, Function, _bannerDurationLabel, build, ChatInputBar, _ChatInputBarState, Column, dispose (+13 more)
...
Cohesion: 0.09
Nodes (22): Backend, Chat Screen Redesign - End-to-End Test Plan, Frontend, Prerequisites, Test 3.1: Send Ping, Test 3.2: Receive Ping - Visual Effect, Test 3.3: Ping Message in History, Test 3: Ping Feature (+14 more)
...
Cohesion: 0.12
Nodes (20): build, FileMessageContent, GifMessageContent, ImageMessageContent, MessageContentFactory, PingMessageContent, TextMessageContent, VoiceMessageContent (+12 more)
...
Cohesion: 0.11
Nodes (14): getBaseUrlForPlatform, getBaseUrlForPlatform, revokeAudioObjectUrl, revokeAudioObjectUrl, _sanitizeFilename, Exception, _sanitizeFilename, _saveBytesAsDownload (+6 more)
...
Cohesion: 0.11
Nodes (20): code:bash (cd frontend), code:bash (git add frontend/lib/models/message_model.dart), Phase 2: Frontend - Message Model & Provider Updates, Task 2.1: Extend MessageModel with New Fields, code:bash (cd frontend), code:bash (flutter run --dart-define=BASE_URL=http://192.168.1.100:3000), Step 6: Run Flutter on device, code:bash (cd frontend) (+12 more)
...
Cohesion: 0.16
Nodes (15): api_service.dart, ApiService, _effectiveMediaUrl, jsonDecode, ArgumentError, EncryptedMedia, MediaCryptoService, main (+7 more)

### Community 76 - "Community 76"
Cohesion: 0.18
Nodes (11): _decodeHtmlEntities, isSafeImageUrl, LinkPreviewService, expectedPayload, preview, extractFirstUrl(), isPrivateOrLocal(), isSafeImageUrl() (+3 more)

### Community 77 - "Community 77"
Cohesion: 0.14
Nodes (17): add_or_invitations_screen.dart, _AddByUsernameTab, _AddByUsernameTabState, AddOrInvitationsScreen, build, Card, Center, DefaultTabController (+9 more)
...
Cohesion: 0.12
Nodes (13): main, _msg, main, expectLater, main, _lastMessage, main, MaterialApp (+5 more)

### Community 86 - "Community 86"
Cohesion: 0.18
Nodes (16): AlertDialog, build, _buildContactsList, _buildContactTile, _buildHeader, _compareByDisplayName, ContactsScreen, Container (+8 more)
...
Cohesion: 0.14
Nodes (14): Phase 5: Error Handling & Polish, code:dart (Future<void> retryVoiceMessage(String tempId) async {), code:dart (Widget _buildDeliveryIcon() {), code:bash (git add frontend/lib/providers/chat_provider.dart frontend/l), code:dart (Future<void> _loadAndPlayAudio() async {), code:dart (bool _isExpired() {), code:bash (git add frontend/lib/widgets/voice_message_bubble.dart), code:dart (import 'package:audio_waveforms/audio_waveforms.dart';) (+6 more)
...
Cohesion: 0.18
Nodes (8): main, buildProviderWithSampleData, main, main, package:fireplace/models/user_model.dart, package:fireplace/providers/auth_provider.dart, package:fireplace/providers/conversations_provider.dart, package:fireplace/providers/friends_provider.dart

### Community 177 - "Community 177"
Cohesion: 0.18
Nodes (8): E2eEnvelope, _FakeEncryptionProvider, jsonEncode, main, TimeoutException, main, package:fake_async/fake_async.dart, package:fireplace/utils/e2e_envelope.dart
...
Cohesion: 0.18
Nodes (11): ═══════════════════════════════════════, code:typescript (// backend/src/media/local-storage.service.spec.ts), code:bash (cd backend && npx jest local-storage.service.spec.ts --no-co), code:typescript (// backend/src/media/local-storage.service.ts), code:yaml (# docker-compose.yml — replace Cloudinary env vars with MEDI), code:nginx (server {), code:bash (# Upload), code:bash (cd backend && npx jest local-storage.service.spec.ts --no-co) (+3 more)
...
Cohesion: 0.22
Nodes (8): _gifMessage, main, _wrap, _wrapBubble, package:fireplace/widgets/message/chat_message_bubble.dart, package:fireplace/widgets/message/gif_message_content.dart, package:fireplace/widgets/message/image_message_content.dart, package:fireplace/widgets/message/text_message_content.dart
...
Cohesion: 0.22
Nodes (8): code:dart (void onPreKeysLow(dynamic data) {), code:dart (void onPreKeyBundleResponse(dynamic data) {), code:bash (cd frontend && flutter test), code:bash (git add frontend/lib/providers/encryption_provider.dart CLAU), E2E Encryption Hardening — Implementation Plan, File Map, Summary, Task 4: OTP Exhaustion — Trigger Replenishment and Warn on Null OTP
...
Cohesion: 0.25
Nodes (8): code:dart (// frontend/lib/providers/encryption_provider.dart), code:bash (git add frontend/lib/providers/encryption_provider.dart), code:bash (git add frontend/lib/providers/encryption_provider.dart fron), code:dart (// frontend/lib/providers/connection_provider.dart), code:bash (git add frontend/lib/providers/connection_provider.dart), Task 2.1: Create `EncryptionProvider` skeleton with state + interface, Task 2.3: Move E2E initialization + key exchange logic to EncryptionProvider, Task 4.2: Create ConnectionProvider
...
Cohesion: 0.33
Nodes (5): Files Changed, Goal, Problem, Scope, Spec: In-Session Conversation Message Cache
...
Cohesion: 0.4
Nodes (4): main, MessageModel, _msg, package:fireplace/utils/message_expiry.dart

### Community 286 - "Community 286"
Cohesion: 0.4
Nodes (4): expectLater, main, MediaCryptoService, package:fireplace/services/media_crypto_service.dart
...
Cohesion: 0.5
Nodes (3): combineDisappearingSeconds, Duration, isMessageExpired
...
## Knowledge Gaps
- **2521 isolated node(s):** `mockUsersService`, `mockConfigService`, `dto`, `mediaUrlError`, `_mediaOriginEscaped` (+2516 more)
...
- **Why does `chat_detail_screen.dart` connect `Community 22` to `Community 0`, `Community 2`, `Community 35`, `Community 4`, `Community 5`, `Community 8`, `Community 40`, `Community 43`, `Community 14`, `Community 46`, `Community 18`, `Community 50`, `Community 220`, `Community 86`, `Community 24`, `Community 92`?**
  _High betweenness centrality (0.171) - this node is a cross-community bridge._
- **Why does `Full Codebase Refactor — Domain-Driven Decomposition` connect `Community 219` to `Community 224`, `Community 257`, `Community 9`, `Community 299`, `Community 80`, `Community 118`?**
  _High betweenness centrality (0.148) - this node is a cross-community bridge._
- **Why does `Summary` connect `Community 219` to `Community 256`, `Community 195`, `Community 101`, `Community 313`, `Community 44`, `Community 236`, `Community 48`, `Community 184`, `Community 217`, `Community 188`?**
  _High betweenness centrality (0.145) - this node is a cross-community bridge._
- **What connects `mockUsersService`, `mockConfigService`, `dto` to the rest of the system?**
  _2521 weakly-connected nodes found - possible documentation gaps or missing edges._
