...
## Corpus Check
- 326 files · ~341,614 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4669 nodes · 7526 edges · 305 communities (291 shown, 14 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a8635bf9`
...
## Communities (305 total, 14 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (68): AppConstants, ConversationModel, ArgumentError, EncryptedMedia, MediaCryptoService, main, aesGcmDecrypt, aesGcmEncrypt (+60 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (18): buildCorsOrigin(), ChatGateway, BlockUserDto, SearchUsersDto, PushClientStateDto, RecordingVoiceDto, TypingDto, WsThrottlerGuard (+10 more)
...
Cohesion: 0.05
Nodes (69): blocked_users_screen.dart, BlockedUsersScreen, _BlockedUserTile, build, Padding, Scaffold, SizedBox, build (+61 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (65): ../audio/playback_controller.dart, ../audio/waveform_display.dart, Icon, AppScrollBehavior, buildOverscrollIndicator, Row, Semantics, build (+57 more)
...
Cohesion: 0.06
Nodes (20): GetMessagesDto, MarkConversationReadDto, MessageDeliveredDto, MessagesService, msgs, PendingBucket, PushNotificationCoalescingService, NotifyOptions (+12 more)

### Community 7 - "Community 7"
Cohesion: 0.13
Nodes (27): AuthModule, AuthService, BlockedModule, BlockedUser, ChatModule, ChatValidationModule, Environment, EnvironmentVariables (+19 more)
...
Cohesion: 0.05
Nodes (48): build, AuthScreen, _AuthScreenState, build, Scaffold, Shadow, SizedBox, SafeArea (+40 more)
...
Cohesion: 0.06
Nodes (41): api_service.dart, AuthProvider, _cancelSessionRefreshTimer, _clearLocalAuthState, clearStatus, dispose, Exception, Function (+33 more)

### Community 12 - "Community 12"
Cohesion: 0.06
Nodes (43): badging_bridge_stub.dart, _onConversationsChanged, _scheduleFlush, UnreadBadgeSync, Function, Function, build, Center (+35 more)
...
Cohesion: 0.07
Nodes (41): getOtherUserId, getOtherUserUsername, clearActiveIfDeletedByOther, _clearActiveIfRemoved, clearAll, clearError, closeConversation, ConversationsProvider (+33 more)
...
Cohesion: 0.08
Nodes (23): FriendRequestStatus, ConversationMapper, conv, createMockConversation(), lastMsg, payload, FriendRequestMapper, payload (+15 more)

### Community 23 - "Community 23"
Cohesion: 0.12
Nodes (14): LocalStorageService, err, mockFs, UploadAvatarResult, UploadImageResult, UploadRawFileResult, UploadVoiceResult, MediaCleanupService (+6 more)
...
Cohesion: 0.1
Nodes (12): mockConfigService, mockUsersService, DeleteAccountDto, RegisterFcmTokenDto, RegisterWebPushSubscriptionDto, RemoveFcmTokenDto, RemoveWebPushSubscriptionDto, WebPushKeysDto (+4 more)
...
Cohesion: 0.08
Nodes (24): Center, initState, AnimatedBuilder, build, Center, dispose, initState, PingEffectOverlay (+16 more)
...
Cohesion: 0.08
Nodes (26): Chunk 2: Frontend — Extract EncryptionProvider (Phase 2), Chunk 3: Frontend — Extract FriendsProvider (Phase 3), code:dart (// frontend/lib/providers/encryption_provider.dart), code:bash (git add frontend/lib/providers/encryption_provider.dart), code:dart (// In main.dart, update MultiProvider:), code:dart (final chat = context.read<ChatProvider>();), code:bash (git add frontend/lib/main.dart frontend/lib/providers/chat_p), code:bash (git add frontend/lib/providers/encryption_provider.dart fron) (+18 more)

### Community 41 - "Community 41"
Cohesion: 0.09
Nodes (22): anti_quantum_note_dialog.dart, AntiQuantumNoteDialog, _AntiQuantumNoteDialogState, build, dispose, Expanded, Padding, SizedBox (+14 more)
...
Cohesion: 0.09
Nodes (24): code:bash (docker-compose down), code:bash (taskkill //F //IM node.exe), code:bash (docker-compose up --build), code:bash (curl http://localhost:3000), code:bash (docker-compose down), code:bash (docker-compose up), code:bash (cd frontend), code:bash (flutter run -d <device-id> --dart-define=BASE_URL=http://192) (+16 more)
...
Cohesion: 0.1
Nodes (19): Chat Screen Architecture - Source of Truth, Client → Server, code:typescript (@Entity('messages')), Colors (RpgTheme), Database Schema Changes, Deployment Checklist, Glossary, Integration Tests (Future) (+11 more)

### Community 52 - "Community 52"
Cohesion: 0.11
Nodes (20): 1. New Screen: ContactsScreen, 2. Modified: ConversationTile, 3. Modified: ChatDetailScreen, Frontend Components, 2. Recording UI - Voice Recording Overlay, 3. Message Bubble - Voice Playback UI, 4. Chat Input Bar Enhancement, 7. Socket Service Enhancement (+12 more)
...
Cohesion: 0.12
Nodes (19): Backend Tests, Frontend Tests, Testing Strategy, Conclusion, Functional Requirements, Future Enhancements, Integration Tests, Manual Testing Checklist (+11 more)

### Community 58 - "Community 58"
Cohesion: 0.12
Nodes (18): 6. API Service Enhancement, code:dart (Future<VoiceUploadResult> uploadVoiceMessage({), code:dart (class VoiceUploadResult {), Implementation Phases, Phase 2: Frontend Recording, Phase 3: Frontend Upload & Optimistic UI, Phase 6: Testing & Refinement, code:dart (import 'dart:io';) (+10 more)
...
Cohesion: 0.13
Nodes (20): Chunk 1: Backend — Thin Gateway + Extract Services (Phase 1), code:typescript (// backend/src/chat/services/chat-presence.service.ts), code:bash (git add backend/src/chat/services/chat-reaction.service.ts b), code:bash (git add backend/src/chat/services/chat-link-preview.service.), code:bash (git add -A backend/), code:typescript (// backend/src/chat/services/chat-presence.service.spec.ts), code:typescript (// Replace handleTyping (lines 193-211) with:), code:bash (git add backend/src/chat/services/chat-presence.service.ts b) (+12 more)
...
Cohesion: 0.13
Nodes (18): 2. Architecture Overview, code:mermaid (flowchart TB), Architecture Overview, Contacts Tab Design - Archive → Contacts Refactor, Key Changes, Notes, Overview, Two Independent Flows (+10 more)
...
Cohesion: 0.12
Nodes (16): 10. Frontend — ChatProvider, 1. Backend — Entity, 3. Backend — MessagesService, 4. Backend — MessageMapper, 6. Backend — ChatModule, 7. Frontend — pubspec.yaml, 9. Frontend — SocketService, code:typescript (@Column({ type: 'text', nullable: true, default: null })) (+8 more)
...
Cohesion: 0.14
Nodes (13): code:dart (final Map<String, Map<String, dynamic>> _pendingSendContent ), code:dart (_pendingSendContent[tempId] = <String, dynamic>{'content': c), code:dart (Future<void> _encryptAndSend({), code:dart (Map<String, String?>? linkPreview;), code:dart (final pending = _pendingSendContent[tempId];), code:dart (if (msg.content == '[encrypted]' && plaintextContent.isNotEm), code:dart (MessageType? _parseMessageTypeString(String? type) {), code:dart (final parsedType = _parseMessageTypeString(parsed.messageTyp) (+5 more)
...
Cohesion: 0.17
Nodes (12): code:dart (// frontend/test/services/api_service_media_test.dart), code:block23 (cd frontend && flutter test test/services/api_service_media_), code:dart (/// Upload already-encrypted media bytes to backend. Returns), code:block25 (cd frontend && flutter test test/services/api_service_media_), code:block26 (cd frontend && flutter analyze lib/services/api_service.dart), code:block27 (git add frontend/lib/services/api_service.dart \), code:block80 (cd frontend && flutter test && flutter analyze lib/), File Map (+4 more)
...
Cohesion: 0.18
Nodes (11): code:bash (git add frontend/lib/providers/chat_provider.dart), code:dart (if (_activeConversationId == conversationId && content.isNot), code:dart (if (_activeConversationId == conversationId && content.isNot), code:bash (cd frontend && flutter analyze 2>&1 | tail -5), code:bash (git add frontend/lib/providers/chat_provider.dart), Fix B: Retry preserves `replyToMessageId` (4.3), Step 1: Apply all three fixes above, Step 2: Analyze (+3 more)
...
Cohesion: 0.22
Nodes (8): Already fixed (skip these), code:dart (final who = otherName ?? 'Recipient';), code:dart (String _userFriendlySendError(Object e, int recipientId) {), Deferred (too large for this plan), Important Fixes Implementation Plan, Step 1: Find and replace all three Polish strings, Step 2: Analyze, Task 2: Fix Polish strings → English (2.5)
...
Cohesion: 0.25
Nodes (7): Chat Screen Redesign - End-to-End Test Plan, Test 6.1: Open Gallery, Test 6.2: Select and Upload Image, Test 6: Gallery Attachment (via ChatInputBar), Test 8.1: Complex Workflow, Test 8.2: Reconnection After Network Loss, Test 8: Integration - All Features Together
...
Cohesion: 0.33
Nodes (6): code:dart (// frontend/lib/utils/e2e_envelope.dart), code:block11 (cd frontend && flutter test test/utils/e2e_envelope_test.dar), code:block12 (git add frontend/lib/utils/e2e_envelope.dart \), code:dart (// frontend/test/utils/e2e_envelope_test.dart), code:block9 (cd frontend && flutter test test/utils/e2e_envelope_test.dar), Task 2: E2eEnvelope — mediaKey / mediaIv fields
...
## Knowledge Gaps
- **2302 isolated node(s):** `mockUsersService`, `mockConfigService`, `dto`, `mediaUrlError`, `_mediaOriginEscaped` (+2297 more)
...
- **Why does `Summary` connect `Community 13` to `Community 68`, `Community 74`, `Community 43`, `Community 204`, `Community 177`, `Community 86`, `Community 54`?**
  _High betweenness centrality (0.151) - this node is a cross-community bridge._
- **Why does `chat_detail_screen.dart` connect `Community 3` to `Community 32`, `Community 195`, `Community 4`, `Community 5`, `Community 37`, `Community 70`, `Community 9`, `Community 41`, `Community 12`, `Community 46`, `Community 15`, `Community 47`, `Community 18`, `Community 21`, `Community 24`?**
  _High betweenness centrality (0.143) - this node is a cross-community bridge._
- **Why does `Full Codebase Refactor — Domain-Driven Decomposition` connect `Community 13` to `Community 96`, `Community 16`, `Community 210`, `Community 200`?**
