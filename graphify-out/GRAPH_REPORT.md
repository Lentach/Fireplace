# Graph Report - Fireplace  (2026-05-11)

## Corpus Check
- 328 files · ~343,129 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4697 nodes · 7560 edges · 317 communities (303 shown, 14 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a699fc7e`
...
Cohesion: 0.06
Nodes (44): avatar_circle.dart, AppScrollBehavior, buildOverscrollIndicator, AvatarCircle, _AvatarCircleState, build, _buildImageUrl, Container (+36 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (44): anti_quantum_note_dialog.dart, build, SafeArea, AntiQuantumNoteDialog, _AntiQuantumNoteDialogState, build, dispose, Expanded (+36 more)

### Community 8 - "Community 8"
Cohesion: 0.08
Nodes (20): JwtAuthGuard, UploadMediaDto, LocalStorageService, err, mockFs, UploadAvatarResult, UploadImageResult, UploadRawFileResult (+12 more)
...
Cohesion: 0.08
Nodes (10): BlockedService, StartConversationDto, FriendsService, ChatConversationService, friend, mockFriendRequest, mockRecipient, mockSender (+2 more)
...
Cohesion: 0.07
Nodes (23): AcceptFriendRequestDto, ALLOWED_EMOJIS, MEDIA_URL_REGEX, _mediaOriginEscaped, RejectFriendRequestDto, SendFriendRequestDto, SendMessageDto, dto (+15 more)
...
Cohesion: 0.08
Nodes (18): AuthService, mockUser, mockConfigService, mockUsersService, JwtStrategy, User, mockDataSource, mockFcm (+10 more)
...
Cohesion: 0.11
Nodes (18): Conversation, ConversationsService, ConversationMapper, conv, createMockConversation(), lastMsg, payload, Message (+10 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (36): Backend, Chat Screen Redesign - End-to-End Test Plan, Frontend, Prerequisites, Test 10.1: Image Upload Validation - MIME Type, Test 10.2: Image Upload Validation - File Size, Test 10.3: CORS Headers, Test 10: Backend Validation (+28 more)
...
Cohesion: 0.09
Nodes (34): acceptFriendRequest, blockUser, clearSearchResults, consumeFriendRequestSent, FriendsProvider, Function, isFriend, loadBlockedList (+26 more)
...
Cohesion: 0.1
Nodes (32): build, _buildInfoCard, _buildLocalCacheCard, Center, Container, initState, PrivacySafetyScreen, _PrivacySafetyScreenState (+24 more)

### Community 27 - "Community 27"
Cohesion: 0.07
Nodes (24): ConversationModel, main, main, buildProviderWithSampleData, main, main, _msg, _FakeEncryptionProvider (+16 more)

### Community 28 - "Community 28"
Cohesion: 0.09
Nodes (11): DeleteAccountDto, RegisterFcmTokenDto, RegisterWebPushSubscriptionDto, RemoveFcmTokenDto, RemoveWebPushSubscriptionDto, WebPushKeysDto, startsWith(), validateAvatarMagicBytes() (+3 more)

### Community 29 - "Community 29"
Cohesion: 0.09
Nodes (24): api_service.dart, ApiService, _effectiveMediaUrl, Exception, jsonDecode, dispose, _fetch, GifModel (+16 more)
...
Cohesion: 0.07
Nodes (26): applyPhonePortraitOrientations, AuthGate, _AuthGateState, AuthScreen, didChangeMetrics, dispose, FireplaceApp, initState (+18 more)
...
Cohesion: 0.08
Nodes (24): Implementation Phases, Phase 2: Frontend Recording, Phase 3: Frontend Upload & Optimistic UI, Phase 5: Error Handling & Polish, Phase 6: Testing & Refinement, code:bash (git add frontend/lib/widgets/voice_recording_overlay.dart), code:dart (void sendMessage({), code:bash (git add frontend/lib/services/socket_service.dart frontend/l) (+16 more)

### Community 36 - "Community 36"
Cohesion: 0.08
Nodes (27): code:bash (cd frontend), code:dart (import 'package:flutter/material.dart';), code:bash (git add frontend/lib/widgets/chat_input_bar.dart), code:dart (import 'package:flutter/material.dart';), code:dart (import 'chat_action_tiles.dart';), code:dart (class ChatProvider extends ChangeNotifier {), code:bash (git add frontend/lib/widgets/chat_action_tiles.dart), code:bash (git add frontend/lib/screens/chat_detail_screen.dart) (+19 more)
...
Cohesion: 0.08
Nodes (26): code:bash (cd frontend), code:bash (git add frontend/lib/models/message_model.dart), Phase 2: Frontend - Message Model & Provider Updates, Task 2.1: Extend MessageModel with New Fields, code:bash (cd frontend), code:bash (flutter run --dart-define=BASE_URL=http://192.168.1.100:3000), Step 6: Run Flutter on device, code:bash (cd frontend) (+18 more)
...
Cohesion: 0.09
Nodes (25): code:bash (git add backend/src/messages/entities/message.entity.ts), code:typescript (import { Entity, PrimaryGeneratedColumn, Column, ManyToOne, ), code:typescript (async handleSendMessage(), code:bash (# Backend will auto-sync with TypeORM synchronize:true), code:javascript (// Send message with expiration), Task 1.1: Add Message Delivery Status & Expiration, code:typescript (: rt.messageType === 'IMAGE' || rt.messageType === 'DRAWING'), code:typescript (: rt.messageType === 'IMAGE') (+17 more)
...
Cohesion: 0.12
Nodes (22): build, buildRecordingBar, _checkMicPermission, dispose, Exception, _formatRecordingDuration, Function, _getCancelThreshold (+14 more)
...
Cohesion: 0.1
Nodes (23): code:yaml (dependencies:), 1. New Screen: ContactsScreen, 2. Modified: ConversationTile, 3. Modified: ChatDetailScreen, 5. ChatProvider - New Methods, code:dart (void deleteConversationOnly(int conversationId) {), code:dart (onConversationDeleted: (data) {), Frontend Components (+15 more)
...
Cohesion: 0.09
Nodes (21): code:dart (IconButton(), code:dart (@override), code:dart (@override), code:dart (context.read<ChatProvider>().deleteConversation(conversation), code:dart (context.read<ChatProvider>().deleteConversationOnly(conversa), code:dart ('This will delete all messages. This action cannot be undone), code:dart ('This will delete all messages. Your contact will remain in ), code:bash (git add frontend/lib/widgets/conversation_tile.dart frontend) (+13 more)

### Community 53 - "Community 53"
Cohesion: 0.09
Nodes (22): Chunk 2: Frontend — Model + Config + API Service, Chunk 5: Integration + CLAUDE.md, code:dart (static String get giphyApiKey {), code:bash (git add frontend/lib/config/app_config.dart), code:dart (Future<Map<String, dynamic>> uploadMedia({), code:dart (} else if (type == 'gif' && gifBytes != null) {), File Structure, GIF Support Implementation Plan (+14 more)
...
Cohesion: 0.15
Nodes (9): FriendRequestStatus, FriendRequestMapper, payload, request, payload, user, UserMapper, notificationOptions (+1 more)
...
Cohesion: 0.12
Nodes (17): code:dart (Widget _buildDeliveryIcon() {), code:dart (String? _getTimerText() {), code:dart (@override), code:bash (git add frontend/lib/widgets/chat_message_bubble.dart), Task 3.1: Update ChatMessageBubble with Delivery Indicator & Timer, Chunk 4: Frontend — ChatProvider + Wire-up + Bubble, code:dart (/// Send a GIF message. Downloads from Giphy, uploads to Clo), code:dart (onTap: () => _showComingSoon(context, l10n.actionTileGif),) (+9 more)
...
Cohesion: 0.13
Nodes (16): code:bash (git add frontend/lib/services/socket_service.dart), Step 3.4: Commit socket service changes, code:bash (git add frontend/lib/providers/chat_provider.dart), Task 4: Clean debug prints from `chat_provider.dart` (Frontend), Chunk 3: Frontend — Remove ping socket events, update ApiService, code:bash (git add frontend/lib/services/socket_service.dart frontend/l), code:dart (/// Upload media (image or voice) to backend. Returns {media), code:bash (git add frontend/lib/services/api_service.dart) (+8 more)
...
Cohesion: 0.15
Nodes (13): code:bash (docker images | findstr "mvp-chat-app"), code:bash (docker system prune -a), code:bash (docker-compose up --build), code:bash (docker images | findstr "mvp-chat-app"), code:bash (docker-compose down), Task 10: Cleanup Old Docker Images, code:yaml (# docker-compose.yml — replace Cloudinary env vars with MEDI), code:nginx (server {) (+5 more)
...
Cohesion: 0.21
Nodes (4): OneTimePreKeyDto, UploadOneTimePreKeysDto, KeyBundlesService, OneTimePreKeyData
...
Cohesion: 0.17
Nodes (12): code:markdown (| **deleteConversationOnly** | ChatConversationService.handl), code:markdown (- **conversationDeleted:** `{ conversationId: number }`), code:markdown (### 7.X Delete Conversation vs Unfriend), code:markdown (**2026-02-14:**), Step 10.1: Update §5 WebSocket Event Map, Step 10.2: Update §7 Frontend Mechanisms, Step 10.3: Update §9 File Map, Step 10.4: Update §13 Recent Changes (+4 more)
...
Cohesion: 0.18
Nodes (11): code:bash (git add CLAUDE.md), Step 10.5: Commit documentation, code:markdown (- **Message Types:** TEXT, PING, IMAGE, DRAWING, VOICE), code:markdown (---), code:markdown (**2026-02-15:**), code:bash (git add CLAUDE.md), Task 6.1: Update CLAUDE.md with voice messages, code:bash (git add CLAUDE.md) (+3 more)
...
Cohesion: 0.18
Nodes (10): 4. Directory Structure After Refactor, 5. Summary, 7. CLAUDE.md Gotchas Preservation Checklist, Backend `src/chat/`, code:block11 (providers/), code:block12 (chat/), Error Handling, Frontend `lib/` (+2 more)
...
Cohesion: 0.33
Nodes (5): build, Function, ReactionChipsRow, Semantics, Wrap
...
Cohesion: 0.4
Nodes (3): AppConstants, main, package:fireplace/constants/app_constants.dart
...
Cohesion: 0.4
Nodes (4): code:typescript (const conversation = await this.conversationsService.findByI), Step 1: Add membership check in `handleMarkConversationRead`, Step 2: Replace N-saves loop with batch UPDATE in `messages.service.ts`, Task 3: Membership check + batch READ update (3.2, 3.5)
...
- **Why does `Summary` connect `Community 32` to `Community 192`, `Community 97`, `Community 130`, `Community 81`, `Community 179`, `Community 180`, `Community 116`, `Community 22`?**
  _High betweenness centrality (0.161) - this node is a cross-community bridge._
- **Why does `Full Codebase Refactor — Domain-Driven Decomposition` connect `Community 179` to `Community 32`, `Community 101`, `Community 13`, `Community 241`, `Community 214`, `Community 223`?**
  _High betweenness centrality (0.148) - this node is a cross-community bridge._
- **Why does `chat_detail_screen.dart` connect `Community 10` to `Community 2`, `Community 3`, `Community 6`, `Community 7`, `Community 38`, `Community 14`, `Community 47`, `Community 16`, `Community 143`, `Community 18`, `Community 19`, `Community 50`, `Community 207`, `Community 26`, `Community 60`?**
