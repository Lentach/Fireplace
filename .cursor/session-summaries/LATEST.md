...
- Tests: A **925+4** green, B **911+4** green, fail-before proven by stashing lib per bug. **⚠ Both PRs edit the CLAUDE.md §3 count — after BOTH merge set it to 933 and rerun the verifier.**
