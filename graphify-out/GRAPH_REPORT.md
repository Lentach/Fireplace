...
## Corpus Check
- 328 files · ~343,164 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4697 nodes · 7560 edges · 315 communities (300 shown, 15 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5e4e3ba3`
...
## Communities (315 total, 15 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (36): buildCorsOrigin(), ChatGateway, AcceptFriendRequestDto, AddReactionDto, ALLOWED_EMOJIS, BlockUserDto, GetMessagesDto, MEDIA_URL_REGEX (+28 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (85): add_or_invitations_screen.dart, blocked_users_screen.dart, MainShell, _AddByUsernameTab, _AddByUsernameTabState, AddOrInvitationsScreen, build, Card (+77 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (79): avatar_circle.dart, build, SizedBox, AvatarCircle, _AvatarCircleState, build, _buildImageUrl, Container (+71 more)
...
Cohesion: 0.05
Nodes (69): _addMessageToState, addReaction, _cancelDelayedRetry, _cancelDelayedRetryIfAny, clearAll, clearChatHistory, clearMessages, clearPingEffect (+61 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (14): BlockedService, ConversationsService, RejectFriendRequestDto, FriendsService, MediaCleanupService, MessageCleanupService, expired, ChatConversationService (+6 more)

### Community 6 - "Community 6"
Cohesion: 0.11
Nodes (33): AuthModule, BlockedModule, BlockedUser, ChatModule, ChatValidationModule, Environment, EnvironmentVariables, validate() (+25 more)

### Community 7 - "Community 7"
Cohesion: 0.08
Nodes (25): AuthService, Conversation, MarkConversationReadDto, MessageDeliveredDto, ConversationMapper, conv, createMockConversation(), lastMsg (+17 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (53): build, _buildHeaderTitle, _buildScrollToBottomButton, ChatDetailScreen, _ChatDetailScreenState, ChatInputBar, _clearActiveConversationIfThisChat, Column (+45 more)
...
Cohesion: 0.06
Nodes (49): ../audio/playback_controller.dart, ../audio/waveform_display.dart, Icon, _formatTime, Row, Semantics, build, _buildContentColumn (+41 more)
...
Cohesion: 0.05
Nodes (38): Center, initState, build, Directory, dispose, Exception, Function, initState (+30 more)

### Community 17 - "Community 17"
Cohesion: 0.06
Nodes (35): anti_quantum_note_dialog.dart, Padding, AppScrollBehavior, buildOverscrollIndicator, AntiQuantumNoteDialog, _AntiQuantumNoteDialogState, build, dispose (+27 more)

### Community 18 - "Community 18"
Cohesion: 0.08
Nodes (16): PendingBucket, PushNotificationCoalescingService, NotifyOptions, PushNotificationsService, conv, data, mockConversation, mockMessage (+8 more)

### Community 19 - "Community 19"
Cohesion: 0.07
Nodes (34): build, ChatInputBar, _ChatInputBarState, Column, dispose, _formatTimer, initState, _onRecordingStateChanged (+26 more)
...
Cohesion: 0.07
Nodes (30): code:yaml (dependencies:), code:bash (cd frontend), code:dart (import 'package:flutter/material.dart';), code:bash (git add frontend/lib/widgets/chat_input_bar.dart), code:dart (import 'package:flutter/material.dart';), code:dart (import 'chat_action_tiles.dart';), code:dart (class ChatProvider extends ChangeNotifier {), code:bash (git add frontend/lib/widgets/chat_action_tiles.dart) (+22 more)
...
Cohesion: 0.07
Nodes (29): Backend, Chat Screen Redesign - End-to-End Test Plan, Frontend, Prerequisites, Test 1.1: Sending Message Shows Clock Icon, Test 1.2: Receiving Message Shows Double Checkmark, Test 1.3: Old Messages Have Delivered Status, Test 1: Message Delivery Indicators (+21 more)

### Community 27 - "Community 27"
Cohesion: 0.07
Nodes (30): code:bash (git add frontend/lib/providers/chat_provider.dart), Step 4.5: Commit ChatProvider changes, code:bash (git add frontend/lib/providers/chat_provider.dart), code:dart (import 'package:flutter_test/flutter_test.dart';), code:dart (test('chatHistoryCleared removes cache entry', () {), code:bash (cd frontend && flutter test test/providers/messaging_provide), code:dart (// Keep cache current for active conversation.), code:dart (// Update cache with decrypted content (encrypted placeholde) (+22 more)

### Community 28 - "Community 28"
Cohesion: 0.07
Nodes (27): applyPhonePortraitOrientations, AuthGate, _AuthGateState, AuthScreen, didChangeMetrics, dispose, FireplaceApp, initState (+19 more)

### Community 29 - "Community 29"
Cohesion: 0.07
Nodes (26): code:dart (final Map<String, Map<String, dynamic>> _pendingSendContent ), code:dart (_pendingSendContent[tempId] = <String, dynamic>{'content': c), code:dart (Future<void> _encryptAndSend({), code:dart (Map<String, String?>? linkPreview;), code:dart (final pending = _pendingSendContent[tempId];), code:dart (if (msg.content == '[encrypted]' && plaintextContent.isNotEm), code:dart (MessageType? _parseMessageTypeString(String? type) {), code:dart (final parsedType = _parseMessageTypeString(parsed.messageTyp) (+18 more)

### Community 30 - "Community 30"
Cohesion: 0.08
Nodes (28): 1. New Screen: ContactsScreen, 2. Modified: ConversationTile, 3. Modified: ChatDetailScreen, 5. ChatProvider - New Methods, code:dart (void deleteConversationOnly(int conversationId) {), code:dart (onConversationDeleted: (data) {), Frontend Components, code:dart (void deleteConversationOnly(int conversationId) {) (+20 more)
...
Cohesion: 0.09
Nodes (21): AuthForm, _AuthFormState, build, dispose, Form, build, DeleteAccountDialog, _DeleteAccountDialogState (+13 more)
...
Cohesion: 0.1
Nodes (15): AppConstants, E2eEnvelope, main, main, expectLater, main, MediaCryptoService, main (+7 more)

### Community 49 - "Community 49"
Cohesion: 0.1
Nodes (16): main, main, buildProviderWithSampleData, main, main, _msg, _FakeEncryptionProvider, main (+8 more)

### Community 50 - "Community 50"
Cohesion: 0.1
Nodes (20): Executive Summary, 2. Files to Modify, 5. Verification Checklist, 7. Production Next Steps, Document Change Log, Executive Summary, Key Concepts, Mobile Deployment — Flutter on Physical Device (+12 more)
...
Cohesion: 0.1
Nodes (22): code:dart (import 'dart:io';), code:dart (import 'package:image_picker/image_picker.dart';), code:dart (import 'package:image_picker/image_picker.dart';), code:dart (import 'dart:typed_data';), code:yaml (dependencies:), code:dart (// In build() method, update content section:), code:bash (git add frontend/lib/services/api_service.dart), Task 5.2: Frontend - Camera & Drawing Upload (+14 more)
...
Cohesion: 0.1
Nodes (20): code:bash (rm frontend/lib/screens/archive_placeholder_screen.dart), code:typescript (import {), code:typescript (import { UserMapper } from '../mappers/user.mapper';), code:typescript (static toPayloadArray(conversations: Conversation[]) {), code:typescript (static toPayloadArray(users: User[]) {), code:typescript (static toPayloadArray(requests: FriendRequest[]) {), code:bash (git add backend/src/chat/dto/chat.dto.ts backend/src/chat/ma), code:bash (git add -u frontend/lib/screens/) (+12 more)

### Community 58 - "Community 58"
Cohesion: 0.1
Nodes (19): code:dart (Widget _buildDeliveryIcon() {), code:dart (String? _getTimerText() {), code:dart (@override), code:bash (git add frontend/lib/widgets/chat_message_bubble.dart), Task 3.1: Update ChatMessageBubble with Delivery Indicator & Timer, code:dart (@override), code:dart (@override), Step 5.2: Wrap tile content in Dismissible (+11 more)
...
Cohesion: 0.11
Nodes (19): code:bash (git add backend/src/messages/entities/message.entity.ts), code:typescript (import { Entity, PrimaryGeneratedColumn, Column, ManyToOne, ), code:typescript (async handleSendMessage(), code:typescript (export class SendMessageDto {), code:bash (# Backend will auto-sync with TypeORM synchronize:true), code:javascript (// Send message with expiration), Task 1.1: Add Message Delivery Status & Expiration, code:typescript (export class SendMessageDto {) (+11 more)
...
Cohesion: 0.12
Nodes (16): Chat Screen Redesign - Telegram/Wire Inspired UI, code:typescript (async createImageMessage(data: {), code:typescript (import { MessagesController } from './messages.controller';), code:bash (curl -X POST http://localhost:3000/messages/image \), code:bash (git add backend/src/messages/messages.controller.ts), code:bash (# Start backend), code:markdown (# Chat Redesign Manual Test Results), code:bash (git add docs/testing/2026-02-04-chat-redesign-manual-tests.m) (+8 more)
...
Cohesion: 0.12
Nodes (16): code:bash (docker images | findstr "mvp-chat-app"), code:bash (docker system prune -a), code:bash (docker-compose up --build), code:bash (docker images | findstr "mvp-chat-app"), code:bash (docker-compose down), Task 10: Cleanup Old Docker Images, code:bash (rm backend/src/cloudinary/cloudinary.service.ts), code:bash (cd backend && npm test) (+8 more)
...
Cohesion: 0.12
Nodes (15): Chunk 3: Frontend — Extract FriendsProvider (Phase 3), Chunk 6: Final Cleanup + CLAUDE.md Update (Phase 6), code:bash (git add frontend/lib/main.dart frontend/lib/providers/chat_p), code:bash (git add frontend/lib/providers/friends_provider.dart), code:bash (git add frontend/lib/main.dart frontend/lib/providers/chat_p), code:bash (git add CLAUDE.md), Full Codebase Refactor Implementation Plan, Phase 1 Exit Criteria Check (+7 more)

### Community 97 - "Community 97"
Cohesion: 0.12
Nodes (15): code:dart (// In main.dart, update MultiProvider:), code:dart (final chat = context.read<ChatProvider>();), Task 2.2: Wire EncryptionProvider into provider tree + ChatProvider facade, 1. Kontekst z CLAUDE.md, 3.1 Brak przekazywania expiresIn przy wysyłce (ChatInputBar), 3.2 Obrazki w bąbelku bez ograniczenia szerokości, 3.3 EmojiPicker — minimalna konfiguracja, 3.4 Plan vs kod — tempId przy optymistic message (+7 more)

### Community 98 - "Community 98"
Cohesion: 0.13
Nodes (15): code:bash (cd backend && npm test -- --testPathPattern=messages.service), code:ts (const PRIVATE_IP_RE =), code:ts (const PRIVATE_IP_RE =), code:bash (git add backend/src/chat/services/link-preview.service.ts), code:ts (import { ExecutionContext } from '@nestjs/common';), code:bash (cd backend && npm test -- --testPathPattern="ws-throttler.gu), code:bash (git add backend/src/chat/guards/ws-throttler.guard.spec.ts), code:ts (import { LinkPreviewService } from './link-preview.service';) (+7 more)
...
Cohesion: 0.14
Nodes (14): code:bash (cd backend), code:bash (cd frontend), code:bash (git add .), code:bash (git log --oneline -10  # Review commits), Step 11.1: Check git status, Step 11.2: Verify all success criteria, Step 11.3: Run full test suite, Step 11.4: Create final summary commit (if needed) (+6 more)
...
Cohesion: 0.15
Nodes (14): code:bash (cd backend && npx jest media.controller.spec.ts --no-coverag), code:bash (git add backend/src/media/media.controller.ts backend/src/me), code:typescript (// In the SendMessageDto describe block, add these cases:), code:typescript (// OLD:), code:typescript (@Matches(MEDIA_URL_REGEX, {), code:typescript (// backend/src/media/media.module.ts), code:bash (cd backend && npm test), code:bash (git add backend/src/media/media.module.ts backend/src/chat/d) (+6 more)

### Community 123 - "Community 123"
Cohesion: 0.15
Nodes (14): code:bash (git status), code:bash (git add -A), code:bash (git log --oneline -8), code:bash (git push origin master), Task 12: Final Commit and Summary, code:bash (cd frontend && flutter analyze), code:bash (cd backend && npm run build), code:bash (git status) (+6 more)
...
Cohesion: 0.15
Nodes (10): Function, handleFcmRemoteMessageOpen, setAndroidNotificationConversationTapHandler, AndroidNotificationChannel, Function, handleFcmRemoteMessageOpen, setAndroidNotificationConversationTapHandler, showFireplaceMessageNotificationWithPlugin (+2 more)
...
Cohesion: 0.15
Nodes (13): code:typescript (describe('handleMessageDelivered', () => {), code:bash (cd backend && npm test -- --testPathPattern=chat-message.ser), code:typescript (async handleMessageDelivered(), code:bash (cd backend && npm test -- --testPathPattern=chat-message.ser), code:bash (cd backend && git add src/chat/services/chat-message.service), Task 1: `messageDelivered` — ownership check, code:ts (@Column({ type: 'timestamp', nullable: true })), code:ts (user.passwordChangedAt = new Date();) (+5 more)

### Community 143 - "Community 143"
Cohesion: 0.15
Nodes (13): ═══════════════════════════════════════, code:typescript (// backend/src/media/local-storage.service.spec.ts), code:typescript (// backend/src/media/media-cleanup.service.spec.ts), code:bash (cd backend && npx jest media-cleanup.service.spec.ts --no-co), code:typescript (// backend/src/media/media-cleanup.service.ts), code:bash (cd backend && npx jest media-cleanup.service.spec.ts --no-co), code:bash (git add backend/src/media/media-cleanup.service.ts backend/s), code:bash (cd backend && npx jest local-storage.service.spec.ts --no-co) (+5 more)
...
Cohesion: 0.17
Nodes (12): code:bash (docker-compose up), code:bash (cd frontend), code:bash (flutter run -d <device-id> --dart-define=BASE_URL=http://192), code:bash (docker-compose down), Task 8: Test Flutter Native Run (if device available), code:yaml (# docker-compose.yml — replace Cloudinary env vars with MEDI), code:nginx (server {), code:bash (docker-compose down && docker-compose up) (+4 more)
...
Cohesion: 0.17
Nodes (11): code:typescript (/** True if either user has blocked the other. Single query ), code:bash (cd backend && npm test --no-coverage 2>&1 | tail -15), code:bash (cd backend && git add src/blocked/blocked.service.ts), code:typescript (it('does not serve the same OTP twice under concurrent calls), code:bash (cd backend && npm test -- --testPathPattern=key-bundles --no), code:bash (cd backend && npm test --no-coverage 2>&1 | tail -10), code:bash (cd backend && git add src/key-bundles/key-bundles.service.ts), Task 3: `isBlockedByEither` — combine into single query (+3 more)
...
Cohesion: 0.18
Nodes (10): 3. New REST Endpoint, code:typescript (@Post('voice')), code:typescript (@Post('voice')), code:typescript (import { CloudinaryModule } from '../cloudinary/cloudinary.m), code:bash (# First login to get JWT), code:bash (git add backend/src/messages/messages.controller.ts backend/), code:typescript (import {), Task 1.4: Create POST /messages/voice endpoint (+2 more)
...
Cohesion: 0.2
Nodes (11): Chunk 1: Backend — Entity, Module, Service, code:typescript (// backend/src/secret-notes/secret-note.entity.ts), code:typescript (// backend/src/secret-notes/secret-notes.module.ts), code:typescript (// 1. Add import at top of app.module.ts:), code:yaml (backend:), code:bash (docker-compose restart backend), code:bash (# Should return landing page HTML), code:bash (git add backend/src/secret-notes/secret-notes.module.ts back) (+3 more)
...
Cohesion: 0.2
Nodes (10): ChatActionTiles (`widgets/chat_action_tiles.dart`), ChatMessageBubble (`widgets/chat_message_bubble.dart`), ChatProvider (`providers/chat_provider.dart`), E2eEnvelope parsing, Frontend Changes, L10n (`l10n/app_pl.arb`, `l10n/app_en.arb`), MessageModel (`models/message_model.dart`), New: `GifPickerSheet` widget (`widgets/gif_picker_sheet.dart`) (+2 more)
...
Cohesion: 0.22
Nodes (7): ArgumentError, EncryptedMedia, MediaCryptoService, expectLater, main, package:fireplace/providers/encryption_provider.dart, package:webcrypto/webcrypto.dart
...
Cohesion: 0.25
Nodes (8): code:bash (cd frontend && flutter test test/providers/messaging_provide), code:dart (// Snapshot to cache immediately (may include encrypted plac), code:dart (final myConversationId = responseConversationId ?? _effectiv), code:bash (cd frontend && flutter test test/providers/messaging_provide), code:bash (cd frontend && flutter test), code:bash (git add frontend/lib/providers/messaging_provider.dart front), code:dart (test('onMessageHistory populates cache for active conversati), Task 2: Populate cache in onMessageHistory
...
Cohesion: 0.25
Nodes (7): Chunk 4: Frontend — Encrypt all message types, code:dart (// After successful upload:), code:bash (git add frontend/lib/providers/chat_provider.dart), code:dart (if (message.messageType == MessageType.ping) {), code:bash (git add frontend/lib/providers/chat_provider.dart frontend/l), Task 11: Encrypt voice messages, Task 12: Encrypt image messages
...
Cohesion: 0.29
Nodes (7): Chunk 5: Frontend — Widget Decomposition (Phase 5), code:dart (class MessageMetadataRow extends StatelessWidget {), code:dart (class MessageContentFactory {), code:bash (git add frontend/lib/widgets/message/ frontend/lib/screens/c), code:bash (git add frontend/lib/widgets/audio/ frontend/lib/widgets/mes), Task 5.1: Decompose `chat_message_bubble.dart` into composition pattern, Task 5.3: Decompose `voice_message_bubble.dart`
...
Cohesion: 0.33
Nodes (6): code:dart (// frontend/test/widgets/anti_quantum_note_dialog_test.dart), code:bash (cd frontend && flutter test test/widgets/anti_quantum_note_d), code:dart (// frontend/lib/widgets/anti_quantum_note_dialog.dart), code:bash (cd frontend && flutter test test/widgets/anti_quantum_note_d), code:bash (git add frontend/lib/widgets/anti_quantum_note_dialog.dart f), Task 6: AntiQuantumNoteDialog widget
...
Cohesion: 0.4
Nodes (5): Chunk 3: Frontend — Crypto utility + Dialog widget, code:yaml (encrypt: ^5.0.3), code:bash (cd frontend && flutter pub get 2>&1 | tail -5), code:bash (git add frontend/pubspec.yaml frontend/pubspec.lock), Task 5: Add encrypt package

### Community 275 - "Community 275"
Cohesion: 0.4
Nodes (5): code:dart (test('build includes messageType when provided', () {), code:dart (class E2eEnvelope {), code:bash (git add frontend/lib/utils/e2e_envelope.dart frontend/test/u), Task 3: Extend E2E Envelope with messageType, mediaUrl, mediaDuration, code:bash (git add frontend/lib/utils/e2e_envelope.dart frontend/lib/se)
...
Cohesion: 0.4
Nodes (5): code:ts (FileInterceptor('file', { limits: { fileSize: 11 * 1024 * 10), code:ts (FileInterceptor('file', { limits: { fileSize: 21 * 1024 * 10), code:bash (cd backend && npm test -- --testPathPattern="media.controlle), code:bash (git add backend/src/media/media.controller.ts), Task 6 — Fix upload size mismatch: raise server limit to 21 MB
...
Cohesion: 0.5
Nodes (3): Anti-Quantum Note — Implementation Plan, Chunk 2: Backend — Controller, Module, App wiring, Chunk 4: Frontend — Crypto + sendNote + tile wiring
...
## Knowledge Gaps
- **2319 isolated node(s):** `mockUsersService`, `mockConfigService`, `dto`, `mediaUrlError`, `_mediaOriginEscaped` (+2314 more)
...
- **Why does `Summary` connect `Community 119` to `Community 32`, `Community 106`, `Community 173`, `Community 79`, `Community 118`, `Community 87`, `Community 184`, `Community 26`?**
  _High betweenness centrality (0.161) - this node is a cross-community bridge._
- **Why does `Full Codebase Refactor — Domain-Driven Decomposition` connect `Community 119` to `Community 96`, `Community 105`, `Community 235`, `Community 206`, `Community 23`?**
  _High betweenness centrality (0.148) - this node is a cross-community bridge._
- **Why does `chat_detail_screen.dart` connect `Community 8` to `Community 1`, `Community 2`, `Community 199`, `Community 41`, `Community 10`, `Community 43`, `Community 13`, `Community 141`, `Community 16`, `Community 17`, `Community 19`, `Community 22`, `Community 28`?**
