...
## Corpus Check
- 326 files · ~341,810 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4672 nodes · 7532 edges · 318 communities (304 shown, 14 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3b6c02d8`
...
Cohesion: 0.04
Nodes (54): AppConstants, ConversationModel, E2eEnvelope, main, main, main, main, buildProviderWithSampleData (+46 more)
...
Cohesion: 0.05
Nodes (61): blocked_users_screen.dart, BlockedUsersScreen, _BlockedUserTile, build, Padding, Scaffold, SizedBox, build (+53 more)
...
Cohesion: 0.05
Nodes (43): AppScrollBehavior, buildOverscrollIndicator, AuthForm, _AuthFormState, build, Form, build, Dialog (+35 more)
...
Cohesion: 0.06
Nodes (45): AuthGate, _AuthGateState, AuthScreen, FireplaceApp, main, MainShell, MaterialApp, MultiProvider (+37 more)
...
Cohesion: 0.06
Nodes (44): add_or_invitations_screen.dart, _AddByUsernameTab, _AddByUsernameTabState, AddOrInvitationsScreen, build, Card, Center, DefaultTabController (+36 more)
...
Cohesion: 0.09
Nodes (22): MarkConversationReadDto, MessageDeliveredDto, ConversationMapper, conv, createMockConversation(), lastMsg, payload, MediaCleanupService (+14 more)

### Community 16 - "Community 16"
Cohesion: 0.06
Nodes (38): api_service.dart, AuthProvider, _cancelSessionRefreshTimer, _clearLocalAuthState, clearStatus, dispose, Exception, Function (+30 more)

### Community 17 - "Community 17"
Cohesion: 0.06
Nodes (38): badging_bridge_stub.dart, SafeArea, _onConversationsChanged, _scheduleFlush, UnreadBadgeSync, build, ChatInputBar, _ChatInputBarState (+30 more)
...
Cohesion: 0.07
Nodes (32): code:yaml (dependencies:), code:bash (cd frontend), code:dart (import 'package:flutter/material.dart';), code:bash (git add frontend/lib/widgets/chat_input_bar.dart), code:dart (import 'package:flutter/material.dart';), code:dart (import 'chat_action_tiles.dart';), code:dart (class ChatProvider extends ChangeNotifier {), code:bash (git add frontend/lib/widgets/chat_action_tiles.dart) (+24 more)
...
Cohesion: 0.12
Nodes (13): PendingBucket, PushNotificationCoalescingService, NotifyOptions, PushNotificationsService, conv, data, mockMessage, mockRecipient (+5 more)
...
Cohesion: 0.09
Nodes (24): 3. Run on device, code:block25, code:block26, code:bash (git add README.md), code:bash (docker-compose down), code:bash (taskkill //F //IM node.exe), code:bash (docker-compose up --build), code:bash (curl http://localhost:3000) (+16 more)
...
Cohesion: 0.12
Nodes (20): anti_quantum_note_dialog.dart, AntiQuantumNoteDialog, _AntiQuantumNoteDialogState, build, dispose, Expanded, Padding, SizedBox (+12 more)
...
Cohesion: 0.11
Nodes (17): Chat Screen Redesign - End-to-End Test Plan, Test 2.1: Set Conversation Timer, Test 2.2: Message Shows Timer Countdown, Test 2.3: Timer Persists Per Conversation, Test 2.4: Timer Turns Off, Test 2.5: Backend Cron Job Deletes Expired Messages, Test 2: Disappearing Messages, Test 6.1: Open Gallery (+9 more)
...
Cohesion: 0.15
Nodes (15): 1. New Screen: ContactsScreen, 2. Modified: ConversationTile, 3. Modified: ChatDetailScreen, Frontend Components, 2. Recording UI - Voice Recording Overlay, 3. Message Bubble - Voice Playback UI, 4. Chat Input Bar Enhancement, 7. Socket Service Enhancement (+7 more)
...
Cohesion: 0.22
Nodes (7): JwtAuthGuard, UploadMediaDto, MediaController, fakeFile(), fakeReq, fakeRes, mockStorage
...
Cohesion: 0.16
Nodes (14): 1. Critical Rules & Gotchas, E2E Encryption, Frontend, TypeORM, Backend, Documentation, Frontend, Implementation Checklist (+6 more)
...
Cohesion: 0.18
Nodes (13): code:dart (final persisted = await _encryptionProvider!.encryptionServi), code:dart (final persisted = await _encryptionProvider!.getDecryptedCon), code:dart (final persisted = await _encryptionProvider!.encryptionServi), code:dart (final persisted = await _encryptionProvider!.getDecryptedCon), code:dart (await _encryptionProvider?.encryptionService), code:dart (await _encryptionProvider?.saveDecryptedContent(decrypted.id), Step 2.1: Replace call site 1 — save after received message decrypt, Step 2.3: Replace call site 3 — get in history decrypt (received messages) (+5 more)
...
Cohesion: 0.2
Nodes (10): Chunk 6: Final Cleanup + CLAUDE.md Update (Phase 6), code:bash (git add CLAUDE.md), Task 6.1: Line count verification, Task 6.2: Run all tests, Task 6.3: Update CLAUDE.md, Task 6.4: Final comprehensive smoke test, code:bash (git add CLAUDE.md), code:block65 (- `messages` table has composite index `idx_messages_conv_cr) (+2 more)

### Community 184 - "Community 184"
Cohesion: 0.2
Nodes (10): code:markdown (**2026-02-14:**), Step 10.4: Update §13 Recent Changes, code:markdown (**2026-02-14:**), code:bash (git add CLAUDE.md), Task 10: Manual Testing & Documentation, code:markdown (- **Message Types:** TEXT, PING, IMAGE, DRAWING, VOICE), code:markdown (---), code:markdown (**2026-02-15:**) (+2 more)
...
- **Why does `Summary` connect `Community 211` to `Community 66`, `Community 98`, `Community 231`, `Community 174`, `Community 177`, `Community 148`, `Community 53`, `Community 186`, `Community 29`?**
  _High betweenness centrality (0.149) - this node is a cross-community bridge._
- **Why does `chat_detail_screen.dart` connect `Community 4` to `Community 34`, `Community 3`, `Community 6`, `Community 7`, `Community 40`, `Community 9`, `Community 42`, `Community 43`, `Community 12`, `Community 11`, `Community 143`, `Community 17`, `Community 50`, `Community 212`, `Community 23`?**
  _High betweenness centrality (0.145) - this node is a cross-community bridge._
- **Why does `Full Codebase Refactor — Domain-Driven Decomposition` connect `Community 211` to `Community 71`, `Community 105`, `Community 13`, `Community 279`, `Community 249`, `Community 219`?**
