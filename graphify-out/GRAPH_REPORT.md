...
## Corpus Check
- 328 files · ~344,064 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4706 nodes · 7572 edges · 302 communities (288 shown, 14 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1a38f06f`
...
Cohesion: 0.04
Nodes (51): AppConstants, main, aesGcmDecrypt, aesGcmEncrypt, main, secureRandomBytes, main, main (+43 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (62): build, Directory, dispose, Exception, Function, initState, _isExpired, _loadAndPlayAudio (+54 more)

### Community 5 - "Community 5"
Cohesion: 0.11
Nodes (32): BlockedModule, BlockedUser, ChatModule, ChatValidationModule, Environment, EnvironmentVariables, validate(), Conversation (+24 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (50): getOtherUserId, getOtherUserUsername, clearActiveIfDeletedByOther, _clearActiveIfRemoved, clearAll, clearError, closeConversation, ConversationsProvider (+42 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (46): AppScrollBehavior, buildOverscrollIndicator, build, Dialog, dispose, ResetPasswordDialog, _ResetPasswordDialogState, SizedBox (+38 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (50): ../audio/playback_controller.dart, ../audio/waveform_display.dart, Icon, Function, Row, Semantics, build, _buildContentColumn (+42 more)
...
Cohesion: 0.05
Nodes (49): app_localizations.dart, app_localizations_en.dart, app_localizations_pl.dart, antiQuantumNoteSendFailed, AppLocalizations, _AppLocalizationsDelegate, AppLocalizationsEn, AppLocalizationsPl (+41 more)

### Community 11 - "Community 11"
Cohesion: 0.06
Nodes (48): blocked_users_screen.dart, AuthScreen, _AuthScreenState, build, Scaffold, Shadow, SizedBox, BlockedUsersScreen (+40 more)
...
Cohesion: 0.09
Nodes (13): AuthController, createAuthServiceMock(), AuthModule, AuthService, mockConfigService, mockUsersService, LoginDto, RefreshBodyDto (+5 more)
...
Cohesion: 0.07
Nodes (40): build, _buildHeaderTitle, _buildScrollToBottomButton, ChatDetailScreen, _ChatDetailScreenState, ChatInputBar, _clearActiveConversationIfThisChat, Column (+32 more)

### Community 16 - "Community 16"
Cohesion: 0.06
Nodes (39): code:bash (git add frontend/lib/screens/contacts_screen.dart), Step 6.3: Commit ContactsScreen, code:bash (cd frontend && flutter analyze 2>&1 | tail -5), Chat Scroll `reverse: true` Refactor — Implementation Plan, code:dart (void _onScroll() {), code:bash (git add frontend/lib/screens/chat_detail_screen.dart), code:dart (// Non-pagination path.), code:bash (cd frontend && flutter analyze) (+31 more)
...
Cohesion: 0.07
Nodes (32): api_service.dart, ApiService, _effectiveMediaUrl, Exception, jsonDecode, dispose, _fetch, GifModel (+24 more)
...
Cohesion: 0.08
Nodes (37): _ActionTile, AlertDialog, build, _CenterProgressOverlay, ChatActionTiles, _CircularProgressPainter, Container, CustomPaint (+29 more)
...
Cohesion: 0.07
Nodes (33): code:dart (Widget _buildDeliveryIcon() {), code:dart (String? _getTimerText() {), code:dart (@override), code:bash (git add frontend/lib/widgets/chat_message_bubble.dart), code:yaml (dependencies:), code:bash (cd frontend), code:dart (import 'package:flutter/material.dart';), code:bash (git add frontend/lib/widgets/chat_input_bar.dart) (+25 more)
...
Cohesion: 0.07
Nodes (29): anti_quantum_note_dialog.dart, build, AntiQuantumNoteDialog, _AntiQuantumNoteDialogState, build, dispose, Expanded, Padding (+21 more)

### Community 28 - "Community 28"
Cohesion: 0.06
Nodes (33): code:dart (// frontend/test/services/media_crypto_service_test.dart), code:block2 (cd frontend && flutter test test/services/media_crypto_servi), code:dart (// frontend/lib/services/media_crypto_service.dart), code:block4 (cd frontend && flutter test test/services/media_crypto_servi), code:dart (import '../services/media_crypto_service.dart';), code:block6 (cd frontend && flutter analyze lib/providers/messaging_provi), code:block7 (git add frontend/lib/services/media_crypto_service.dart \), Task 1: MediaCryptoService (+25 more)

### Community 29 - "Community 29"
Cohesion: 0.07
Nodes (32): Chunk 5: Frontend — Widget Decomposition (Phase 5), code:dart (class MessageMetadataRow extends StatelessWidget {), code:dart (class MessageContentFactory {), code:bash (git add frontend/lib/widgets/message/ frontend/lib/screens/c), code:bash (git add frontend/lib/widgets/input/ frontend/lib/screens/cha), code:bash (git add frontend/lib/widgets/audio/ frontend/lib/widgets/mes), Task 5.1: Decompose `chat_message_bubble.dart` into composition pattern, Task 5.2: Decompose `chat_input_bar.dart` (+24 more)
...
Cohesion: 0.08
Nodes (31): code:bash (cd frontend), code:bash (git add frontend/lib/models/message_model.dart), Phase 2: Frontend - Message Model & Provider Updates, Task 2.1: Extend MessageModel with New Fields, code:dart (static MessageType _parseMessageType(String? type) {), code:yaml (just_audio: ^0.9.36  # already exists), code:bash (git add frontend/pubspec.yaml frontend/pubspec.lock), code:dart (enum MessageType {) (+23 more)

### Community 32 - "Community 32"
Cohesion: 0.08
Nodes (27): code:dart (IconButton(), Step 5.1: Remove IconButton delete, Implementation Phases, Phase 2: Frontend Recording, Phase 3: Frontend Upload & Optimistic UI, Phase 5: Error Handling & Polish, Phase 6: Testing & Refinement, code:bash (git add frontend/lib/widgets/voice_recording_overlay.dart) (+19 more)
...
Cohesion: 0.08
Nodes (28): code:typescript (export enum MessageType {), code:typescript (import { IsInt } from 'class-validator';), code:typescript (import { SendPingDto } from './dto/send-ping.dto';), code:javascript (socket.emit('sendPing', { recipientId: 2 });), code:bash (git add backend/src/messages/entities/message.entity.ts), Task 1.2: Add Ping Message Type, code:bash (git add backend/src/messages/messages.service.ts), Task 2: MessagesService.deleteAllByConversation (+20 more)
...
Cohesion: 0.07
Nodes (26): Chat Screen Architecture - Source of Truth, Client → Server, code:typescript (@Entity('messages')), Countdown Not Live Updating, Database Schema Changes, Delivery Indicators Not Updating, Deployment Checklist, Drawing Upload Fails (+18 more)

### Community 40 - "Community 40"
Cohesion: 0.09
Nodes (16): FriendRequestStatus, FriendRequestMapper, payload, request, payload, user, UserMapper, MessageType (+8 more)
...
Cohesion: 0.11
Nodes (24): AlertDialog, build, _buildContactsList, _buildContactTile, _buildHeader, Center, _compareByDisplayName, ContactsScreen (+16 more)

### Community 43 - "Community 43"
Cohesion: 0.1
Nodes (24): build, buildRecordingBar, _checkMicPermission, dispose, Exception, Focus, _formatRecordingDuration, Function (+16 more)

### Community 44 - "Community 44"
Cohesion: 0.1
Nodes (25): Architecture, Backend Services, E2E Encryption, Frontend Providers, Architecture, Backend Layer, code:block1 (User A long-press (1.5s)), Event Flow (+17 more)
...
Cohesion: 0.08
Nodes (23): 5. ChatProvider - New Methods, code:dart (void deleteConversationOnly(int conversationId) {), code:dart (onConversationDeleted: (data) {), code:dart (void deleteConversationOnly(int conversationId) {), code:dart (void _handleConversationDeleted(dynamic data) {), code:dart (onConversationDeleted: _handleConversationDeleted,), code:dart (import 'archive_placeholder_screen.dart';), code:dart (import 'contacts_screen.dart';) (+15 more)
...
Cohesion: 0.12
Nodes (18): 1. User A Deletes Conversation, User B Sends Message Simultaneously, 2. User A Deletes Conversation, Then User B Unfriends, 3. Re-opening Chat Before Full Deletion (Race Condition), Edge Cases, Bubble Redesign: Telegram-style time overlay + media full-bleed, Files Changed, Goal, Problem (+10 more)
...
Cohesion: 0.1
Nodes (20): Anti-Quantum Note — Implementation Plan, Chunk 1: Backend — Entity, Module, Service, Chunk 2: Backend — Controller, Module, App wiring, Chunk 4: Frontend — Crypto + sendNote + tile wiring, code:typescript (// backend/src/secret-notes/secret-note.entity.ts), code:typescript (// backend/src/secret-notes/secret-notes.controller.ts), code:bash (cd backend && npx jest secret-notes.controller.spec --no-cov), code:bash (git add backend/src/secret-notes/secret-notes.controller.ts ) (+12 more)
...
Cohesion: 0.11
Nodes (20): Backend Tests, Frontend Tests, Testing Strategy, Conclusion, Data Flow (Step-by-Step), Expiration Flow, Functional Requirements, Integration Tests (+12 more)

### Community 67 - "Community 67"
Cohesion: 0.15
Nodes (11): FetchPreKeyBundleDto, RequestSessionRebuildDto, UploadKeyBundleDto, OneTimePreKeyDto, UploadOneTimePreKeysDto, PreKeyBundleResponse, invalidData, mockBundle (+3 more)

### Community 68 - "Community 68"
Cohesion: 0.1
Nodes (19): applyPhonePortraitOrientations, AuthGate, _AuthGateState, AuthScreen, didChangeMetrics, dispose, FireplaceApp, initState (+11 more)
...
Cohesion: 0.1
Nodes (20): code:dart (@override), code:dart (@override), code:dart (context.read<ChatProvider>().deleteConversation(conversation), code:dart (context.read<ChatProvider>().deleteConversationOnly(conversa), code:dart ('This will delete all messages. This action cannot be undone), code:dart ('This will delete all messages. Your contact will remain in ), code:bash (git add frontend/lib/widgets/conversation_tile.dart frontend), Step 5.2: Wrap tile content in Dismissible (+12 more)

### Community 72 - "Community 72"
Cohesion: 0.15
Nodes (20): 10. Drawing Removal, 11. Backward Compatibility, 12. Testing, 13. Files Changed, 1. Extended E2E Envelope, 2. New Backend Endpoint: `POST /messages/upload-media`, 3. Removed Backend Endpoints, 4. Removed WebSocket Events (+12 more)
...
Cohesion: 0.11
Nodes (18): code:dart (// Menu (three dots)), code:bash (git add frontend/lib/screens/chat_detail_screen.dart), Contacts Tab Implementation Plan, Notes for Implementation, Step 6.2: Verify Flutter compiles, Step 7.1: Remove _unfriend method, Step 7.2: Remove PopupMenuButton from AppBar, Step 7.3: Verify Flutter compiles (+10 more)
...
Cohesion: 0.12
Nodes (18): code:bash (cd frontend/ios), code:bash (cd frontend), code:bash (flutter run --dart-define=BASE_URL=http://192.168.1.100:3000), Step 5: iOS Xcode setup (iOS only), Step 6: Run Flutter on device, code:bash (cd frontend), code:bash (scp -r frontend/build/web/* TWOJ_USER@<IP>:~/fireplace/front), code:nginx (server {) (+10 more)

### Community 81 - "Community 81"
Cohesion: 0.11
Nodes (16): code:dart (class _CircularProgressPainter extends CustomPainter {), code:bash (git add frontend/lib/widgets/chat_action_tiles.dart), code:dart (class _LongPressActionTile extends StatefulWidget {), code:bash (git add frontend/lib/widgets/chat_action_tiles.dart), code:dart (void _handleClearChatHistory(BuildContext context) {), code:bash (git add frontend/lib/widgets/chat_action_tiles.dart), Task 7: CircularProgressPainter for long-press animation, Task 8: _LongPressActionTile widget with animation (+8 more)
...
Cohesion: 0.12
Nodes (16): Anti-Quantum Note — Design Spec, Backend, Backend (modify), Backend (new), Database, Files to Create/Modify, Frontend (modify), Frontend (new) (+8 more)
...
Cohesion: 0.12
Nodes (16): Architecture, BASE_URL Setup, Benefits Summary, code:bash (flutter run -d <device> --dart-define=BASE_URL=http://192.16), code:dart (// lib/constants/app_constants.dart), code:dart (// lib/config/env_config.dart), code:bash (# Enable USB debugging on phone (Settings → Developer Option), code:bash (# First time (via USB):) (+8 more)
...
Cohesion: 0.13
Nodes (15): code:block4 (❌ frontend/Dockerfile.dev), code:bash (git add -A), code:bash (rm frontend/Dockerfile.dev), code:bash (# Kill old processes), code:bash (docker system prune -a), code:bash (git add -A), Existing Files (No Changes), Files to Modify (+7 more)
...
Cohesion: 0.14
Nodes (14): Notes, code:dart (void emitClearChatHistory(int conversationId) {), code:bash (git add frontend/lib/services/socket_service.dart), code:dart (void clearChatHistory(int conversationId) {), code:dart (void _handleChatHistoryCleared(dynamic data) {), code:dart (onChatHistoryCleared: (data) {), code:dart (final void Function(dynamic data)? onChatHistoryCleared;), code:dart (if (onChatHistoryCleared != null) {) (+6 more)

### Community 109 - "Community 109"
Cohesion: 0.14
Nodes (15): Chunk 4: Frontend — Extract ConnectionProvider + ConversationsProvider + MessagingProvider (Phase 4), code:dart (void connect({required String baseUrl, required String token), code:dart (_socketService.connect(baseUrl: baseUrl, token: token);), code:bash (git add frontend/lib/services/socket_service.dart frontend/l), code:bash (git add frontend/lib/providers/conversations_provider.dart), code:bash (git add frontend/lib/providers/messaging_provider.dart), code:bash (git add -A frontend/lib/), code:bash (git rm frontend/lib/providers/chat_provider.dart) (+7 more)
...
Cohesion: 0.19
Nodes (13): build, Center, Column, dispose, GifPickerSheet, _GifPickerSheetState, initState, _onScroll (+5 more)
...
Cohesion: 0.14
Nodes (12): code:typescript (@Post('voice')), code:typescript (import { CloudinaryModule } from '../cloudinary/cloudinary.m), code:bash (# First login to get JWT), code:bash (git add backend/src/messages/messages.controller.ts backend/), code:typescript (import {), Task 1.4: Create POST /messages/voice endpoint, code:typescript (import { DataSource } from 'typeorm';), code:typescript (async deleteAccount(userId: number, password: string): Promi) (+4 more)
...
Cohesion: 0.18
Nodes (11): code:bash (git add .), Step 11.4: Create final summary commit (if needed), code:bash (# Terminal 1), code:bash (git add -A), Task 14: Run full test suites and fix any issues, code:bash (git add -A), code:bash (cd frontend && flutter analyze && flutter test), code:block29 (flutter run -d chrome) (+3 more)
...
Cohesion: 0.2
Nodes (9): Chunk 5: Final integration, persist/restore, tests, docs, code:bash (git add CLAUDE.md), E2E Encryption for All Message Types + Drawing Removal — Implementation Plan, Task 15: Update CLAUDE.md, Current State, E2E Encryption for All Message Types + Drawing Removal, Non-Goals, Summary (+1 more)
...
Cohesion: 0.2
Nodes (10): code:dart (// Monotonic counter for temporary negative message IDs — pr), code:dart (id: -DateTime.now().millisecondsSinceEpoch, // Temporary neg), code:dart (id: -(++ChatProvider._tempIdSeq), // Monotonic temporary neg), code:bash (cd frontend && flutter analyze 2>&1 | tail -5), code:bash (git add frontend/lib/providers/chat_provider.dart), Fix A: Monotonic optimistic ID counter (4.2), Step 1: Apply all three fixes above, Step 2: Analyze (+2 more)
...
Cohesion: 0.24
Nodes (8): code:dart (MultiProvider(), Summary, 5. Summary, 7. CLAUDE.md Gotchas Preservation Checklist, Error Handling, Full Codebase Refactor — Domain-Driven Decomposition, Phase Exit Criteria, Provider Tree in `main.dart`
...
## Knowledge Gaps
- **2327 isolated node(s):** `mockUsersService`, `mockConfigService`, `dto`, `mediaUrlError`, `_mediaOriginEscaped` (+2322 more)
...
- **Why does `chat_detail_screen.dart` connect `Community 15` to `Community 289`, `Community 4`, `Community 6`, `Community 7`, `Community 8`, `Community 72`, `Community 42`, `Community 11`, `Community 205`, `Community 46`, `Community 79`, `Community 17`, `Community 114`, `Community 21`, `Community 22`, `Community 55`, `Community 27`?**
  _High betweenness centrality (0.144) - this node is a cross-community bridge._
- **Why does `Full Codebase Refactor — Domain-Driven Decomposition` connect `Community 185` to `Community 227`, `Community 263`, `Community 104`, `Community 14`, `Community 210`, `Community 82`?**
  _High betweenness centrality (0.137) - this node is a cross-community bridge._
- **Why does `Summary` connect `Community 185` to `Community 196`, `Community 167`, `Community 41`, `Community 171`, `Community 174`, `Community 176`, `Community 85`, `Community 188`?**
