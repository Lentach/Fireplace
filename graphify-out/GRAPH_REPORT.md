...
## Corpus Check
- 318 files · ~339,118 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4621 nodes · 7473 edges · 314 communities (301 shown, 13 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d3136be8`
...
## Communities (314 total, 13 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (73): build, Icon, SizedBox, _formatTime, GestureDetector, Row, build, _buildContentColumn (+65 more)
...
Cohesion: 0.04
Nodes (55): AppConstants, ConversationModel, main, aesGcmDecrypt, aesGcmEncrypt, main, secureRandomBytes, main (+47 more)

### Community 3 - "Community 3"
Cohesion: 0.08
Nodes (35): AuthModule, mockConfigService, mockUsersService, BlockedModule, ChatModule, ChatValidationModule, Environment, EnvironmentVariables (+27 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (17): buildCorsOrigin(), ChatGateway, BlockUserDto, SearchUsersDto, PushClientStateDto, RecordingVoiceDto, TypingDto, WsThrottlerGuard (+9 more)

### Community 5 - "Community 5"
Cohesion: 0.07
Nodes (14): BlockedService, BlockedUser, ConversationsService, FriendsService, MediaCleanupService, MessageCleanupService, expired, ChatConversationService (+6 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (62): avatar_circle.dart, AuthGate, _AuthGateState, AuthScreen, FireplaceApp, main, MainShell, MaterialApp (+54 more)

### Community 7 - "Community 7"
Cohesion: 0.07
Nodes (17): GetMessagesDto, MarkConversationReadDto, MessageDeliveredDto, MessageDeliveryStatus, MessagesService, ChatLinkPreviewService, ChatMessageService, conv (+9 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (47): add_or_invitations_screen.dart, blocked_users_screen.dart, _AddByUsernameTab, _AddByUsernameTabState, AddOrInvitationsScreen, build, Card, Center (+39 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (41): Padding, AppScrollBehavior, buildOverscrollIndicator, AuthForm, _AuthFormState, build, Form, build (+33 more)

### Community 10 - "Community 10"
Cohesion: 0.06
Nodes (26): AcceptFriendRequestDto, AddReactionDto, ALLOWED_EMOJIS, MEDIA_URL_REGEX, _mediaOriginEscaped, RejectFriendRequestDto, RemoveReactionDto, SendFriendRequestDto (+18 more)

### Community 11 - "Community 11"
Cohesion: 0.1
Nodes (27): FriendRequest, FriendRequestStatus, ConversationMapper, conv, createMockConversation(), lastMsg, payload, FriendRequestMapper (+19 more)
...
Cohesion: 0.06
Nodes (41): SafeArea, build, ChatInputBar, _ChatInputBarState, dispose, _formatTimer, initState, _onRecordingStateChanged (+33 more)
...
Cohesion: 0.05
Nodes (43): Anti-Quantum Note — Implementation Plan, Chunk 1: Backend — Entity, Module, Service, Chunk 2: Backend — Controller, Module, App wiring, Chunk 3: Frontend — Crypto utility + Dialog widget, Chunk 4: Frontend — Crypto + sendNote + tile wiring, code:typescript (// backend/src/secret-notes/secret-note.entity.ts), code:typescript (// backend/src/secret-notes/secret-notes.controller.ts), code:bash (cd backend && npx jest secret-notes.controller.spec --no-cov) (+35 more)

### Community 16 - "Community 16"
Cohesion: 0.06
Nodes (37): api_service.dart, AuthProvider, _cancelSessionRefreshTimer, _clearLocalAuthState, clearStatus, dispose, Exception, Function (+29 more)
...
Cohesion: 0.06
Nodes (36): Center, initState, build, Directory, dispose, Exception, Function, initState (+28 more)
...
Cohesion: 0.06
Nodes (33): LayoutBuilder, build, _buildScaffold, _ChatBubblePainter, ContactsScreen, CustomPaint, didChangeAppLifecycleState, dispose (+25 more)

### Community 24 - "Community 24"
Cohesion: 0.09
Nodes (33): build, _buildHeaderTitle, _buildScrollToBottomButton, ChatDetailScreen, _ChatDetailScreenState, ChatInputBar, Column, didUpdateWidget (+25 more)

### Community 25 - "Community 25"
Cohesion: 0.06
Nodes (33): code:dart (_encryptionProvider?.saveDecryptedContent(msg.id, persistDat), code:dart (final persisted = await _encryptionProvider!.encryptionServi), code:dart (final persisted = await _encryptionProvider!.getDecryptedCon), code:dart (final stored = await _encryptionProvider!.encryptionService), code:dart (final stored = await _encryptionProvider!.getDecryptedConten), code:dart (final persisted = await _encryptionProvider!.encryptionServi), code:dart (final persisted = await _encryptionProvider!.getDecryptedCon), code:bash (cd C:/Users/Lentach/Desktop/Fireplace) (+25 more)
...
Cohesion: 0.1
Nodes (29): 10. Drawing Removal, 11. Backward Compatibility, 12. Testing, 13. Files Changed, 1. Extended E2E Envelope, 2. New Backend Endpoint: `POST /messages/upload-media`, 3. Removed Backend Endpoints, 4. Removed WebSocket Events (+21 more)

### Community 29 - "Community 29"
Cohesion: 0.09
Nodes (25): anti_quantum_note_dialog.dart, AntiQuantumNoteDialog, _AntiQuantumNoteDialogState, build, dispose, Expanded, Padding, SizedBox (+17 more)
...
Cohesion: 0.08
Nodes (26): code:dart (import 'package:flutter_test/flutter_test.dart';), code:dart (import 'package:flutter_test/flutter_test.dart';), code:dart (/// Persist decrypted message content to local cache.), Step 1.1: Write the failing tests, Step 1.2: Run tests to verify they fail, Step 1.3: Add delegation methods to EncryptionProvider, Step 1.4: Run tests to verify they pass, Task 1: Add delegation methods to EncryptionProvider + tests (+18 more)
...
Cohesion: 0.09
Nodes (23): Chunk 4: Frontend — ChatProvider + Wire-up + Bubble, Chunk 5: Integration + CLAUDE.md, code:dart (/// Send a GIF message. Downloads from Giphy, uploads to Clo), code:dart (onTap: () => _showComingSoon(context, l10n.actionTileGif),), code:dart (onTap: () => _openGifPicker(context),), code:dart (void _openGifPicker(BuildContext context) {), code:dart (import 'gif_picker_sheet.dart';), File Structure (+15 more)

### Community 42 - "Community 42"
Cohesion: 0.1
Nodes (24): code:bash (git add backend/src/chat/services/chat-message.service.ts \), Step 4: Commit, Chunk 1: Backend — Thin Gateway + Extract Services (Phase 1), code:typescript (// backend/src/chat/services/chat-presence.service.ts), code:bash (git add backend/src/chat/services/chat-reaction.service.ts b), code:bash (git add backend/src/chat/services/chat-link-preview.service.), code:typescript (// backend/src/chat/services/chat-presence.service.spec.ts), code:typescript (// Replace handleTyping (lines 193-211) with:) (+16 more)
...
Cohesion: 0.09
Nodes (22): Chunk 2: Frontend — Extract EncryptionProvider (Phase 2), Chunk 3: Frontend — Extract FriendsProvider (Phase 3), Chunk 6: Final Cleanup + CLAUDE.md Update (Phase 6), code:dart (// frontend/lib/providers/encryption_provider.dart), code:bash (git add frontend/lib/providers/encryption_provider.dart), code:bash (git add frontend/lib/providers/encryption_provider.dart fron), code:bash (git add frontend/lib/providers/friends_provider.dart), code:dart (// frontend/lib/providers/connection_provider.dart) (+14 more)

### Community 46 - "Community 46"
Cohesion: 0.09
Nodes (22): code:bash (cd frontend && flutter test test/providers/messaging_provide), code:dart (// Snapshot to cache immediately (may include encrypted plac), code:dart (final myConversationId = responseConversationId ?? _effectiv), code:bash (cd frontend && flutter test test/providers/messaging_provide), code:bash (cd frontend && flutter test), code:bash (git add frontend/lib/providers/messaging_provider.dart front), code:dart (// BEFORE:), code:dart (// BEFORE:) (+14 more)

### Community 47 - "Community 47"
Cohesion: 0.09
Nodes (20): Chat Screen Architecture - Source of Truth, Client → Server, code:typescript (@Entity('messages')), Colors (RpgTheme), Database Schema Changes, Deployment Checklist, Glossary, Image Loading (+12 more)
...
Cohesion: 0.1
Nodes (19): cancel, ChatReconnectManager, Duration, onDisconnect, resetAttempts, scheduleReconnect, applyRefreshedAccessToken, ConnectionProvider (+11 more)
...
Cohesion: 0.1
Nodes (19): Chunk 1: Drawing Removal + Envelope Extension + Model Changes, Chunk 5: Final integration, persist/restore, tests, docs, code:dart (final data = <String, dynamic>{), code:dart (final restoredType = _parseMessageTypeString(stored?['messag), code:bash (git add frontend/lib/providers/chat_provider.dart), code:bash (# Terminal 1), code:bash (git add -A), code:bash (git add -A frontend/lib/screens/drawing_canvas_screen.dart f) (+11 more)
...
Cohesion: 0.16
Nodes (3): UsersService, WebPushSubscriptionsService, WebPushSubscriptionUpsertInput
...
Cohesion: 0.11
Nodes (18): code:dart (test('chatHistoryCleared removes cache entry', () {), code:bash (cd frontend && flutter test test/providers/messaging_provide), code:dart (// Keep cache current for active conversation.), code:dart (// Update cache with decrypted content (encrypted placeholde), code:dart (// Keep delivery status current in cache.), code:dart (// Reflect deletion in cache; remove entry entirely if the c), code:dart (_conversationCache.remove(conversationId);), code:dart (_conversationCache.remove(conversationId);) (+10 more)
...
Cohesion: 0.12
Nodes (18): ═══════════════════════════════════════, code:bash (cd backend && npx jest media.controller.spec.ts --no-coverag), code:typescript (// In the SendMessageDto describe block, add these cases:), code:typescript (// OLD:), code:typescript (@Matches(MEDIA_URL_REGEX, {), code:typescript (// backend/src/media/media.module.ts), code:bash (cd backend && npm test), code:bash (git add backend/src/media/media.module.ts backend/src/chat/d) (+10 more)
...
Cohesion: 0.12
Nodes (15): 2.1 ChatDetailScreen, 2.2 ChatInputBar, 2.3 ChatActionTiles, 2.4 ChatMessageBubble, 2.5 PingEffectOverlay, 2. Co jest już zaimplementowane i spójne, 2.1 ChatDetailScreen ✅, 2.2 ChatInputBar ✅ (+7 more)
...
Cohesion: 0.12
Nodes (15): Backend, Chat Screen Redesign - End-to-End Test Plan, Frontend, Prerequisites, Test 11.1: Open Conversation Without Active Conversation, Test 11.2: Send Drawing Without Active Conversation, Test 11.3: Upload Image Without Recipient, Test 11: Edge Cases (+7 more)
...
Cohesion: 0.14
Nodes (13): code:typescript (import {), code:typescript (async handleDeleteConversationOnly(), code:typescript (import {), Step 1.3: Add handleDeleteConversationOnly method, code:typescript (import {), code:typescript (import { UserMapper } from '../mappers/user.mapper';), code:typescript (static toPayloadArray(conversations: Conversation[]) {), code:typescript (static toPayloadArray(users: User[]) {) (+5 more)
...
Cohesion: 0.18
Nodes (13): code:yaml (# docker-compose.yml — Backend + DB only (for mobile dev)), code:yaml (# docker-compose.web.yml — Full stack with web frontend), Configuration Details, docker-compose.web.yml (Optional), docker-compose.yml (Main), code:yaml (# docker-compose.yml — Backend + DB only (for mobile dev)), code:bash (git add docker-compose.yml), code:yaml (# docker-compose.web.yml — Full stack with web frontend) (+5 more)

### Community 134 - "Community 134"
Cohesion: 0.17
Nodes (13): code:bash (git add -A), code:bash (rm frontend/Dockerfile.dev), code:bash (# Kill old processes), code:bash (docker system prune -a), code:bash (git add -A), Migration Procedure, code:bash (git add -A), code:bash (rm frontend/Dockerfile.dev) (+5 more)
...
Cohesion: 0.31
Nodes (10): base64UrlEncode, _base64UrlToUint8List, createWebPushBridge, _isIOSWebKit, isStandaloneOrNotRequired, _toBase64Url, _toPayload, WebPushBridge (+2 more)

### Community 161 - "Community 161"
Cohesion: 0.24
Nodes (11): 1. Critical Rules & Gotchas, Backend, E2E Encryption, TypeORM, Backend, code:dart (class _LongPressActionTile extends StatefulWidget {), code:typescript (async deleteAllByConversation(conversationId: number): Promi), code:typescript (async handleClearChatHistory(client: Socket, data: any, serv) (+3 more)
...
Cohesion: 0.18
Nodes (11): ChatActionTiles (`widgets/chat_action_tiles.dart`), ChatMessageBubble (`widgets/chat_message_bubble.dart`), ChatProvider (`providers/chat_provider.dart`), E2eEnvelope parsing, Frontend Changes, L10n (`l10n/app_pl.arb`, `l10n/app_en.arb`), MessageModel (`models/message_model.dart`), New: `GifPickerSheet` widget (`widgets/gif_picker_sheet.dart`) (+3 more)
...
Cohesion: 0.2
Nodes (9): Chat Screen Redesign - Telegram/Wire Inspired UI, code:bash (# Start backend), code:markdown (# Chat Redesign Manual Test Results), code:bash (git add docs/testing/2026-02-04-chat-redesign-manual-tests.m), Current State Analysis, Plan Complete!, Summary, Task 6.1: End-to-End Manual Testing (+1 more)
...
Cohesion: 0.2
Nodes (10): code:bash (cd frontend), code:bash (git add frontend/lib/models/message_model.dart), Phase 2: Frontend - Message Model & Provider Updates, Task 2.1: Extend MessageModel with New Fields, code:bash (cd frontend), code:bash (scp -r frontend/build/web/* TWOJ_USER@<IP>:~/fireplace/front), code:nginx (server {), Etap 8: Flutter web build (+2 more)
...
Cohesion: 0.22
Nodes (10): code:bash (git add backend/src/chat/chat.gateway.ts \), Chunk 2: Backend Changes (upload-media endpoint, remove sendPing, remove old endpoints), code:typescript (import { IsIn, IsNumber, IsOptional, IsPositive } from 'clas), code:typescript (@Post('upload-media')), code:bash (git add backend/src/messages/), code:bash (git add backend/src/chat/), Task 5: Create `POST /messages/upload-media` endpoint, Task 6: Remove sendPing from backend (+2 more)
...
Cohesion: 0.22
Nodes (9): code:typescript (import { IsInt } from 'class-validator';), code:typescript (import { IsInt } from 'class-validator';), code:typescript (export { DeleteConversationOnlyDto } from './delete-conversa), code:bash (git add backend/src/chat/dto/delete-conversation-only.dto.ts), Step 1.1: Create DeleteConversationOnlyDto, Step 1.2: Export DTO in barrel file, Step 1.4: Remove old handleDeleteConversation method, Step 1.5: Commit backend DTO and handler (+1 more)

### Community 195 - "Community 195"
Cohesion: 0.25
Nodes (9): code:typescript (@SubscribeMessage('deleteConversationOnly')), code:typescript (@SubscribeMessage('deleteConversationOnly')), code:typescript (@SubscribeMessage('deleteConversation')), code:bash (git add backend/src/chat/chat.gateway.ts), Step 2.1: Add @SubscribeMessage handler, Step 2.2: Remove old deleteConversation handler, Step 2.3: Verify backend compiles, Step 2.4: Commit gateway changes (+1 more)
...
Cohesion: 0.25
Nodes (8): code:bash (docker-compose up), code:bash (cd frontend), code:bash (flutter run -d <device-id> --dart-define=BASE_URL=http://192), code:bash (docker-compose down), Task 8: Test Flutter Native Run (if device available), code:bash (docker-compose down && docker-compose up), code:bash (docker-compose down && docker-compose up -d), Krok 2: Backend - Dodaj IP do CORS
...
Cohesion: 0.29
Nodes (6): CLAUDE.md Updates After Implementation, GIF Support — Design Spec, Giphy API Details, Out of Scope, Privacy Model, User Flow
...
Cohesion: 0.33
Nodes (6): code:bash (docker-compose down), code:bash (taskkill //F //IM node.exe), code:bash (docker-compose up --build), code:bash (curl http://localhost:3000), code:bash (docker-compose down), Task 7: Test Backend + DB Startup

### Community 254 - "Community 254"
Cohesion: 0.33
Nodes (6): code:bash (docker images | findstr "mvp-chat-app"), code:bash (docker system prune -a), code:bash (docker-compose up --build), code:bash (docker images | findstr "mvp-chat-app"), code:bash (docker-compose down), Task 10: Cleanup Old Docker Images
...
Cohesion: 0.33
Nodes (6): code:bash (git add backend/src/media/media.controller.ts backend/src/me), code:ts (FileInterceptor('file', { limits: { fileSize: 11 * 1024 * 10), code:ts (FileInterceptor('file', { limits: { fileSize: 21 * 1024 * 10), code:bash (cd backend && npm test -- --testPathPattern="media.controlle), code:bash (git add backend/src/media/media.controller.ts), Task 6 — Fix upload size mismatch: raise server limit to 21 MB
...
## Knowledge Gaps
- **2273 isolated node(s):** `mockUsersService`, `mockConfigService`, `dto`, `mediaUrlError`, `_mediaOriginEscaped` (+2268 more)
...
- **Why does `Full Codebase Refactor — Domain-Driven Decomposition` connect `Community 201` to `Community 102`, `Community 10`, `Community 45`, `Community 211`, `Community 246`, `Community 281`?**
  _High betweenness centrality (0.160) - this node is a cross-community bridge._
- **Why does `Summary` connect `Community 201` to `Community 224`, `Community 225`, `Community 171`, `Community 173`, `Community 176`, `Community 82`, `Community 115`, `Community 182`, `Community 86`, `Community 54`?**
  _High betweenness centrality (0.151) - this node is a cross-community bridge._
- **Why does `chat_detail_screen.dart` connect `Community 24` to `Community 0`, `Community 6`, `Community 39`, `Community 8`, `Community 9`, `Community 202`, `Community 140`, `Community 13`, `Community 14`, `Community 79`, `Community 18`, `Community 20`, `Community 21`, `Community 23`, `Community 28`, `Community 29`?**
