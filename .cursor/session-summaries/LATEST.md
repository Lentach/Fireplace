...
**Date:** 2026-07-28 — **invitation rework IMPLEMENTED end to end** on `feat/invitation-rework` (worktree `fireplace-wt-invitation`). Backend 564/47, Flutter 930+4, live `test_e2e` 11 — all exit 0. **Not merged, not deployed.** ➡ `2026-07-28-invitation-implementation.md`; plan `docs/plans/2026-07-28-invitation-implementation-plan.md`.
