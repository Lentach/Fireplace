...
/// was 394 of an innerHeight of 797 → a 403px keyboard Flutter never saw). This
/// source computes the real inset as `innerHeight - visualViewport.height -
/// visualViewport.offsetTop` and updates [inset] on visualViewport resize/scroll.
///
