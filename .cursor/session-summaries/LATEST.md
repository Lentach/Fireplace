...
## Previous
- 2026-07-20: Landing `/welcome` Rev 7-14 — reduced-motion + off-screen rAF pause + social/SEO meta + a11y focus rings + bidirectional skip bookends; Rev 14 mobile `.kb-done` pill hides on tap. Rebuilt + redeployed on the Astro 7.1.0 toolchain (dependabot PR #88 merged mid-session; smoke-tested clean). LIVE `6oHf6wJ4`/`DJ-65XJU`. Committed + pushed. Full: `2026-07-20-session-landing-nits.md`.
