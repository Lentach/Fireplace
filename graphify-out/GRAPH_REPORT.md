...
## Corpus Check
- 328 files · ~344,959 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4708 nodes · 7577 edges · 312 communities (300 shown, 12 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5c278357`
...
Cohesion: 0.03
Nodes (44): buildCorsOrigin(), ChatGateway, AcceptFriendRequestDto, AddReactionDto, ALLOWED_EMOJIS, BlockUserDto, MEDIA_URL_REGEX, _mediaOriginEscaped (+36 more)
...
Cohesion: 0.05
Nodes (70): _addMessageToState, addReaction, _cancelDelayedRetry, _cancelDelayedRetryIfAny, clearAll, clearChatHistory, clearMessages, clearPingEffect (+62 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (61): avatar_circle.dart, build, initState, Exception, SizedBox, AvatarCircle, _AvatarCircleState, build (+53 more)

### Community 4 - "Community 4"
Cohesion: 0.08
Nodes (29): AuthService, mockConfigService, mockUsersService, Conversation, ConversationMapper, conv, createMockConversation(), lastMsg (+21 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (50): app_localizations.dart, app_localizations_en.dart, app_localizations_pl.dart, antiQuantumNoteSendFailed, AppLocalizations, _AppLocalizationsDelegate, AppLocalizationsEn, AppLocalizationsPl (+42 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (49): ../audio/playback_controller.dart, ../audio/waveform_display.dart, Icon, _formatTime, Column, Row, build, _buildContentColumn (+41 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (49): blocked_users_screen.dart, BlockedUsersScreen, _BlockedUserTile, build, Padding, Scaffold, SizedBox, build (+41 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (33): AppConstants, ArgumentError, EncryptedMedia, MediaCryptoService, E2eEnvelope, main, aesGcmDecrypt, aesGcmEncrypt (+25 more)

### Community 9 - "Community 9"
Cohesion: 0.06
Nodes (44): getOtherUserId, getOtherUserUsername, clearActiveIfDeletedByOther, _clearActiveIfRemoved, clearAll, clearError, closeConversation, ConversationsProvider (+36 more)

### Community 10 - "Community 10"
Cohesion: 0.09
Nodes (18): UploadMediaDto, LocalStorageService, err, mockFs, UploadAvatarResult, UploadImageResult, UploadRawFileResult, UploadVoiceResult (+10 more)

### Community 11 - "Community 11"
Cohesion: 0.06
Nodes (42): Exception, build, Directory, dispose, Exception, Function, initState, _isExpired (+34 more)
...
Cohesion: 0.05
Nodes (34): main, buildProviderWithSampleData, main, main, main, _msg, _FakeEncryptionProvider, main (+26 more)

### Community 14 - "Community 14"
Cohesion: 0.09
Nodes (9): BlockedService, ConversationsService, ChatConversationService, friend, mockFriendRequest, mockRecipient, mockSender, ChatValidationService (+1 more)
...
Cohesion: 0.06
Nodes (33): build, Dialog, dispose, ResetPasswordDialog, _ResetPasswordDialogState, SizedBox, _submit, build (+25 more)

### Community 18 - "Community 18"
Cohesion: 0.07
Nodes (36): add_or_invitations_screen.dart, _AddByUsernameTab, _AddByUsernameTabState, AddOrInvitationsScreen, build, Card, Center, DefaultTabController (+28 more)
...
Cohesion: 0.09
Nodes (12): JwtAuthGuard, DeleteAccountDto, RegisterFcmTokenDto, RegisterWebPushSubscriptionDto, RemoveFcmTokenDto, RemoveWebPushSubscriptionDto, WebPushKeysDto, startsWith() (+4 more)

### Community 24 - "Community 24"
Cohesion: 0.07
Nodes (30): AuthForm, _AuthFormState, build, dispose, Form, build, DeleteAccountDialog, _DeleteAccountDialogState (+22 more)
...
Cohesion: 0.09
Nodes (28): Summary, Provider Tree in `main.dart`, 1. WhatsApp, 2. Telegram, 3. Facebook Messenger, 4. Slack, 5. Discord, 6. Common UX patterns (zoom/pan) (+20 more)

### Community 31 - "Community 31"
Cohesion: 0.07
Nodes (28): Chat Screen Architecture - Source of Truth, Client → Server, code:typescript (@Entity('messages')), Colors (RpgTheme), Database Schema Changes, Deployment Checklist, Glossary, Image Loading (+20 more)

### Community 32 - "Community 32"
Cohesion: 0.09
Nodes (29): 1.1 Frontend (Flutter), 1.3 iOS (`frontend/ios/Runner/Info.plist`), 1.4 Android (`frontend/android/app/src/main/AndroidManifest.xml`), 1. Current Configuration, 3.1 Backend CORS — `docker-compose.yml`, 3.2 iOS — `frontend/ios/Runner/Info.plist`, 3.3 Android — `frontend/android/app/src/main/AndroidManifest.xml`, 3. Exact Code Changes (+21 more)
...
Cohesion: 0.09
Nodes (27): 4. Implementation Procedure, code:powershell (ipconfig), code:bash (ifconfig | grep "inet " | grep -v 127.0.0.1), code:bash (cd frontend/ios), code:bash (cd frontend), code:bash (flutter run --dart-define=BASE_URL=http://192.168.1.100:3000), Step 1: Find computer IP, Step 3: Edit iOS Info.plist (+19 more)

### Community 37 - "Community 37"
Cohesion: 0.08
Nodes (24): Center, AnimatedBuilder, build, Center, dispose, initState, PingEffectOverlay, _PingEffectOverlayState (+16 more)

### Community 38 - "Community 38"
Cohesion: 0.08
Nodes (26): code:block4 (❌ frontend/Dockerfile.dev), code:bash (git add -A), code:bash (rm frontend/Dockerfile.dev), code:bash (# Kill old processes), code:bash (docker system prune -a), code:bash (git add -A), Existing Files (No Changes), Files to Modify (+18 more)

### Community 39 - "Community 39"
Cohesion: 0.13
Nodes (3): MessagesService, msgs, ChatLinkPreviewService
...
Cohesion: 0.15
Nodes (7): GetMessagesDto, MarkConversationReadDto, MessageDeliveredDto, PendingBucket, PushNotificationCoalescingService, NotifyOptions, PushNotificationsService
...
Cohesion: 0.1
Nodes (23): 1. New Screen: ContactsScreen, 2. Modified: ConversationTile, 3. Modified: ChatDetailScreen, Frontend Components, 2. Recording UI - Voice Recording Overlay, 3. Message Bubble - Voice Playback UI, 4. Chat Input Bar Enhancement, 6. API Service Enhancement (+15 more)
...
Cohesion: 0.09
Nodes (23): Backend Tests, Frontend Tests, Testing Strategy, Conclusion, Functional Requirements, Future Enhancements, Integration Tests, Manual Testing Checklist (+15 more)
...
Cohesion: 0.09
Nodes (22): Backend, Chat Screen Redesign - End-to-End Test Plan, Frontend, Prerequisites, Test 10.1: Image Upload Validation - MIME Type, Test 10.2: Image Upload Validation - File Size, Test 10.3: CORS Headers, Test 10: Backend Validation (+14 more)
...
Cohesion: 0.11
Nodes (22): Chunk 5: Frontend — Widget Decomposition (Phase 5), code:dart (class MessageMetadataRow extends StatelessWidget {), code:dart (class MessageContentFactory {), code:bash (git add frontend/lib/widgets/message/ frontend/lib/screens/c), code:bash (git add frontend/lib/widgets/input/ frontend/lib/screens/cha), code:bash (git add frontend/lib/widgets/audio/ frontend/lib/widgets/mes), Task 5.1: Decompose `chat_message_bubble.dart` into composition pattern, Task 5.2: Decompose `chat_input_bar.dart` (+14 more)
...
Cohesion: 0.1
Nodes (21): code:bash (git status), code:bash (git add -A), code:bash (git log --oneline -8), code:bash (git push origin master), Task 12: Final Commit and Summary, code:bash (cd frontend && flutter analyze), code:bash (cd backend && npm run build), code:bash (git status) (+13 more)
...
Cohesion: 0.14
Nodes (20): code:yaml (libsignal_protocol_dart: ^0.7.4), code:dart (class EncryptionService {), code:dart (class LinkPreviewService {), code:typescript (@Entity('key_bundles')), code:typescript (@Entity('one_time_pre_keys')), code:typescript (@Module({), code:typescript (export class UploadKeyBundleDto {), code:typescript (export class OneTimePreKeyDto {) (+12 more)

### Community 59 - "Community 59"
Cohesion: 0.1
Nodes (20): code:bash (# Docker), Step 2: Update backend CORS, code:powershell (# Dodaj regułę dla port 3000), code:bash (# Powinno być 192.168.x.x (local network)), code:bash (docker ps  # Backend powinien być RUNNING), code:block32 (NSURLConnection error: -1022), code:block33 (CLEARTEXT communication to 192.168.1.100 not permitted by ne), code:block34 (error: Signing for "Runner" requires a development team. Sel) (+12 more)

### Community 60 - "Community 60"
Cohesion: 0.11
Nodes (20): code:yaml (dependencies:), code:bash (cd frontend), code:dart (import 'package:flutter/material.dart';), code:bash (git add frontend/lib/widgets/chat_input_bar.dart), code:yaml (dependencies:), code:bash (cd frontend), code:bash (mkdir -p frontend/assets/sounds), code:dart (import 'package:flutter/material.dart';) (+12 more)
...
Cohesion: 0.11
Nodes (19): Chunk 3: Frontend — Remove ping socket events, update ApiService, code:bash (git add frontend/lib/services/socket_service.dart frontend/l), code:dart (/// Upload media (image or voice) to backend. Returns {media), code:bash (git add frontend/lib/services/api_service.dart), Task 7: Remove ping events from SocketService and ChatProvider, Task 8: Replace uploadImageMessage/uploadVoiceMessage with uploadMedia in ApiService, code:bash (git add frontend/lib/services/api_service.dart), code:dart (// frontend/test/services/api_service_media_test.dart) (+11 more)

### Community 69 - "Community 69"
Cohesion: 0.11
Nodes (19): code:dart (// Monotonic counter for temporary negative message IDs — pr), code:dart (id: -DateTime.now().millisecondsSinceEpoch, // Temporary neg), code:dart (id: -(++ChatProvider._tempIdSeq), // Monotonic temporary neg), code:dart (if (_activeConversationId == conversationId && content.isNot), code:dart (if (_activeConversationId == conversationId && content.isNot), code:dart (bool _decryptingHistory = false;), code:dart (_decryptHistoryCancelled = true;), code:dart (_decryptHistoryCancelled = false;) (+11 more)

### Community 70 - "Community 70"
Cohesion: 0.11
Nodes (19): Chunk 4: Frontend — Extract ConnectionProvider + ConversationsProvider + MessagingProvider (Phase 4), code:dart (void connect({required String baseUrl, required String token), code:dart (_socketService.connect(baseUrl: baseUrl, token: token);), code:bash (git add frontend/lib/services/socket_service.dart frontend/l), code:dart (// frontend/lib/providers/connection_provider.dart), code:bash (git add frontend/lib/providers/connection_provider.dart), code:bash (git add frontend/lib/providers/conversations_provider.dart), code:bash (git add frontend/lib/providers/messaging_provider.dart) (+11 more)
...
Cohesion: 0.16
Nodes (15): api_service.dart, ApiService, _effectiveMediaUrl, jsonDecode, dispose, _fetch, GifModel, GifService (+7 more)
...
Cohesion: 0.11
Nodes (17): code:dart (Widget _buildDeliveryIcon() {), code:dart (String? _getTimerText() {), code:dart (@override), code:bash (git add frontend/lib/widgets/chat_message_bubble.dart), code:dart (import 'package:flutter/material.dart';), code:dart (import 'chat_action_tiles.dart';), code:dart (class ChatProvider extends ChangeNotifier {), code:bash (git add frontend/lib/widgets/chat_action_tiles.dart) (+9 more)

### Community 77 - "Community 77"
Cohesion: 0.12
Nodes (17): code:ts (const PRIVATE_IP_RE =), code:ts (const PRIVATE_IP_RE =), code:bash (git add backend/src/chat/services/link-preview.service.ts), code:ts (import {), code:ts (@IsString()), code:ts (@IsString()), code:bash (cd backend && npm test -- --no-coverage), code:bash (git add backend/src/config/env.validation.ts) (+9 more)

### Community 78 - "Community 78"
Cohesion: 0.11
Nodes (17): 3. Backend — Gateway + Services, 4. Directory Structure After Refactor, 5. Summary, 7. CLAUDE.md Gotchas Preservation Checklist, Backend `src/chat/`, `chat-friend-request.service.ts` (503 LOC) -> Split, `chat.gateway.ts` (462 LOC, 29 handlers) -> Thin Gateway, `chat-message.service.ts` (522 LOC) -> Split (+9 more)

### Community 79 - "Community 79"
Cohesion: 0.12
Nodes (17): code:dart (// frontend/lib/utils/web_blob_utils_stub.dart), code:dart (// frontend/lib/utils/web_blob_utils_web.dart), code:block30 (cd frontend && flutter analyze lib/utils/web_blob_utils_stub), code:block31 (git add frontend/lib/utils/web_blob_utils_stub.dart \), code:dart (import 'dart:convert';), code:dart (String? _blobUrl; // Web only: revoked on dispose), code:dart (Future<String> _downloadAndCache(String url) async {), code:dart (if (_blobUrl != null) {) (+9 more)

### Community 80 - "Community 80"
Cohesion: 0.11
Nodes (18): code:dart (test('build includes messageType when provided', () {), code:dart (class E2eEnvelope {), code:bash (git add frontend/lib/utils/e2e_envelope.dart frontend/test/u), Task 3: Extend E2E Envelope with messageType, mediaUrl, mediaDuration, code:dart (// frontend/lib/utils/e2e_envelope.dart), code:block11 (cd frontend && flutter test test/utils/e2e_envelope_test.dar), code:block12 (git add frontend/lib/utils/e2e_envelope.dart \), code:dart (// frontend/test/utils/e2e_envelope_test.dart) (+10 more)
...
Cohesion: 0.14
Nodes (14): Bubble Redesign: Telegram-style time overlay + media full-bleed, code:dart (static Widget build({), code:bash (cd frontend && flutter test), code:bash (git add frontend/lib/widgets/message/message_content_factory), Task 4: Forward `timeOverlay` through `MessageContentFactory`, Files Changed, Goal, Problem (+6 more)
...
Cohesion: 0.13
Nodes (15): Phase 5: Error Handling & Polish, code:bash (git add frontend/lib/widgets/voice_recording_overlay.dart), code:dart (Future<void> retryVoiceMessage(String tempId) async {), code:dart (Widget _buildDeliveryIcon() {), code:bash (git add frontend/lib/providers/chat_provider.dart frontend/l), code:dart (Future<void> _loadAndPlayAudio() async {), code:dart (bool _isExpired() {), code:bash (git add frontend/lib/widgets/voice_message_bubble.dart) (+7 more)
...
Cohesion: 0.13
Nodes (15): Chunk 1: Drawing Removal + Envelope Extension + Model Changes, Chunk 5: Final integration, persist/restore, tests, docs, code:bash (# Terminal 1), code:bash (git add -A), code:bash (git add -A frontend/lib/screens/drawing_canvas_screen.dart f), code:bash (git add CLAUDE.md), E2E Encryption for All Message Types + Drawing Removal — Implementation Plan, Task 14: Run full test suites and fix any issues (+7 more)
...
Cohesion: 0.17
Nodes (5): AuthController, createAuthServiceMock(), LoginDto, RefreshBodyDto, RegisterDto
...
Cohesion: 0.13
Nodes (15): code:typescript (// backend/src/auth/device-sessions.service.ts), code:bash (cd backend && npx jest src/auth/device-sessions.service.spec), code:bash (git add backend/src/auth/device-sessions.service.ts backend/), code:typescript (// backend/src/auth/auth.module.ts), code:bash (cd backend && npm run build), code:bash (# In Docker), code:bash (git add backend/src/auth/auth.module.ts), code:typescript (// backend/src/auth/device-session.entity.ts) (+7 more)
...
Cohesion: 0.15
Nodes (13): Executive Summary, Key Concepts, 10. Implementation Timeline, 14. Glossary, Document Change Log, End-to-End Encryption Architecture — Signal Protocol, Executive Summary, Key Decisions (+5 more)

### Community 119 - "Community 119"
Cohesion: 0.15
Nodes (14): code:bash (git add CLAUDE.md), Step 10.5: Commit documentation, code:markdown (**2026-02-14:**), code:bash (git add CLAUDE.md), Task 10: Manual Testing & Documentation, code:markdown (- **Message Types:** TEXT, PING, IMAGE, DRAWING, VOICE), code:markdown (---), code:markdown (**2026-02-15:**) (+6 more)
...
Cohesion: 0.16
Nodes (14): code:bash (scp -r frontend/build/web/* TWOJ_USER@<IP>:~/fireplace/front), code:nginx (server {), code:bash (sudo nano /etc/nginx/sites-available/fireplace), code:nginx (server {), code:bash (sudo ln -s /etc/nginx/sites-available/fireplace /etc/nginx/s), Etap 6: Nginx + SSL, Etap 8: Flutter web build, code:bash (sudo certbot --nginx -d twoja-domena.com) (+6 more)
...
Cohesion: 0.17
Nodes (11): code:bash (cd backend && git add src/chat/services/chat-conversation.se), code:bash (cd backend && npm test --no-coverage 2>&1 | tail -10), code:bash (cd backend && git add src/chat/services/chat-conversation.se), code:typescript (import { Test, TestingModule } from '@nestjs/testing';), code:bash (cd backend && npm test -- --testPathPattern=chat-conversatio), code:typescript (const areFriends = await this.friendsService.areFriends(user), code:bash (cd backend && npm test -- --testPathPattern=chat-conversatio), Security & Bug Fixes Implementation Plan (+3 more)
...
Cohesion: 0.15
Nodes (13): code:typescript (/** True if either user has blocked the other. Single query ), code:bash (cd backend && npm test --no-coverage 2>&1 | tail -15), code:bash (cd backend && git add src/blocked/blocked.service.ts), code:typescript (import { ExecutionContext, Injectable } from '@nestjs/common), code:typescript (import { WsThrottlerGuard } from './guards/ws-throttler.guar), code:typescript (import { UseGuards } from '@nestjs/common';), code:typescript (@UseGuards(WsThrottlerGuard)), code:bash (cd backend && npm test --no-coverage 2>&1 | tail -10) (+5 more)
...
Cohesion: 0.15
Nodes (12): Chunk 3: Frontend — Extract FriendsProvider (Phase 3), Chunk 6: Final Cleanup + CLAUDE.md Update (Phase 6), code:bash (git add frontend/lib/providers/friends_provider.dart), code:bash (git add CLAUDE.md), Full Codebase Refactor Implementation Plan, Phase 1 Exit Criteria Check, Phase 3 Exit Criteria Check, Task 3.1: Create `FriendsProvider` skeleton with state (+4 more)
...
Cohesion: 0.17
Nodes (8): getBaseUrlForPlatform, getBaseUrlForPlatform, _sanitizeFilename, Exception, _sanitizeFilename, Function, handler, dart:html

### Community 154 - "Community 154"
Cohesion: 0.17
Nodes (11): Anti-Quantum Note — Design Spec, Backend, Database, New module: `secret-notes`, Reading Page (served by backend), State 1 — Landing (note exists, not yet read), State 2 — Revealed (after button click), State 3 — Gone (already read or expired) (+3 more)
...
Cohesion: 0.17
Nodes (12): code:dart (IconButton(), code:dart (context.read<ChatProvider>().deleteConversation(conversation), code:dart (context.read<ChatProvider>().deleteConversationOnly(conversa), code:dart ('This will delete all messages. This action cannot be undone), code:dart ('This will delete all messages. Your contact will remain in ), code:bash (git add frontend/lib/widgets/conversation_tile.dart frontend), Step 3.3: Verify Flutter compiles, Step 5.1: Remove IconButton delete (+4 more)
...
Cohesion: 0.18
Nodes (12): Chunk 2: Frontend — Extract EncryptionProvider (Phase 2), code:dart (// frontend/lib/providers/encryption_provider.dart), code:bash (git add frontend/lib/providers/encryption_provider.dart), code:bash (git add frontend/lib/providers/encryption_provider.dart fron), Phase 2 Exit Criteria Check, Task 2.1: Create `EncryptionProvider` skeleton with state + interface, Task 2.3: Move E2E initialization + key exchange logic to EncryptionProvider, code:dart (void onPreKeysLow(dynamic data) {) (+4 more)
...
Cohesion: 0.18
Nodes (10): code:yaml (cryptography: ^2.7.0), code:bash (cd frontend && flutter pub get), code:bash (git add frontend/pubspec.yaml frontend/pubspec.lock), code:dart (// inside ApiService class), code:bash (git add frontend/lib/services/api_service.dart), Execution Handoff, PR 5 — Frontend Foundation, Self-Review (+2 more)
...
Cohesion: 0.2
Nodes (9): code:typescript (import {), code:typescript (async createImageMessage(data: {), code:typescript (import { MessagesController } from './messages.controller';), code:bash (curl -X POST http://localhost:3000/messages/image \), code:bash (git add backend/src/messages/messages.controller.ts), Phase 5: Image Upload for Messages (Camera & Drawing), Task 5.1: Backend - Image Message Upload Endpoint, code:typescript (import {) (+1 more)
...
Cohesion: 0.2
Nodes (10): code:dart (final stored = await _encryptionProvider!.encryptionService), code:dart (final stored = await _encryptionProvider!.getDecryptedConten), code:dart (await _encryptionProvider?.encryptionService), code:dart (await _encryptionProvider?.saveDecryptedContent(decrypted.id), Step 2.1: Replace call site 1 — save after received message decrypt, Step 2.4: Replace call site 4 — get in history decrypt (own sent messages), Step 2.6: Verify zero remaining references, Step 2.7: Run analyze (+2 more)
...
Cohesion: 0.25
Nodes (9): 2.1 Signal Protocol Key Types, code:block2 (Private: 32 bytes Curve25519 scalar), code:block3 (Private: 32 bytes Curve25519 scalar), code:block4 (Generated in batches of 100), code:block5 (Generated dynamically during conversation), Identity Key Pair (Long-term), One-Time PreKeys (Short-term), Ratchet Keys (Ephemeral) (+1 more)
...
Cohesion: 0.22
Nodes (9): code:markdown (| **deleteConversationOnly** | ChatConversationService.handl), code:markdown (- **conversationDeleted:** `{ conversationId: number }`), code:markdown (### 7.X Delete Conversation vs Unfriend), code:markdown (**2026-02-14:**), Step 10.1: Update §5 WebSocket Event Map, Step 10.2: Update §7 Frontend Mechanisms, Step 10.3: Update §9 File Map, Step 10.4: Update §13 Recent Changes (+1 more)
...
Cohesion: 0.22
Nodes (9): code:dart (import 'package:flutter_test/flutter_test.dart';), code:bash (cd frontend && flutter test test/services/encryption_service), code:dart (/// Removes all persisted decrypted content cache entries fo), code:bash (cd frontend && flutter test test/services/encryption_service), code:dart (void clearAll() {), code:dart (group('EncryptionProvider.clearAll triggers persist-clear', ), code:bash (cd frontend && flutter test), code:bash (git add frontend/lib/services/encryption_service.dart fronte) (+1 more)
...
Cohesion: 0.29
Nodes (7): 2.2 Device Registration Flow, 2.3 PreKey Rotation, 2. Key Management & Device Registration, code:dart (// Flutter: First login or new device setup), code:typescript (// Backend: /devices/register endpoint), code:dart (// Flutter: Background task), code:dart (// Flutter: When PreKey count drops below threshold)
...
Cohesion: 0.33
Nodes (6): code:bash (grep -n "deleteAccount" backend/src/users/users.service.ts |), code:ts (import { UsersService } from './users.service';), code:bash (grep -n "deleteAccount\|keyBundles\|fcmTokens\|conversation\), code:bash (cd backend && npm test -- --testPathPattern="users.service.c), code:bash (git add backend/src/users/users.service.cascade.spec.ts), Task 9 — Test: account deletion cascade
...
Cohesion: 0.33
Nodes (6): code:dart (Future<String> createSecretNote(String token, String ciphert), code:dart (import 'package:encrypt/encrypt.dart' as enc;), code:dart (Future<void> sendAntiQuantumNote({), code:bash (cd frontend && flutter test 2>&1 | tail -15), code:bash (git add frontend/lib/services/api_service.dart frontend/lib/), Task 7: sendNote in ChatProvider (crypto + API + send message)
...
Cohesion: 0.5
Nodes (4): 3. New REST Endpoint, code:typescript (@Post('voice')), code:typescript (@Post('voice')), Step 2: Add friendship check to voice upload in `messages.controller.ts`

### Community 291 - "Community 291"
Cohesion: 0.5
Nodes (4): Placeholder Scan, Self-Review, Spec Coverage Check, Type Consistency
...
Cohesion: 0.67
Nodes (3): code:dart (_encryptionProvider?.saveDecryptedContent(msg.id, persistDat), code:dart (_encryptionProvider?.encryptionService), Step 2.2: Replace call site 2 — save after own message (`messageSent`)

## Knowledge Gaps
- **2329 isolated node(s):** `mockUsersService`, `mockConfigService`, `dto`, `mediaUrlError`, `_mediaOriginEscaped` (+2324 more)
...
- **Why does `Full Codebase Refactor — Domain-Driven Decomposition` connect `Community 78` to `Community 107`, `Community 237`, `Community 144`, `Community 211`, `Community 30`?**
  _High betweenness centrality (0.145) - this node is a cross-community bridge._
- **Why does `chat_detail_screen.dart` connect `Community 7` to `Community 3`, `Community 37`, `Community 6`, `Community 9`, `Community 43`, `Community 203`, `Community 46`, `Community 15`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 87`, `Community 24`, `Community 27`?**
  _High betweenness centrality (0.141) - this node is a cross-community bridge._
- **Why does `Summary` connect `Community 30` to `Community 78`, `Community 178`, `Community 51`, `Community 93`, `Community 154`, `Community 187`, `Community 29`, `Community 126`?**
