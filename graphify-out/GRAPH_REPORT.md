...
## Corpus Check
- 337 files · ~349,502 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4824 nodes · 7724 edges · 314 communities (298 shown, 16 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f5c7575b`
...
## Communities (314 total, 16 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (36): buildCorsOrigin(), ChatGateway, AcceptFriendRequestDto, AddReactionDto, ALLOWED_EMOJIS, BlockUserDto, MEDIA_URL_REGEX, _mediaOriginEscaped (+28 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (62): AppConstants, main, aesGcmDecrypt, aesGcmEncrypt, main, secureRandomBytes, main, main (+54 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (73): blocked_users_screen.dart, AuthScreen, _AuthScreenState, build, Scaffold, Shadow, SizedBox, BlockedUsersScreen (+65 more)
...
Cohesion: 0.06
Nodes (64): avatar_circle.dart, build, Exception, combineDisappearingSeconds, Duration, isMessageExpired, SizedBox, AvatarCircle (+56 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (19): AuthController, createAuthServiceMock(), AuthService, mockConfigService, mockUsersService, LoginDto, RefreshBodyDto, RegisterDto (+11 more)
...
Cohesion: 0.07
Nodes (29): FriendRequestStatus, ConversationMapper, conv, createMockConversation(), lastMsg, payload, FriendRequestMapper, payload (+21 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (49): ../audio/playback_controller.dart, ../audio/waveform_display.dart, Icon, _isExpired, _formatTime, Row, Semantics, build (+41 more)

### Community 9 - "Community 9"
Cohesion: 0.06
Nodes (49): _ActionTile, AlertDialog, _apply, build, _CenterProgressOverlay, ChatActionTiles, _CircularProgressPainter, _clearError (+41 more)

### Community 10 - "Community 10"
Cohesion: 0.08
Nodes (12): BlockedService, ConversationsService, FriendsService, MediaCleanupService, mockMessageRepo, mockStorage, friend, mockFriendRequest (+4 more)

### Community 11 - "Community 11"
Cohesion: 0.15
Nodes (25): AuthModule, BlockedModule, BlockedUser, ChatModule, ChatValidationModule, Environment, EnvironmentVariables, validate() (+17 more)

### Community 12 - "Community 12"
Cohesion: 0.07
Nodes (23): GetMessagesDto, MarkConversationReadDto, MessageDeliveredDto, MessageDeliveryStatus, PendingBucket, PushNotificationCoalescingService, NotifyOptions, PushNotificationsService (+15 more)
...
Cohesion: 0.07
Nodes (39): build, _buildHeaderTitle, _buildScrollToBottomButton, ChatDetailScreen, _ChatDetailScreenState, ChatInputBar, _clearActiveConversationIfThisChat, Column (+31 more)
...
Cohesion: 0.07
Nodes (31): SafeArea, build, Dialog, dispose, ResetPasswordDialog, _ResetPasswordDialogState, SizedBox, _submit (+23 more)
...
Cohesion: 0.07
Nodes (30): anti_quantum_note_dialog.dart, AppScrollBehavior, buildOverscrollIndicator, AntiQuantumNoteDialog, _AntiQuantumNoteDialogState, build, dispose, Expanded (+22 more)
...
Cohesion: 0.08
Nodes (30): add_or_invitations_screen.dart, _AddByUsernameTab, _AddByUsernameTabState, AddOrInvitationsScreen, build, Card, Center, DefaultTabController (+22 more)

### Community 26 - "Community 26"
Cohesion: 0.06
Nodes (32): Backend, Backend Changes, Changing conversation timer, `CLAUDE.md`, Constants, `conversations` (unchanged), Data Model, Expiry sweep (`removeExpiredMessages`, `ChatDetailScreen` 1s timer) (+24 more)

### Community 27 - "Community 27"
Cohesion: 0.08
Nodes (28): cancel, ChatReconnectManager, Duration, onDisconnect, resetAttempts, scheduleReconnect, Duration, onDisconnect (+20 more)

### Community 28 - "Community 28"
Cohesion: 0.08
Nodes (30): Files to Create, ═══════════════════════════════════════, ═══════════════════════════════════════, ═══════════════════════════════════════, ═══════════════════════════════════════, Backend — create, Backend — delete, Backend — modify (+22 more)

### Community 29 - "Community 29"
Cohesion: 0.06
Nodes (29): AuthProvider, _cancelSessionRefreshTimer, _clearLocalAuthState, clearPwaAppBadgeOnLogout, clearStatus, dispose, Exception, Function (+21 more)
...
Cohesion: 0.08
Nodes (28): 1. Database Changes, 2. Cloudinary Service Enhancement, 3. New REST Endpoint, 4. WebSocket Integration, Backend Components, code:typescript (export enum MessageType {), code:typescript (async uploadVoiceMessage(), code:typescript (@Post('voice')) (+20 more)
...
Cohesion: 0.08
Nodes (26): code:dart (void sendPing(int recipientId) {), code:bash (git add frontend/lib/providers/chat_provider.dart), Step 4.5: Commit ChatProvider changes, Chunk 4: Frontend — Encrypt all message types, code:dart (final Map<String, Map<String, dynamic>> _pendingSendContent ), code:dart (_pendingSendContent[tempId] = <String, dynamic>{'content': c), code:dart (Future<void> _encryptAndSend({), code:dart (Map<String, String?>? linkPreview;) (+18 more)

### Community 34 - "Community 34"
Cohesion: 0.08
Nodes (27): code:dart (// frontend/test/services/media_crypto_service_test.dart), code:block2 (cd frontend && flutter test test/services/media_crypto_servi), code:dart (// frontend/lib/services/media_crypto_service.dart), code:block4 (cd frontend && flutter test test/services/media_crypto_servi), code:dart (import '../services/media_crypto_service.dart';), code:block6 (cd frontend && flutter analyze lib/providers/messaging_provi), code:block7 (git add frontend/lib/services/media_crypto_service.dart \), Task 1: MediaCryptoService (+19 more)

### Community 35 - "Community 35"
Cohesion: 0.08
Nodes (26): code:bash (cd backend && npm test --no-coverage 2>&1 | tail -15), code:typescript (import { MessagesService } from './messages.service';), code:bash (cd backend && npm test -- --testPathPattern=messages.service), code:bash (cd backend && npm test --no-coverage 2>&1 | tail -10), code:bash (cd backend && git add src/messages/messages.service.ts src/m), code:typescript (import { ExecutionContext, Injectable } from '@nestjs/common), code:typescript (import { WsThrottlerGuard } from './guards/ws-throttler.guar), code:typescript (import { UseGuards } from '@nestjs/common';) (+18 more)
...
Cohesion: 0.1
Nodes (21): Bubble Redesign: Telegram-style time overlay + media full-bleed, Files Changed, Goal, Problem, Scope, Spec: In-Session Conversation Message Cache, Chat Scroll: `reverse: true` Refactor, code:dart (_scrollController.jumpTo(preOffset + (newExtent - preExtent)) (+13 more)

### Community 41 - "Community 41"
Cohesion: 0.12
Nodes (24): app_localizations.dart, app_localizations_en.dart, app_localizations_pl.dart, antiQuantumNoteSendFailed, AppLocalizations, _AppLocalizationsDelegate, AppLocalizationsEn, AppLocalizationsPl (+16 more)
...
Cohesion: 0.08
Nodes (22): Chat Screen Redesign - Telegram/Wire Inspired UI, code:bash (git add backend/src/messages/entities/message.entity.ts), code:typescript (export enum MessageType {), code:typescript (import { IsInt } from 'class-validator';), code:typescript (import { SendPingDto } from './dto/send-ping.dto';), code:javascript (socket.emit('sendPing', { recipientId: 2 });), code:bash (git add backend/src/messages/entities/message.entity.ts), code:typescript (import { Entity, PrimaryGeneratedColumn, Column, ManyToOne, ) (+14 more)

### Community 44 - "Community 44"
Cohesion: 0.08
Nodes (25): code:typescript (describe('handleMessageDelivered', () => {), code:bash (cd backend && npm test -- --testPathPattern=chat-message.ser), code:typescript (async handleMessageDelivered(), code:bash (cd backend && npm test -- --testPathPattern=chat-message.ser), code:bash (cd backend && git add src/chat/services/chat-message.service), Task 1: `messageDelivered` — ownership check, code:ts (@Column({ type: 'timestamp', nullable: true })), code:ts (user.passwordChangedAt = new Date();) (+17 more)
...
Cohesion: 0.09
Nodes (21): initState, build, Directory, dispose, Exception, Function, initState, _loadAndPlayAudio (+13 more)
...
Cohesion: 0.09
Nodes (23): code:block4 (❌ frontend/Dockerfile.dev), code:bash (git add -A), code:bash (rm frontend/Dockerfile.dev), code:bash (# Kill old processes), code:bash (docker system prune -a), code:bash (git add -A), Existing Files (No Changes), Files to Modify (+15 more)
...
Cohesion: 0.09
Nodes (21): code:dart (// frontend/lib/providers/encryption_provider.dart), code:bash (git add frontend/lib/providers/encryption_provider.dart), code:bash (git add frontend/lib/providers/encryption_provider.dart fron), code:dart (// frontend/lib/providers/connection_provider.dart), code:bash (git add frontend/lib/providers/connection_provider.dart), Task 2.1: Create `EncryptionProvider` skeleton with state + interface, Task 2.3: Move E2E initialization + key exchange logic to EncryptionProvider, Task 4.2: Create ConnectionProvider (+13 more)
...
Cohesion: 0.1
Nodes (20): code:bash (cd backend && git add src/chat/services/chat-conversation.se), code:typescript (/** True if either user has blocked the other. Single query ), code:bash (cd backend && git add src/blocked/blocked.service.ts), code:typescript (/** True only for safe HTTPS URLs pointing to public hosts *), code:typescript (imageUrl: imageUrl ? imageUrl.trim() : null,), code:typescript (imageUrl: imageUrl && isSafeImageUrl(imageUrl.trim()) ? imag), code:bash (cd backend && npm test --no-coverage 2>&1 | tail -15), code:bash (cd backend && git add src/chat/services/link-preview.service) (+12 more)
...
Cohesion: 0.1
Nodes (19): Future Enhancements, Chat Screen Architecture - Source of Truth, Client → Server, code:typescript (@Entity('messages')), Colors (RpgTheme), Current Limitations, Database Schema Changes, Deployment Checklist (+11 more)
...
Cohesion: 0.11
Nodes (17): code:dart (Widget _buildDeliveryIcon() {), code:dart (String? _getTimerText() {), code:dart (@override), code:bash (git add frontend/lib/widgets/chat_message_bubble.dart), Task 3.1: Update ChatMessageBubble with Delivery Indicator & Timer, code:dart (else if (message.messageType == MessageType.gif && message.m), code:dart (void _showGifDialog(BuildContext context, String url) {), code:bash (git add frontend/lib/widgets/chat_message_bubble.dart) (+9 more)
...
Cohesion: 0.13
Nodes (17): code:yaml (# docker-compose.yml — Backend + DB only (for mobile dev)), code:yaml (# docker-compose.web.yml — Full stack with web frontend), Configuration Details, docker-compose.web.yml (Optional), docker-compose.yml (Main), code:bash (git add -A), code:yaml (# docker-compose.yml — Backend + DB only (for mobile dev)), code:bash (git add docker-compose.yml) (+9 more)
...
Cohesion: 0.12
Nodes (16): Backend, Chat Screen Redesign - End-to-End Test Plan, Frontend, Prerequisites, Test 2.1: Set Conversation Timer, Test 2.2: Message Shows Timer Countdown, Test 2.3: Timer Persists Per Conversation, Test 2.4: Timer Turns Off (+8 more)
...
Cohesion: 0.12
Nodes (15): bodyFont, Color, FireplaceColors, formatMessageClock, InputDecoration, isDark, messageBubbleMetaColor, of (+7 more)
...
Cohesion: 0.16
Nodes (3): startsWith(), validateAvatarMagicBytes(), UsersController
...
Cohesion: 0.15
Nodes (12): antiQuantumNoteSendFailed, AppLocalizationsEn, disappearingTimerDays, disappearingTimerHours, disappearingTimerMinutes, disappearingTimerSeconds, friendAcceptedYourRequest, friendAdded (+4 more)
...
Cohesion: 0.15
Nodes (13): code:dart (// Monotonic counter for temporary negative message IDs — pr), code:dart (id: -DateTime.now().millisecondsSinceEpoch, // Temporary neg), code:dart (id: -(++ChatProvider._tempIdSeq), // Monotonic temporary neg), code:dart (if (_activeConversationId == conversationId && content.isNot), code:dart (if (_activeConversationId == conversationId && content.isNot), code:bash (cd frontend && flutter analyze 2>&1 | tail -5), code:bash (git add frontend/lib/providers/chat_provider.dart), Fix A: Monotonic optimistic ID counter (4.2) (+5 more)
...
Cohesion: 0.15
Nodes (12): Architecture, Benefits Summary, code:bash (# Enable USB debugging on phone (Settings → Developer Option), code:bash (# First time (via USB):), Development Experience, Flutter Configuration, Flutter Devices Setup, Hot-Reload Commands (+4 more)

### Community 156 - "Community 156"
Cohesion: 0.17
Nodes (11): antiQuantumNoteSendFailed, AppLocalizationsPl, disappearingTimerDays, disappearingTimerHours, disappearingTimerMinutes, disappearingTimerSeconds, friendAcceptedYourRequest, friendAdded (+3 more)
...
Cohesion: 0.17
Nodes (11): Anti-Quantum Note — Design Spec, Backend, Client-side encryption with key-in-fragment, Database, New module: `secret-notes`, Protection against link-preview bots, Security Model, Summary (+3 more)
...
Cohesion: 0.18
Nodes (11): code:xml (<key>CADisableMinimumFrameDurationOnPhone</key>), code:xml (<key>CADisableMinimumFrameDurationOnPhone</key>), code:xml (<manifest xmlns:android="http://schemas.android.com/apk/res/), code:xml (<manifest xmlns:android="http://schemas.android.com/apk/res/), code:bash (cd frontend/ios), code:block19 (Launching lib/main.dart on iPhone 15 in debug mode...), Krok 3: iOS - HTTP Exception + Permissions, Krok 4: Android - Permissions + HTTP (+3 more)
...
Cohesion: 0.39
Nodes (4): HealthController, createMockResponse(), res, HealthModule
...
Cohesion: 0.25
Nodes (7): Chunk 1: Drawing Removal + Envelope Extension + Model Changes, E2E Encryption for All Message Types + Drawing Removal — Implementation Plan, Current State, E2E Encryption for All Message Types + Drawing Removal, Non-Goals, Summary, Target State
...
Cohesion: 0.29
Nodes (6): context, mockSocket, req, { req, res }, { res }, result
...
Cohesion: 0.33
Nodes (6): code:dart (import 'dart:ui' as ui;), code:dart (import '../screens/drawing_canvas_screen.dart';), code:bash (git add frontend/lib/screens/drawing_canvas_screen.dart), Task 3.6: Create Drawing Canvas Screen (Basic), code:bash (git add -A frontend/lib/screens/drawing_canvas_screen.dart f), Task 2: Remove Drawing from frontend
...
Cohesion: 0.67
Nodes (3): 8. `_encryptAndSend` Refactor, code:dart (Future<void> _encryptAndSend({), code:dart (String messageType = 'TEXT',)

## Knowledge Gaps
- **2421 isolated node(s):** `mockUsersService`, `mockConfigService`, `dto`, `mediaUrlError`, `_mediaOriginEscaped` (+2416 more)
...
- **Why does `chat_detail_screen.dart` connect `Community 16` to `Community 2`, `Community 4`, `Community 8`, `Community 9`, `Community 170`, `Community 13`, `Community 302`, `Community 206`, `Community 49`, `Community 18`, `Community 20`, `Community 53`, `Community 22`, `Community 86`, `Community 184`, `Community 25`, `Community 85`, `Community 27`?**
  _High betweenness centrality (0.158) - this node is a cross-community bridge._
- **Why does `Summary` connect `Community 205` to `Community 161`, `Community 290`, `Community 43`, `Community 76`, `Community 204`, `Community 236`, `Community 84`, `Community 55`, `Community 221`, `Community 94`?**
  _High betweenness centrality (0.137) - this node is a cross-community bridge._
- **Why does `Full Codebase Refactor — Domain-Driven Decomposition` connect `Community 205` to `Community 237`, `Community 238`, `Community 209`, `Community 114`, `Community 274`, `Community 63`?**
