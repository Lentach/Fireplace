...
- Large files: `messaging/messaging_provider.send.dart` (~1106 — biggest after the provider decomposition; next sub-split candidate is media-send vs send-retry), `chat-message.service.ts`, `chat-friend-request.service.ts`
