...
**Tests:** `cd backend && npm test` (316 unit tests, 41 suites; verified by `node scripts/verify-claude-backend-test-counts.mjs`). `cd frontend && flutter test`. CI: `.github/workflows/ci.yml`.
