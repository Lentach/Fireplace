...
## Corpus Check
- 328 files · ~345,425 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4709 nodes · 7578 edges · 304 communities (290 shown, 14 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6fb8a174`
...
## Communities (304 total, 14 thin omitted)
...
Cohesion: 0.07
Nodes (13): BlockedService, ChatValidationModule, ConversationsService, MediaCleanupService, MessageCleanupService, expired, ChatConversationService, friend (+5 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (48): build, ChatInputBar, _ChatInputBarState, Column, dispose, _formatTimer, initState, _insertNewline (+40 more)
...
Cohesion: 0.12
Nodes (23): Conversation, ConversationMapper, conv, createMockConversation(), lastMsg, payload, payload, user (+15 more)

### Community 10 - "Community 10"
Cohesion: 0.05
Nodes (45): Summary, 2. Frontend — Widget Decomposition, 4. Directory Structure After Refactor, 5. Summary, 7. CLAUDE.md Gotchas Preservation Checklist, Backend `src/chat/`, `chat_input_bar.dart` (809 LOC) -> Extraction, `chat_message_bubble.dart` (784 LOC) -> Composition Pattern (+37 more)

### Community 11 - "Community 11"
Cohesion: 0.06
Nodes (39): avatar_circle.dart, AppScrollBehavior, buildOverscrollIndicator, AuthForm, _AuthFormState, build, Form, AvatarCircle (+31 more)
...
Cohesion: 0.05
Nodes (40): initState, Exception, build, Directory, dispose, Exception, Function, initState (+32 more)
...
Cohesion: 0.08
Nodes (15): PendingBucket, PushNotificationCoalescingService, NotifyOptions, PushNotificationsService, conv, data, mockMessage, mockRecipient (+7 more)

### Community 20 - "Community 20"
Cohesion: 0.16
Nodes (20): BlockedModule, BlockedUser, ChatModule, Environment, EnvironmentVariables, validate(), ConversationsModule, Environment Variables (+12 more)
...
Cohesion: 0.07
Nodes (31): code:typescript (/** True if either user has blocked the other. Single query ), code:bash (cd backend && npm test --no-coverage 2>&1 | tail -15), code:bash (cd backend && git add src/blocked/blocked.service.ts), code:typescript (/** True only for safe HTTPS URLs pointing to public hosts *), code:typescript (imageUrl: imageUrl ? imageUrl.trim() : null,), code:typescript (imageUrl: imageUrl && isSafeImageUrl(imageUrl.trim()) ? imag), code:bash (cd backend && npm test --no-coverage 2>&1 | tail -15), code:bash (cd backend && git add src/chat/services/link-preview.service) (+23 more)

### Community 27 - "Community 27"
Cohesion: 0.09
Nodes (31): Center, build, _buildInfoCard, _buildLocalCacheCard, Center, Container, initState, PrivacySafetyScreen (+23 more)
...
Cohesion: 0.09
Nodes (32): 10. Drawing Removal, 11. Backward Compatibility, 12. Testing, 13. Files Changed, 1. Extended E2E Envelope, 2. New Backend Endpoint: `POST /messages/upload-media`, 3. Removed Backend Endpoints, 4. Removed WebSocket Events (+24 more)

### Community 30 - "Community 30"
Cohesion: 0.11
Nodes (6): GetMessagesDto, MarkConversationReadDto, MessageDeliveredDto, MessagesService, msgs, ChatLinkPreviewService
...
Cohesion: 0.1
Nodes (10): AuthController, createAuthServiceMock(), AuthModule, AuthService, mockConfigService, mockUsersService, LoginDto, RefreshBodyDto (+2 more)
...
Cohesion: 0.09
Nodes (27): 1. New Screen: ContactsScreen, 2. Modified: ConversationTile, 3. Modified: ChatDetailScreen, Frontend Components, 2. Recording UI - Voice Recording Overlay, 3. Message Bubble - Voice Playback UI, 4. Chat Input Bar Enhancement, 6. API Service Enhancement (+19 more)
...
Cohesion: 0.09
Nodes (27): code:dart (static MessageType _parseMessageType(String? type) {), code:yaml (just_audio: ^0.9.36  # already exists), code:bash (git add frontend/pubspec.yaml frontend/pubspec.lock), code:dart (enum MessageType {), code:dart (static MessageType _parseMessageType(String? type) {), code:bash (git add frontend/lib/models/message_model.dart), code:dart (class MessageModel {), code:dart (factory MessageModel.fromJson(Map<String, dynamic> json) {) (+19 more)

### Community 40 - "Community 40"
Cohesion: 0.13
Nodes (15): _decodeHtmlEntities, isSafeImageUrl, LinkPreviewService, main, MessagesController, package:fireplace/services/link_preview_service.dart, expectedPayload, preview (+7 more)
...
Cohesion: 0.08
Nodes (25): code:bash (git status), code:bash (git add -A), code:bash (git log --oneline -8), code:bash (git push origin master), Task 12: Final Commit and Summary, code:bash (cd frontend && flutter analyze), code:bash (cd backend && npm run build), code:bash (git status) (+17 more)

### Community 43 - "Community 43"
Cohesion: 0.11
Nodes (21): api_service.dart, ApiService, _effectiveMediaUrl, jsonDecode, dispose, _fetch, GifModel, GifService (+13 more)
...
Cohesion: 0.09
Nodes (23): Chunk 1: Drawing Removal + Envelope Extension + Model Changes, Chunk 2: Backend Changes (upload-media endpoint, remove sendPing, remove old endpoints), Chunk 5: Final integration, persist/restore, tests, docs, code:typescript (import { IsIn, IsNumber, IsOptional, IsPositive } from 'clas), code:typescript (@Post('upload-media')), code:bash (git add backend/src/messages/), code:bash (git add backend/src/chat/), code:dart (final data = <String, dynamic>{) (+15 more)
...
Cohesion: 0.12
Nodes (24): 1. Critical Rules & Gotchas, Backend, E2E Encryption, Frontend, TypeORM, Backend, Documentation, Frontend (+16 more)
...
Cohesion: 0.09
Nodes (22): 10. Frontend — ChatProvider, 11. Frontend — ChatMessageBubble, 1. Backend — Entity, 3. Backend — MessagesService, 4. Backend — MessageMapper, 6. Backend — ChatModule, 7. Frontend — pubspec.yaml, 9. Frontend — SocketService (+14 more)

### Community 52 - "Community 52"
Cohesion: 0.1
Nodes (21): code:dart (void connect(String token, int userId) {), code:dart (void _handleMessageDelivered(Map<String, dynamic> data) {), code:dart (void sendPing(int recipientId) {), code:dart (void _handlePingReceived(Map<String, dynamic> data) {), code:dart (void sendMessage(String content, {int? expiresIn}) {), code:dart (void _handleIncomingMessage(Map<String, dynamic> data) {), code:bash (git add frontend/lib/providers/chat_provider.dart), Task 2.2: Update ChatProvider with Delivery Tracking & Ping (+13 more)

### Community 53 - "Community 53"
Cohesion: 0.09
Nodes (23): code:markdown (| **deleteConversationOnly** | ChatConversationService.handl), code:markdown (- **conversationDeleted:** `{ conversationId: number }`), code:markdown (### 7.X Delete Conversation vs Unfriend), code:markdown (**2026-02-14:**), code:bash (git add CLAUDE.md), Step 10.1: Update §5 WebSocket Event Map, Step 10.2: Update §7 Frontend Mechanisms, Step 10.3: Update §9 File Map (+15 more)
...
Cohesion: 0.09
Nodes (21): Architecture, BASE_URL Setup, Benefits Summary, code:bash (flutter run -d <device> --dart-define=BASE_URL=http://192.16), code:dart (// lib/constants/app_constants.dart), code:dart (// lib/config/env_config.dart), code:bash (# Enable USB debugging on phone (Settings → Developer Option), code:bash (# First time (via USB):) (+13 more)
...
Cohesion: 0.12
Nodes (19): 1.3 iOS (`frontend/ios/Runner/Info.plist`), 3.1 Backend CORS — `docker-compose.yml`, 3.2 iOS — `frontend/ios/Runner/Info.plist`, 3. Exact Code Changes, code:yaml (ALLOWED_ORIGINS: 'http://localhost:3000,http://localhost:808), code:yaml (ALLOWED_ORIGINS: 'http://localhost:3000,http://localhost:808), code:env (ALLOWED_ORIGINS=http://localhost:3000,http://localhost:8080,), code:xml (<!-- Allow HTTP connections to local IP (development only) -) (+11 more)

### Community 69 - "Community 69"
Cohesion: 0.11
Nodes (18): Anti-Quantum Note — Design Spec, Backend (modify), Backend (new), Client-side encryption with key-in-fragment, Database, Files to Create/Modify, Frontend (modify), Frontend (new) (+10 more)

### Community 70 - "Community 70"
Cohesion: 0.11
Nodes (18): Backend, Chat Screen Redesign - End-to-End Test Plan, Frontend, Prerequisites, Test 11.1: Open Conversation Without Active Conversation, Test 11.2: Send Drawing Without Active Conversation, Test 11.3: Upload Image Without Recipient, Test 11: Edge Cases (+10 more)
...
Cohesion: 0.15
Nodes (15): 1. User A Deletes Conversation, User B Sends Message Simultaneously, 2. User A Deletes Conversation, Then User B Unfriends, 3. Re-opening Chat Before Full Deletion (Race Condition), Edge Cases, Bubble Redesign: Telegram-style time overlay + media full-bleed, Files Changed, Goal, Problem (+7 more)
...
Cohesion: 0.11
Nodes (17): 0. Quick Start, 3. File Location Map, 5. How-To: Adding New Features, 6. Key Behaviors & Gotchas (Runtime), 7. Frontend Screens & Widgets, 8. Environment & Config, 9. Known Limitations, Add a new DB column: (+9 more)
...
Cohesion: 0.12
Nodes (17): code:dart (// frontend/test/services/media_crypto_service_test.dart), code:block2 (cd frontend && flutter test test/services/media_crypto_servi), code:dart (// frontend/lib/services/media_crypto_service.dart), code:block4 (cd frontend && flutter test test/services/media_crypto_servi), code:dart (import '../services/media_crypto_service.dart';), code:block6 (cd frontend && flutter analyze lib/providers/messaging_provi), code:block7 (git add frontend/lib/services/media_crypto_service.dart \), Task 1: MediaCryptoService (+9 more)
...
Cohesion: 0.13
Nodes (16): code:bash (git add -A), code:bash (rm frontend/Dockerfile.dev), code:bash (# Kill old processes), code:bash (docker system prune -a), code:bash (git add -A), Migration Procedure, code:bash (git add -A), code:bash (rm frontend/Dockerfile.dev) (+8 more)
...
Cohesion: 0.15
Nodes (13): code:json ({), 1.1 Frontend (Flutter), 1.2 Backend (NestJS), 1. Current Configuration, Ciphertext String Format, code:block1 (Alice                          Server                       ), code:block2 (BEFORE: { content: "Cześć Bob!" }), code:json ({) (+5 more)
...
Cohesion: 0.18
Nodes (11): Executive Summary, 13.1 Signal Protocol Documentation, 13.2 Implementation Guides, 13.3 Security Research, 13. Resources & Documentation, 14. Glossary, Document Change Log, End-to-End Encryption Architecture — Signal Protocol (+3 more)
...
Cohesion: 0.18
Nodes (10): code:bash (cd backend), code:bash (cd frontend), Step 11.3: Run full test suite, Already fixed (skip these), code:bash (# Backend), Deferred (too large for this plan), Important Fixes Implementation Plan, Verification (+2 more)
...
Cohesion: 0.2
Nodes (9): code:typescript (export enum MessageType {), code:typescript (import { IsInt } from 'class-validator';), code:typescript (import { SendPingDto } from './dto/send-ping.dto';), code:javascript (socket.emit('sendPing', { recipientId: 2 });), code:bash (git add backend/src/messages/entities/message.entity.ts), Task 1.2: Add Ping Message Type, 1. Database Changes, code:typescript (export enum MessageType {) (+1 more)
...
Cohesion: 0.2
Nodes (10): code:bash (git add backend/src/chat/chat.gateway.ts), Step 2.4: Commit gateway changes, code:bash (git add backend/src/chat/chat.gateway.ts \), code:bash (cd backend && npm test), code:bash (git add backend/src/chat/chat.gateway.ts), code:ts (@UseGuards(WsThrottlerGuard)), code:ts (@UseGuards(WsThrottlerGuard)), code:ts (@UseGuards(WsThrottlerGuard)) (+2 more)
...
Cohesion: 0.32
Nodes (8): 1.4 Android (`frontend/android/app/src/main/AndroidManifest.xml`), 3.3 Android — `frontend/android/app/src/main/AndroidManifest.xml`, code:xml (<!-- Network access for API + Socket.IO -->), code:xml (<application), code:xml (<application), 3. Android - `frontend/android/app/src/main/AndroidManifest.xml`, code:xml (<!-- Network access for API + Socket.IO -->), code:xml (<application)
...
Cohesion: 0.25
Nodes (8): 2. Cloudinary Service Enhancement, 3. New REST Endpoint, 4. WebSocket Integration, Backend Components, code:typescript (async uploadVoiceMessage(), code:typescript (@Post('voice')), code:typescript (@Post('voice')), Step 2: Add friendship check to voice upload in `messages.controller.ts`
...
Cohesion: 0.29
Nodes (6): code:bash (git add backend/src/messages/entities/message.entity.ts), code:typescript (import { Entity, PrimaryGeneratedColumn, Column, ManyToOne, ), code:typescript (async handleSendMessage(), code:bash (# Backend will auto-sync with TypeORM synchronize:true), code:javascript (// Send message with expiration), Task 1.1: Add Message Delivery Status & Expiration
...
Cohesion: 0.4
Nodes (5): Contacts Tab Design - Archive → Contacts Refactor, Notes, Overview, User Stories, Overview
...
Cohesion: 0.5
Nodes (3): BadgingBridge, createBadgingBridge, _navigator
...
Cohesion: 0.5
Nodes (4): 8. Frontend — MessageModel, code:dart (linkPreviewUrl: json['linkPreviewUrl'] as String?,), code:dart (String? linkPreviewUrl,), code:dart (final String? linkPreviewUrl;)
...
## Knowledge Gaps
- **2330 isolated node(s):** `mockUsersService`, `mockConfigService`, `dto`, `mediaUrlError`, `_mediaOriginEscaped` (+2325 more)
...
- **Why does `Full Codebase Refactor — Domain-Driven Decomposition` connect `Community 10` to `Community 49`, `Community 107`, `Community 13`, `Community 207`?**
  _High betweenness centrality (0.145) - this node is a cross-community bridge._
- **Why does `chat_detail_screen.dart` connect `Community 8` to `Community 1`, `Community 35`, `Community 7`, `Community 199`, `Community 11`, `Community 109`, `Community 14`, `Community 47`, `Community 15`, `Community 77`, `Community 18`, `Community 21`, `Community 23`, `Community 29`?**
  _High betweenness centrality (0.141) - this node is a cross-community bridge._
- **Why does `Summary` connect `Community 10` to `Community 69`, `Community 70`, `Community 46`, `Community 80`, `Community 148`, `Community 182`, `Community 91`?**
